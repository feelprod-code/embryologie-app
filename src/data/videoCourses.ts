...
export const videoCourses: VideoCourse[] = [
  {
    ...
    shortSummary: "Étude de l'embryologie biodynamique, axée sur le développement humain et les interactions durant la croissance. Exploration de principes pour améliorer les pratiques thérapeutiques des professionnels.",
    fullSummary: "Dans cette introduction à l'embryologie biodynamique, nous plongeons profondément dans le processus de développement humain, mettant en lumière la puissance intrinsèque du fœtus. Les ostéopathes sont encouragés à renoncer à une volonté consciente pour participer activement à ce ballet de croissance dynamique. En explorant les interactions fondamentales, les synchronicités moléculaires et tissulaires, ainsi que les scènes clés du développement embryonnaire, cette session offre une compréhension enrichie de la construction humaine. Les praticiens apprendront comment ces principes peuvent révolutionner leur approche thérapeutique.",
    transcriptMarkdown: `
...
J'ai une cellule, puis un groupe de cellules. Elles fonctionnent bien grâce aux communications autocrines et paracrines. En groupe, on est plus fort, plus efficace.
...
Ensuite, apparaît un système qu'on appelle **neuro-entérique primitif**. Cela signifie que je vais développer un système où l'information rentre, il faut que je ferme, puis après il faudra que j'ouvre : c'est le système **parasympathique**.

Puis je vais commencer à me complexifier, en développant un système **orthosympathique**.
...
Cette chronologie d'apparition est presque superposée entre la **phylogenèse** (l'évolution des espèces) et l'**ontogenèse** (le développement de l'individu).
...
![Systèmes biologiques et anatomiques](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/ectoderme/ecto-03/Ectoderme_1.png)
...
![Cytosquelette cellulaire](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/ectoderme/ecto-04/Ectoderme_3.png)
...
![Protéine, Zinc, Sulfate](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/ectoderme/ecto-04/Ectoderme_57.png)



![Structure de tenségrité](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/ectoderme/ecto-04/Ectoderme_4.jpeg)



![Tensegrité](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/ectoderme/ecto-04/Ectoderme_5.jpeg)



![Système matriciel tissulaire](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/ectoderme/ecto-04/Ectoderme_6.jpeg)
...
![Cellule eucaryote](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/ectoderme/ecto-05/Ectoderme_7.png)



![Structure histologique granulaire](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/ectoderme/ecto-05/Ectoderme_2.jpeg)
...
![Feuillets embryonnaires](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/ectoderme/ecto-06/Ectoderme_11.png)
...
![Feuillets embryonnaires](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/ectoderme/ecto-06/Ectoderme_12.png)
...
* Tout le système fluidique (vaisseaux, artères, veines, système lymphatique).
...
Lorsque des phénomènes **synchronisés** se produisent, comme la fermeture des **neuroports** ou l'intégration des **cœlomes**, nous vous donnerons des points précis dans le temps, par exemple au moment de la prise de conscience du **cœur**. Sinon, nous parlerons en jours ou en semaines, et nous aborderons également des notions de **taille**.
...
![Développement utérin fœtal](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/ectoderme/ecto-07/Ectoderme_18.jpeg)



![Développement embryonnaire humain](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/ectoderme/ecto-07/Ectoderme_13.png)



![Embryon neurulation sagittale](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/ectoderme/ecto-07/Ectoderme_50.png)



![Embryon, 6-7 semaines](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/ectoderme/ecto-07/Ectoderme_61.png)
...
![Microvillosités entérocytes](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/ectoderme/ecto-08/Ectoderme_8.jpeg)
...
Un apport significatif de lumière modifie les paramètres. Lorsqu'un champ électrique est présent, il y a toujours un champ électromagnétique, ce qui assure la **cohésion** du système et fournit une **référence**. Ainsi, une cellule à un endroit donné n'a pas la même référence spatiale qu'une autre cellule.
...
`,
  },
  {
    ...
    shortSummary: "Mécanismes de la gamétogénèse et leur influence sur la fertilité. Analyse des interactions entre ostéopathie et conception.",
    fullSummary: "Cette session explore la gamétogénèse en détaillant les différences cruciales entre l'ovocyte et le spermatozoïde, tant sur le plan cellulaire que fonctionnel. Les étudiants découvrent la production d'ovocytes, leur origine pendant la vie fœtale, ainsi que l'importance des cellules nourricières et folliculaires dans le développement embryonnaire. L'impact de la température sur la fertilité est également abordé, soulignant la nécessité de chaleur pour les ovaires et de fraîcheur pour les testicules, ainsi que les implications pour les problèmes de fertilité chez les femmes. Enfin, les liens anatomiques entre les organes et le système artériel sont présentés, mettant en lumière les axes de communication trophique et le rôle de l'ostéopathie dans la gestion de la fertilité.",
    transcriptMarkdown: `
# Gamétogénèse
...
![Ovule fécondé](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/ectoderme/ecto-11/Ectoderme_14.jpeg)
...
![Blastocyste en segmentation](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/ectoderme/ecto-12/Ectoderme_24.jpeg)
...
![Blastocyste cavitation](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/ectoderme/ecto-12/Ectoderme_20.jpeg)
...
![Pincement embryonnaire par contraction](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/ectoderme/ecto-12/Ectoderme_29.jpeg)
...
![Développement embryonnaire précoce](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/ectoderme/ecto-12/Ectoderme_16.jpeg)



![Embryon 2 cellules](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/ectoderme/ecto-12/Ectoderme_19.jpeg)



![Coque embryonnaire déformée](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/ectoderme/ecto-12/Ectoderme_79.jpeg)



![Blastocyste cavitation NaKATPase](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/ectoderme/ecto-12/Ectoderme_26.png)



![Blastula Micromères PV](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/ectoderme/ecto-12/Ectoderme_21.jpeg)



![Embryon de gastéropode](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/ectoderme/ecto-12/Ectoderme_23.jpeg)
...
![Éclosion blastocyste](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/ectoderme/ecto-13/Ectoderme_22.png)
...
`,
  },
  {
    ...
    shortSummary: "Détails sur le processus d'implantation embryonnaire et son importance pour le développement précoce. Description de l'implantation de l'embryon dans la muqueuse utérine.",
    fullSummary: "Cette vidéo explore le processus fascinant d'implantation embryonnaire et la formation de la cavité amniotique primitive. Vous apprendrez comment l'embryon, avec son pôle assimilateur, pénètre la muqueuse utérine grâce à des cellules spécialisées et à une activité agressive du syncytiotrophoblaste, qui engendre des micro-saignements et prépare le terrain pour la vie. Nous aborderons la différenciation cellulaire entre les hypoblastes et épiblastes, qui donneront respectivement naissance au système digestif et au système neuronal. En fin de compte, cette session révèle les subtilités de la quête de l'embryon pour s'incarner, renforçant la compréhension des défis d'implantation et de leur impact sur la réussite de la grossesse.",
    transcriptMarkdown: `
...
La muqueuse utérine est représentée ici. L'embryon montre des **cellules spécifiques**, captrices d'informations. Cette couche de cellules forme ce qu'on appelle la **vésicule embryonnaire**.
...
![Embryon humain 9 jours](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/ectoderme/ecto-14/Ectoderme_35.jpeg)
...
L'information de **pression interne et externe** est cruciale. L'intégration du **cœlome** (fermeture de la cavité péritonéale) et la fermeture du **tube neural** se feront simultanément. Ce sont des synchronicités, des inductions spécifiques.
...
![Développement embryonnaire précoce](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/ectoderme/ecto-14/Ectoderme_38.jpeg)
...
![Néphron en développement](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/ectoderme/ecto-14/Ectoderme_43.jpeg)



À ce stade, nous avons déjà une préparation pour un tissu de type digestif et un tissu de type neurologique.

![Neurulation</td></tr></table>](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/ectoderme/ecto-14/Ectoderme_34.jpeg)




![Implantation du blastocyste](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/ectoderme/ecto-14/Ectoderme_17.jpeg)



![Implantation du blastocyste](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/ectoderme/ecto-14/Ectoderme_30.jpeg)



![8ème jour embryonnaire](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/ectoderme/ecto-14/Ectoderme_31.jpeg)



![Développement embryonnaire précoce](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/ectoderme/ecto-14/Ectoderme_36.jpeg)



![Embryon 14-15 jours](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/ectoderme/ecto-14/Ectoderme_37.jpeg)
...
Prenons une couche de cellules. L'information trophique arrive maintenant d'une manière beaucoup plus spécifique et polarisée. Avec l'apparition de la **cavité vitelline**, de la **cavité amniotique** et du **cœlome externe**, s'organise ce qu'on appelle un **pédicule embryonnaire**. Cela signifie que l'information trophique ne vient plus de partout, mais d'une manière orientée.
...
Cela introduit un mouvement très important qui permet de passer du **zygote** à un **fœtus primitif**. Au départ, l'information trophique est générale, sans lien véritable. Mais lorsque le passage se fait du blastocèle à une cavité vitelline et un cœlome externe, une concentration se produit. Il n'y a plus qu'un lien entre cette petite masse et la partie extérieure, formant plus tard le **placenta**. Cela s'appelle le **pédicule embryonnaire**, ou le **cordon ombilical primitif**, un lieu trophique.

## Organisation de l'Embryon et Mouvement Métabolique

Prenons maintenant un embryon à ce stade. Nous avons une couche de cellules formant la **cavité amniotique** et une couche de cellules en dessous, la **cavité vitelline**. L'ensemble est relié à un pédicule embryonnaire et se trouve dans une cavité, le **cœlome externe**.
...
![Sels de calcium](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/ectoderme/ecto-17/Ectoderme_28.jpeg)
...
`,
  },
  {
    ...
    shortSummary: "Étude de la méditation axée sur la respiration et son lien avec la puissance embryonnaire, favorisant un état de calme propice aux transformations intérieures.",
    fullSummary: "Cette vidéo explore la méditation axée sur la respiration et la connexion au Souffle de Vie, en mettant l'accent sur l'observation de la respiration du patient. Les participants apprennent à s'accorder à une fréquence spécifique, favorisant un état d'esprit calme et ouvert à de nouvelles perceptions. L'exercice guide également les participants à prolonger l'expiration pour atteindre un espace de silence intérieur, crucial pour accéder à la puissance embryonnaire et à la respiration pré-natale. Les concepts clés incluent l'attention à la respiration, l'observation des changements respiratoires et la recherche des points d'équilibre dans la respiration primaire, ouvrant ainsi la voie aux transformations personnelles et thérapeutiques.",
    transcriptMarkdown: `
...
Nous allons apprendre à observer la **respiration du patient**, en commençant par la première respiration. Progressivement, nous rechercherons un point, une **porte**, où nous pourrons déposer notre sensation. Ce point se situe à la fin de l'expiration et juste avant l'inspiration.
...
![Gastrulation](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/ectoderme/ecto-20/Ectoderme_56.jpeg)
...
![Gastrulation aviaire](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/ectoderme/ecto-20/Ectoderme_53.png)



![Gastrulation humaine 16 jours](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/ectoderme/ecto-20/Ectoderme_55.jpeg)
...
`,
  },
  {
    ...
    shortSummary: "Émergence de la ligne primitive et formation de la notochorde, mettant en lumière leur rôle crucial dans le développement embryonnaire et les connexions entre les structures corporelles.",
    fullSummary: "Cette session explore l'émergence de la ligne primitive comme une force d'aspiration qui établit l'axe embryonnaire. On découvre le concept de 'point zéro', zone de mouvement minimal où se forme la notochorde, essentielle au développement des structures embryonnaires. L'accent est mis sur l'embryon comme une unité fonctionnelle, démontrant l'importance des connexions précises entre les diverses parties du corps, comme le sacrum et la base du crâne, pour un développement sain.",
    transcriptMarkdown: `
...
Ce que l'on appelle la **croissance de l'analyse** et le **cœlome externe** donne finalement naissance à cet espace, créant une convergence de forces qui aboutit à la formation du pédicule embryonnaire.
...
`,
  },
  {
    ...
    shortSummary: "Analyse du flux nodal et des vésicules dans la création de l'asymétrie interne, essentiels pour la compréhension embryologique en ostéopathie.",
    fullSummary: "Cette session aborde l'origine de l'asymétrie interne par le biais du nœud d'Hensen et du flux nodal. Les cils rotatoires créent un mouvement qui permet le déplacement des molécules et des vésicules, générant ainsi des morphogènes qui influencent le développement asymétrique des organes, comme le cœur et le foie. Les interrupteurs génétiques impliqués, tels que Sonic Hedgehog et les facteurs de croissance des fibroblastes (FGF), jouent un rôle clé dans l'organisation des structures internes.\n\nL'axe embryonnaire est présenté comme un centre d'organisation, avec un accent sur l'importance du mésoderme intra-embryonnaire. L'impact de ces concepts sur la pratique ostéopathique est également souligné, en mettant en lumière comment la compréhension de ces processus est cruciale pour la prise en charge des patients, grâce à une image mentale appropriée de ces dynamiques internes.",
    transcriptMarkdown: `
...
`,
  },
  {
    ...
    shortSummary: "Analyse du processus de fermeture du tube neural, crucial pour le développement embryonnaire et la formation de la colonne vertébrale.",
    fullSummary: "Cette session explore en détail la fermeture du tube neural, un moment crucial dans le développement embryonnaire qui commence par la formation d'une structure allongée à partir de l'épiblaste. Ce processus implique l'interaction fascinante entre l'hypoblaste et l'ectoderme, menant à l'émergence de la notochorde et sa transformation en une corde cordale. Les étudiants apprendront comment cette dynamique influence la formation de la vertèbre et intègre des informations essentielles pour le développement embryonnaire. En comprenant ces interactions, les thérapeutes peuvent mieux appréhender les fondements embryologiques liés à leurs pratiques.",
    transcriptMarkdown: `
...
![Embryon humain, stade jeune](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/ectoderme/ecto-29/Ectoderme_15.jpeg)
...
![Développement embryonnaire oiseau](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/ectoderme/ecto-29/Ectoderme_33.jpeg)
...
![Gastrulation](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/ectoderme/ecto-29/Ectoderme_40.jpeg)
...
![Gastrulation amphibien](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/ectoderme/ecto-29/Ectoderme_44.jpeg)



Ce processus engendre un **changement de forme** de l'ectoderme.

![Embryon en coupe sagittale](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/ectoderme/ecto-29/Ectoderme_41.png)
...
![Développement tube cardiaque](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/ectoderme/ecto-29/Ectoderme_58.png)
...
![Embryon humain sagittal](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/ectoderme/ecto-29/Ectoderme_48.jpeg)
...
![Embryon humain vascularisé](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/ectoderme/ecto-29/Ectoderme_59.jpeg)
...
L'ectoderme est le **moteur de la croissance**. Il est alimenté par le **mésoderme fluidique**.
...
![Développement embryonnaire précoce](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/ectoderme/ecto-29/Ectoderme_62.png)
...
![Pliage embryonnaire latéral](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/ectoderme/ecto-29/Ectoderme_63.jpeg)
...
![Schéma explicatif](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/ectoderme/ecto-29/Ectoderme_7.jpeg)
...
![Ébauches digestives 30j](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/ectoderme/ecto-30/Ectoderme_67.jpeg)
...
![Développement embryonnaire humain](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/ectoderme/ecto-30/Ectoderme_70.jpeg)
...
![Embryon 4 semaines](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/ectoderme/ecto-30/Ectoderme_71.jpeg)
...
![Embryon, organes internes](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/ectoderme/ecto-30/Ectoderme_72.jpeg)
...
![Descente septum transversum](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/ectoderme/ecto-30/Ectoderme_69.png)
...
![Ductus pericardio-peritonealis](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/ectoderme/ecto-30/Ectoderme_68.png)
...
![Embryon humain 6 semaines](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/ectoderme/ecto-30/Ectoderme_73.jpeg)
...
![Diaphragme muscle squelettique](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/ectoderme/ecto-30/Ectoderme_74.jpeg)
...
![Coupe sagittale thoracique abdominale](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/ectoderme/ecto-30/Ectoderme_78.jpeg)
...
- Le point le plus mobile est le **cæcum**, le dernier à se mettre en place. Évaluez comment il est.
...
Simultanément, la **cavité amniotique** au-dessus contient du liquide. Lorsque la plaque neurale commence à former un tube et une gouttière, le liquide amniotique est intégré dans le tube neural. Ce processus s'accompagne de l'intégration du **cœlome externe** en **cœlome interne**.

Lorsque le tube neural se ferme complètement, avec la fermeture des **neuropores antérieur et postérieur**, l'intégration du cœlome est totale. Cela donne naissance à une boîte viscérale, une cavité abdominale et une cavité cérébrale, tous formés simultanément. Ce moment, au **28e jour**, est marqué par une synchronicité remarquable.

## Synchronie des événements et rôle de la notochorde

Ce moment de fermeture est crucial. Avec l'intégration du cœlome et des aortes, un tissu se forme autour de la notochorde, dans des champs métaboliques de rétention. Cette fermeture est constante et, pour les ostéopathes, il est intéressant d'observer ces phénomènes se déroulant à distance mais dans un même temps.
...
![Crête neurale embryonnaire](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/ectoderme/ecto-35/Ectoderme_42.jpeg)
...
![Développement villosités intestinales](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/ectoderme/ecto-35/Ectoderme_82.jpeg)
...
Nous commencerons par simplement poser les mains et ressentir l'homogénéité ou non du système. Ensuite, nous pourrons approfondir, en interrogeant les différents niveaux du corps.
...
*   **Les axes digestifs** : Travailler sur les axes digestifs (mésentériques, mésarriques) ou l'axe cœliaque peut apporter l'expansion nécessaire.
...
## V. Cas Pratique : Analyse d'un Ressenti
...
## Processus d'Ascensus et d'Hémisphérisation
...
Il sera intéressant de revoir les jours de développement ultérieurement pour corréler cela avec des phénomènes digestifs ou autres.
...
![Circulation LCR rachidien](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/ectoderme/ecto-38/Ectoderme_47.png)
...
Cette vitesse de croissance agit comme un **algorithme** intégré au système, provoquant à un moment donné la **"hola"** (vague) précise de la **notochorde**.
...
![Homéostasie par champs](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/ectoderme/ecto-41/Ectoderme_81.jpeg)
...
![Somites et tube neural](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/ectoderme/ecto-43/Ectoderme_46.png)
...
Chaque champ métabolique contribue à cette création, et perturber un champ peut dérégler l'ensemble du système. C'est le principe de la **garantie homéostasique**, où chacun doit atteindre son équilibre.
...
![EMT (Transition Épithélio-Mesenchymateuse)](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/ectoderme/ecto-43/Ectoderme_54.png)
...
`,
  },
  {
    ...
    shortSummary: "Examen de l'influence de l'équilibre acido-basique sur le corps et la posture, avec intégration au système hypothalamo-hypophysaire dans un contexte thérapeutique.",
...
Si vous êtes bloqué, cela affecte vos sphincters, qui peuvent être soit ouverts, soit fermés. Vous pouvez être en **diarrhée** ou en **constipation**, ou dans un état **précancéreux** ou **pro-inflammatoire**. Tout cela, que vous soyez en **para** ou en **ortho**, se répercute dans une chimie spécifique.
...
`,
  },
  {
    ...
    shortSummary: "Démonstration pratique de l'approche biodynamique sur le système ventriculaire avec un focus sur la perception tactile et l'exploration des couches tissulaires.",
    fullSummary: "Cette vidéo propose une démonstration pratique de l'approche biodynamique appliquée au système ventriculaire, mettant l'accent sur la perception tactile et la progression à travers les différentes couches tissulaires. L'instructeur guide les thérapeutes à travers un processus d'exploration du corps, en commençant par une prise de contact délicate avec la surface de la tête et en descendendant jusqu'aux structures osseuses, tout en cultivant une sensibilité accrue aux changements de texture et de température. Les concepts clés abordés incluent l'interaction oscillatoire dans les hémisphères cérébraux, ainsi que la création d'un espace thérapeutique qui favorise une meilleure respiration et engagement corporel. Cette pratique s'avère enrichissante pour comprendre les dynamiques internes et évolutionnaires du corps.",
    transcriptMarkdown: `
...
`,
  },
  {
    ...
    shortSummary: "Rôle des crêtes neurales dans le développement embryologique et leur impact sur le système nerveux périphérique et la santé des organes. Exploration des concepts de migration cellulaire, de différenciation et des implications thérapeutiques.",
...
![Embryon humain sagittal](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/ectoderme/ecto-47/Ectoderme_49.jpeg)
...
![Base du crâne foetal](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/ectoderme/ecto-48/Ectoderme_52.jpeg)
...
![Développement tête embryonnaire](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/ectoderme/ecto-48/Ectoderme_51.jpeg)
...
La croissance différentielle du cerveau entraîne la flexion de l'embryon, avec le **prosencéphale**, le **mésencéphale** et le **rhombencéphale** qui donnent la dynamique.
...
La dur-mère, avec sa double couche (viscérale et pariétale), est un emballage du cerveau. Des zones de **densification**, appelées **ceintures durales** (antérieures, moyennes, postérieures), s'orientent vers la base du crâne, lieu de tension membraneuse intense.
...
Les **gaines durales** primitives s'organisent sur l'axe entre l'aorte et le cerveau, un confluent majeur. On retrouve aussi la faux du cerveau, les gaines durales et l'os qui se construit à partir d'un tissu commun.
...
Les pompages et les libérations décongestionnent les problèmes radiculaires. Les **ligaments de Hoffman** et les **opercules de Forestier** créent des soupapes pour l'équilibre hydrique, protégeant les racines nerveuses.
...
![Vessie urinaire](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/ectoderme/ecto-50/Ectoderme_80.jpeg)
...
## Importance chez l'Enfant : Mandibule et Gaine Antérieure
...
Je peux également travailler la **gaine antérieure** par rapport au **sinus transverse**. Je me positionne et cherche à redonner la liberté à ce tissu.
...
Il est important de se rappeler la **dynamique du développement du cerveau**, tout ce mouvement, y compris le mouvement **ventriculaire**. Je place mes pouces pour travailler les différentes gaines durales par rapport à la base du crâne, et les réintégrer à chaque fois.
...
`,
  },
  {
    ...
    shortSummary: "Analyse des trois lignes médianes fondamentales et de leur lien avec la zone urogénitale. Rôle de l'ancrage dans l'équilibre émotionnel et harmonisation des règnes minéral, végétal et animal pour un discernement clair.",
    fullSummary: "Cette vidéo conclut la Phase 1 d'enseignement sur l'embryologie biodynamique, en explorant les trois lignes médianes fondamentales et leur relation avec la zone urogénitale. L'importance de l'ancrage est soulignée, en reliant le règne minéral à la réalité physique et en intégrant les aspects émotionnels et rythmiques des règnes végétal et animal. En vous établissant dans votre règne neurosensoriel, vous apprenez à faire la différence entre jugement et discernement, favorisant ainsi une connexion plus profonde avec vos émotions et votre environnement. Cette harmonie conduit à une meilleure respiration et ancrage, favorables à votre pratique professionnelle.",
    transcriptMarkdown: `
...
![Notocorde et Tube Neural](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/ectoderme/ecto-52/Ectoderme_10.jpeg)
...
Dans l'**embryologie biodynamique**, le thérapeute intervient très peu par **induction directe**. Il s'agit plutôt de faire confiance à une force inhérente qui nous dépasse.

Ne pas donner d'induction et ne pas intervenir activement est un défi, car l'apprentissage classique nous a souvent enseigné l'inverse. Nous ne sommes pas uniquement en contact avec le tissu, mais aussi avec l'**espace** qui l'entoure.

## Respiration Primaire et Mouvement Respiratoire Primaire

Une notion clé est la distinction entre la **respiration primaire** et le **mouvement respiratoire primaire**. La respiration primaire est omniprésente, non limitée au corps physique, mais présente dans la totalité de l'existence.

On peut la considérer comme le **"souffle de vie"**. Il est essentiel d'expérimenter cela et d'oser aller dans cet espace.

## Principe de Santé et Biodynamique

L'embryologie biodynamique s'inscrit dans un des grands principes de l'**ostéopathie** : la capacité d'**autorégulation** du corps et son principe homéostatique de santé.

Notre travail en biodynamique consiste à œuvrer avec la santé, plutôt que contre la maladie. C'est un changement de paradigme, car nous sommes souvent enclins à rechercher la lésion.

Mon approche vous invite à chercher la santé. Ce n'est pas toujours évident, car l'attirance vers la lésion est forte. Nous ne la déconsidérons pas, mais nous ne nous y arrêtons pas.

## Le Secret : Découvrir le Neutre

Le secret pour s'immerger dans ce processus est de découvrir ce qu'est le **neutre**.

### Neutre du Praticien

Il y a d'abord le **"neutre du praticien"**. Ce n'est pas simple, car nous ne sommes pas spontanément dans cet état.

Je vous ai progressivement guidés vers un état de neutralité par la **méditation**, le "neutre du thérapeute".

Cet état est nécessaire, mais il ne suffit pas encore à faire émerger la puissance thérapeutique, ni à exprimer pleinement le souffle de vie. Le praticien doit d'abord être centré et découvrir cet état de neutre.

### Rencontre des Neutres

Une fois que nous avons découvert cet état de neutre et que nous sommes en contact avec le patient, nous devons ouvrir notre espace aux différents champs :

* **Zone A :** Le corps physique.
* **Zone B :** Le système fluidique, sur lequel j'ai beaucoup insisté tout au long du séminaire.
* **Espaces environnants :** L'espace dans lequel nous nous trouvons, puis les différents espaces jusqu'à l'image la plus vaste que vous puissiez concevoir.

Après le "neutre du thérapeute", la deuxième étape, et c'est là que réside la difficulté, est de faire émerger le **"neutre chez le patient"**.

C'est la clé. Vous avez votre propre neutre, mais si le patient n'entre pas dans son propre neutre, c'est-à-dire dans un état de désengagement, les forces thérapeutiques ne peuvent pas émerger.

### Émergence des Forces Thérapeutiques

L'émergence des forces thérapeutiques se produit lorsqu'il y a une rencontre de ces deux neutres. C'est comme la formation du "un" et du "deux" pour atteindre le "tout", que l'on pourrait appeler le **"trois"**.

Lorsque le neutre du thérapeute rencontre le neutre du patient, les forces thérapeutiques – la respiration primaire, le souffle de vie – permettent à la puissance inhérente du système d'émerger.

Cette émergence se manifeste avec la force de son originalité. C'est à ce moment-là que se produit la rencontre avec les forces embryonnaires. C'est la même énergie que le corps va rechercher pour se régénérer, se restructurer et retrouver sa fonction.

## Les Quatre Corps

Nous allons réaliser qu'il faut ramener progressivement les gens "sur terre".

### 1. Force de Gravité (Contact avec la Terre)

C'est ce qu'on appelle la **force de gravité**. Être bien ancré dans sa force de gravité signifie être bien en contact avec la terre. Ce contact est très important.

Certains sont trop "dans la terre", comme déjà "enterrés", tandis que d'autres ne sont pas "sur la terre", ils flottent. Il faut redonner ce contact fondamental.

### 2. Force Électromagnétique (Remettre dans le Corps)

Ensuite, il y a la **force électromagnétique**. Il s'agit de remettre les gens dans leur corps.

Suite à des chocs (comme des coups du lapin ou d'autres accidents), il est possible que des personnes soient "hors de leur corps". Bien que cela ne soit pas visible, elles sont comme déconnectées. Il est question de les ramener dans leur champ électromagnétique.

### 3. Corps Énergétique (L'Atmos, la Non-Forme)

La troisième étape est de ramener les gens dans leur **corps énergétique**, dans l'« atmos ». L'« atmos » représente la non-forme.

Ce corps énergétique se perçoit souvent comme un état vibratoire, une fréquence, une vibration.

### 4. Corps de Lumière (Pleine Fonction)

Quatrième point, il s'agit de ramener les gens dans leur **corps de lumière**. Être complètement lumineux signifie être pleinement dans sa fonction.

C'est donc ramener les gens à leur pleine fonctionnalité. Plus vous êtes en phase avec cela, plus vous attirez l'énergie juste autour de vous, ce que j'appelle les **"justes synchronicités"**.

## Le "Meeting Point"

Pour atteindre ce niveau, nous avons besoin de ce que l'on appelle le **"meeting point"** : un point de rencontre entre le thérapeute et le patient.

S'il n'y a pas ce point de rencontre, il n'y a pas d'émergence thérapeutique. Il arrive que l'on puisse traiter des patients sans qu'un véritable "meeting point" ne se produise ; dans ce cas, il ne se passera pas grand-chose d'essentiel.

Certains patients arrivent et l'on sait déjà ce que l'on va faire, mais ce n'est pas un point de rencontre. L'important est de découvrir et de faire émerger ce neutre chez votre patient.

Cela nécessite un espace particulier et une attention à la possibilité de cette émergence, par un toucher, une présence, une mise à niveau.

Lorsque je travaille avec un enfant, je me mets toujours à son niveau pour rechercher ce point de rencontre. Si ce point se crée, l'enfant entre très vite dans l'émergence de son neutre. 

C'est alors que la force thérapeutique peut commencer à s'exprimer.

## Lois de la Nature et Corrections

Nous n'imposons pas, nous cherchons le neutre, le neutre du patient. Nous nous abandonnons à ce que j'appelle les **lois de la nature**.

Il est très important d'avoir cette confiance dans le processus. Des corrections vont émerger par votre présence, des mouvements vont se produire.

Ces corrections sont similaires à ce que **Sutherland** a décrit, et elles sont proches des mouvements biodynamiques et de la motilité du développement embryonnaire. Ce sont les mêmes phénomènes qui vont se manifester.

## Fluctuation Longitudinale

La première chose très importante est de relancer cette **fluctuation longitudinale**. C'est une des premières puissances que le corps utilise.
...
C'est là que les Chinois ont un mot fantastique : le **"wu bei"** (ou **"wu wei"**). Cela ne signifie pas "ne rien faire", mais plutôt "ne pas faire" (le **"non-faire"**). C'est une distinction très importante.
...
La voie thérapeutique et la voie de pratique sont une voie **mésodermique**. Ces processus, ces lignes thérapeutiques, se développent dans un processus de **croissance**. C'est un mouvement unique, non une succession de mouvements distincts. Nous pouvons nous connecter à ce grand mouvement.

## La notion de croissance et de puissance longitudinale de développement

Il est essentiel d'observer cette notion de **croissance** et cette **puissance longitudinale** de développement. Cette puissance de développement est une rencontre entre l'intérieur et l'extérieur, et vice versa.

La **force thérapeutique** provient de l'extérieur. Le corps a une capacité d'**autorégulation** pour maintenir sa santé, et nous travaillons avec cela.

Dans l'estomac, il y a des **villosités**. Ces villosités sont constituées de cellules, une couche de cellules **épithéliales**. Cette couche contient des cellules qui fabriquent du **mucus** et des cellules qui produisent des **acides**.

Il y a toujours, et c'est très fréquent dans tout le corps, une couche de **cellules souches**. Dans le tissu de l'estomac, ce sont des cellules **régénératrices** qui utilisent cette puissance d'autorégulation.

Rappelez-vous que votre corps se régénère continuellement. La **muqueuse gastrique**, les cellules, la peau… tout cela se régénère constamment et utilise cette puissance embryonnaire.

Par la rencontre de neutres, ce principe que je vous propose permet de sublimer ce processus. Dans ce principe de **structure-fonction**, je parle de la **forme**. 

Est-ce que je suis en forme aujourd'hui ? Cela maintient cette notion de santé. La notion de **temps**, la notion de **tissu**, et la notion des **fluides** sont interliées.

## L'importance des fluides dans le corps

Lorsque nous avons commencé à étudier l'**embryologie**, j'ai mentionné que votre image mentale a été construite autour de l'**os**. En réalité, notre corps se construit autour des **fluides**.

Cela signifie que nous allons de plus en plus vers la perception de ce corps fluide. Dans votre corps, vous avez des **volumes** qui peuvent exprimer un état mental. En fait, vous fonctionnez d'après ces volumes : c'est le **vide** et les **pleins**.

## Récapitulatif et orientation du cours

1. **Première session :** Étude de l'**axe notochordal** et du développement du **tube neural**.
2. **Deuxième session :** Étude du développement du **viscérocrâne** et de l'importance de la **base du crâne** dans ce processus.
3. **Maintenant :** Nous allons étudier essentiellement tout ce qui est en vert, ce que nous appellerons l'**homme interne**. C'est-à-dire tout le **système de soutien**, et surtout le **système fluide**.

Je vous rappelle que vous êtes constitué d'un très grand pourcentage d'**eau**. Mais comment cette eau se met-elle dans le corps ?

Ce corps fluide sera sous la dépendance d'un **corps électrique**. On pourrait dire : j'ai d'abord besoin de quelque chose d'indifférencié, puis d'un **champ électrique**, et enfin d'un **champ de structure**.

Nous allons d'abord aller dans ce vide, pour ressentir le champ électrique, et pour aider les fluides à se restructurer. Ensuite, ces fluides vont se **densifier**.

Nous partons d'un niveau de **lumière** vers un niveau de **densité**, pour retrouver un jour notre lumière.

## La forme de l'eau et ses implications thérapeutiques

**70%** de la masse corporelle sont des **équidiens**. Mais l'eau peut s'exprimer sous forme de **vapeur**, sous forme de **gaz**. Il y a de l'eau qui peut se **cristalliser**. Cela aussi est important : c'est la **forme de l'eau**.

Vous avez déjà entendu parler de cette étude japonaise qui, en fonction de la pensée, structurait la qualité de la forme de l'eau. Cela signifie que nos **pensées** sont importantes.

Il faut se rendre compte que l'eau est **structurée**, elle est liée. C'est ce qui maintient une **cohésion**. Ce sont ces phénomènes qui donnent les **champs asséchés**, desséchés ou hydratés. 

Lorsque nous allons travailler au niveau du **cerveau**, du **crâne** sur le corps fluidique, nous allons petit à petit apprendre à ressentir ce niveau d'énergie. Est-ce que le corps est asséché ou pas ? 

Les techniques de type **structurel** peuvent momentanément déshydrater le corps si elles ne sont pas faites avec conscience. Par contre, des techniques de type **biodynamique** ont tendance à réhydrater le corps.

Cette notion de **rééquilibrage** sur le plan de mes **ions**, sur le plan de mes **macromolécules**, sur comment l'eau va se structurer, forme des coquilles qui donnent une cohésion.

Si vous avez une **déshydratation** dans votre corps, vous perdez vos capacités. Rappelez-vous qu'il faut **six mois** pour se réhydrater. Se réhydrater signifie boire de l'eau de source, de l'eau de qualité. La biodynamique aide à restructurer la qualité hydrique du corps.

## L'Homunculus Interni et les Trajectoires Mésodermiques

L'**Homunculus Interni**, l'homme mésodermique, est lié aux **trajectoires**.

- Sur le plan **vasculaire**.
- Sur le plan des trajectoires du développement **urogénital**.
...
`,
  },
  {
    ...
    duration: "03:43",
    title: "3. Mise en Place du Mesoderme et La Notochorde",
    shortSummary: "Formation du mésoderme et rôle de la notochorde dans le développement embryonnaire. Analyse des interactions cellulaires et implications pour l'ostéopathie.",
    fullSummary: "Cette vidéo vous guide à travers le processus fascinant de la mise en place du mésoderme et du rôle crucial de la notochorde dans le développement embryonnaire. Vous apprendrez comment ces structures interagissent au niveau cellulaire, notamment grâce à la ligne primitive et aux cellules en bouteille, entraînant la formation du tissu mésenchymateux primitif. De plus, vous explorerez des aspects pratiques en lien avec le coccyx, en découvrant comment les impulsions et les champs électromagnétiques influencent la santé des tissus. La session inclut une approche pratique des mouvements notochordaux tout en mettant en lumière l'interconnexion entre le sacrum, le coccyx, et même le cœur, approfondissant ainsi votre compréhension de l'embryologie biodynamique et de l'ostéopathie.",
    transcriptMarkdown: `
# Mise en Place du Mésoderme et de la Notochorde

## La mise en place du Mésoderme

La première étape cruciale est la **mise en place du mésoderme**. On observe l'apparition de la **ligne primitive** et de l'**axe notochordal**.

Il existe un champ d'aspiration entre le tissu **ectodermique** et le tissu **endodermique**, créant un mouvement où un espace va se combler.

Le tissu mésodermique a pour origine le tissu **épiblastique**, et non le tissu ectodermique. Les **cellules en bouteille** sont attirées vers le centre.

C'est ainsi que l'espace entre le tissu épiblastique et hypoblastique devient le **tissu mésenchymateux primitif**, futur mésoderme.

## Rôle de la Notochorde

La **notochorde** influence ce processus. C'est un champ électrique qui agit.

Lors du cours précédent, nous avons travaillé au niveau du **sacrum**, en nous concentrant sur l'axe notochordal.

Nous allons explorer le processus plus en profondeur. La notochorde, positionnée ici, est liée au **nœud d'Hensen**.

Cela génère un mouvement de vague, un mouvement **crânio-caudal**, où la ligne primitive régresse progressivement vers l'arrière.

Cette ligne primitive se retrouve au niveau de la base **sacro-coccygienne**, constituant un vestige énergétique.

On observe ainsi la mise en place du mésoderme.

## La pratique : Le coccyx et les impulsions

Nous allons pratiquer en nous concentrant sur le **coccyx**, car cette zone concentre l'énergie.

La première impulsion se produit sur le tissu **hypoblastique**. C'est à ce moment que l'épiblaste devient **ectoderme** et l'hypoblaste devient **endoderme**.

Cela signifie que l'épiblaste informe tous mes tissus, et il est lui-même complètement intégré par ma notochorde. C'est un champ **électromagnétique** qui informe le corps.

Lorsque nous touchons consciemment ce niveau, nous sommes connectés à cette force que le corps a mise en place.

## Développement du tissu mésodermique

Nous arrivons à la deuxième impulsion, la deuxième vague, qui va former le **tissu mésodermique**.

J'obtiens ainsi une information initiale notochordale qui, avec ma ligne primitive, génère ce champ d'aspiration.

Ce dernier crée l'espace de ma ligne primitive, en contact avec la mise en place de mon **pédicule embryonnaire** et mes champs de **perméation** et d'**infusion** qui s'organisent.

C'est dans ce mouvement que s'opère l'intégration de mon mésoderme. Ceci se passe entre le **quatorzième** et le **seizième jour**.

Quand vous pratiquez, vous percevez d'abord cette sorte de **"Tai Chi"**, cette vague notochordale.

Puis, en dessous, en même temps que ce mouvement, il y a une invasion en dessous. C'est un **double mouvement**.
...
![Début neurulation](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-04/Mesoderme_128.jpeg)




![Développement embryonnaire précoce](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-04/Mesoderme_11.png)



![Gastrulation humaine 3 semaines](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-04/Mesoderme_2.png)



![Gastulation humaine](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-04/Mesoderme_5.jpeg)



![Gastrulation embryonnaire humaine](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-04/Mesoderme_13.png)



![Migration mésenchymateuse](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-04/Mesoderme_3.png)



![Gastrulation 16 jours](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-04/Mesoderme_4.jpeg)
...
![Système cardiovasculaire](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-05/Mesoderme_9.png)



![Développement système lymphatique](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-05/Mesoderme_73.png)



![Veines œsophagiennes collatérales](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-05/Mesoderme_64.png)



![Circulation fœtale humaine](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-05/Mesoderme_174.png)
...
`,
  },
  {
    ...
    duration: "13:32",
    title: "5. Construction des Vaisseaux Primitifs",
    shortSummary: "Construction des vaisseaux primitifs dans l'embryon, analyse du mouvement des fluides et des forces embryonnaires. Étude des fondements de la formation vasculaire et développement des systèmes artériels et veineux primitifs.",
    fullSummary: "Cette vidéo explore la fascinante construction des vaisseaux primitifs au sein de l'embryon, mettant en lumière le mouvement des fluides et les forces embryonnaires qui agissent de l'extérieur vers le centre. Les concepts clés incluent le rôle vital de la cavité amniotique, l'importance d'une substance intercellulaire et les quatre composants nécessaires à la formation vasculaire. L'enseignement aborde également le développement des systèmes artériels et veineux primitifs, la polarité et les phases d'assimilation et de désassimilation, tout en soulignant comment ces processus interconnectés forment la base des réseaux vasculaires embryonnaires. Cette connaissance est indispensable pour tout praticien désireux de comprendre les fondements anatomiques et physiologiques du développement humain.",
    transcriptMarkdown: `
# Construction des Vaisseaux Primitifs

## 1. Mouvement des fluides et forces embryonnaires

Au moment où l'embryon pénètre la **muqueuse utérine**, toute la force fluidique provient de l'extérieur et se centre à l'intérieur de l'embryon. La **force embryonnaire** se développe de la périphérie vers le centre, que ce soit sur le plan fluide, veineux ou artériel. Tout se ramène vers le centre.

## 2. Rôle de la cavité amniotique et de la vésicule vitelline

L'intégration des fluides est permise par la **cavité amniotique**. L'ébauche du système vasculaire apparaît dans le **mésoblaste splanchno-pleural**, au niveau de la paroi de la **vésicule vitelline**, du **chorion** et du **mésenchyme intra-embryonnaire**. Cela se manifeste sous forme de petits îlots vasculaires dans la vésicule vitelline. La cavité amniotique permet l'intégration de cette cavité vitelline vers le centre, marquant les stades vitellin, placentaire et néonatal.

## 3. Les quatre composants essentiels à la formation vasculaire

Pour qu'il y ait une **cinétique** et une formation des vaisseaux, quatre composants sont toujours nécessaires :

1. La présence d'une **substance intercellulaire**.
2. Une **concentration chimique locale**.
...
Un grand réseau se développe à partir de la vésicule vitelline, mais aussi à partir du chorion. L'embryon se développe initialement sous une forme de **"raquette"**, avec un **pédicule embryonnaire**. La **notochorde**, située en dessous de la ligne primitive, influence la plaque neurale. Les cellules de la plaque neurale ne croissent pas à la même vitesse que les cellules environnantes, entraînant le développement d'une **gouttière**.

## 5. Restructuration du flux et formation des vaisseaux

Cet espace de gouttière conduit à une restructuration du **flux métabolique trophique** au sein du mésoderme, sous forme de trajectoires fluidiques bilatérales. Dans le développement mésodermique, de petites **vacuoles** apparaissent. C'est un processus de croissance où le tissu mésodermique fluidique est aspiré. Ces vacuoles grandissent, organisant une trajectoire avec une concentration importante et des substances intercellulaires.

Tous ces composants permettent la formation d'un vaisseau. Ces structures continuent de croître pour former ce qu'on appelle un **champ de corrosion**. Lorsque ces champs se rencontrent, le tissu qui nourrit la membrane cède, permettant le développement progressif d'un vaisseau.

## 6. Polarité et phases d'assimilation et de désassimilation

Un champ d'aspiration, donné par cette vague et ce processus méthodique, est essentiel. Deux mouvements sont à l'œuvre : un mouvement **autocordal** et un mouvement d'aspiration sous-jacent. La notochorde réorganise l'ectoderme sous forme de gouttière, organisant des trajectoires bilatérales autour du tube neural. Les vacuoles se rencontrent, formant le premier vaisseau, appelé **vaisseau d'assimilation**. Les cellules s'en nourrissent.

On observe une **polarité** : la nourriture arrive depuis l'ectoderme, créant une aspiration. Initialement, la congestion est faible, mais elle devient plus importante dans une phase ultérieure.

## 7. Apparition des systèmes artériels et veineux primitifs

Cette phase congestive recrée une phase d'élimination. Un vaisseau de type **artériel** apparaît par la phase d'assimilation (champ d'aspiration). Ensuite, par la phase de retour et l'élimination des **catabolites**, un deuxième niveau se développe : un **réseau descendant**.

Il y a donc un système d'abord d'assimilation d'informations, puis un deuxième plan de désassimilation. Le premier développe le **système artériel primitif**, le second le **réseau veineux secondaire**. Ces deux trajectoires fluidiques de retour sont l'ébauche de la **veine cardinale** et des deux **aortes primitives**. Le système veineux est plus latéral et extérieur que les aortes primitives.

## 8. Réseaux embryonnaires primitifs

Le premier réseau vasculaire qui se développe est celui des **aortes primitives**, sous la dépendance du mouvement développemental. Le soulèvement entre l'ectoderme et l'endoderme aspire depuis la ligne primitive, qui devient le mésoderme. 

Le mésoderme, par le développement de la plaque neurale, se réorganise et crée des trajectoires avec des vacuolisations. Ces vacuolisations, par le champ d'aspiration, créent les composants nécessaires pour former une **double aorte** qui se rejoindra vers la ligne médiane. Latéralement et antérieurement, un retour se fait sous forme de trajectoires des veines cardinales. 

Ainsi, le premier réseau embryonnaire est un réseau aortique primitif d'assimilation nutritive, et le retour est la phase de désassimilation. Ce premier réseau vasculaire est donc constitué :

1. Des **aortes primitives**.
2. Du réseau des **veines cardinales**.

Le tout est intégré par le **pédicule embryonnaire** et le **système vitellin**. Le système vitellin est crucial pour le système viscéral.

## 9. Le rôle de la rate et du foie dans l'équilibre volémique et vasculaire

Les quatre composants pour tous les vaisseaux sont essentiels. Des cas cliniques montrent que des changements volémiques peuvent recréer des champs vasculaires. Par exemple, chez une patiente anémique due à un problème de fer, la **rate**, régulatrice de volume, peut augmenter le volume sanguin en ramenant des globules rouges.

La rate peut "réouvrir" et remettre une concentration, relançant d'anciens réseaux vasculaires qui s'étaient atrophiés. Toute malformation de la rate est liée à une malformation du système vasculaire. La rate est fondamentale pour rééquilibrer le volume du système, en adaptant sa volumétrie aux besoins métaboliques.

## 10. Synthèse des composantes vasculaires primitives

La phase d'assimilation, organisée par la notochorde et le tube neural, réorganise une gouttière et une trajectoire. Elle inclut les composants nécessaires :

* La **trajectoire**.
* La **vacuole**.
* La **concentration métabolique**.
* La présence de **substances intercellulaires**.

Ces éléments donnent naissance à un système vasculaire primitif d'assimilation (système artériel primitif) et, par le retour, à un système de désassimilation (système veineux). Les premières aortes primitives et les deux veines cardinales (veines cardinales primitives) constituent ce premier réseau vasculaire.
...
![Pliure embryonnaire latérale](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-06/Mesoderme_76.jpeg)
...
## Le Cœur et la Distribution de l'Information
...
La rupture de la **symétrie** se fait dès la mise en place du processus **notochordal**. Il y a un flux nodal avec des petits cils qui amènent des vésicules cérébrales de la droite vers la gauche, via la sonétique **HH**, le **FGH8**, et finalement un changement d'acide **rétinoïque**.
...
Cette rupture de la symétrie sera un des facteurs qui positionnera le cœur vers la gauche dans le futur. Cela se fait par des **molécules morphogénétiques**, avec une augmentation du taux calcique sur toute une lame latérale, et donc toute l'information de l'intégration génétique sera différente.
...
L'importance de ces points est cruciale. Le deuxième point sera le moment où j'ai la vague, c'est-à-dire le passage de la mise en place de ma **troisième chambre embryonnaire**, le **cœlome** ou le **léciteux cellexterne**.
...
Elle se régénère jusqu'à un certain temps par votre **sommeil**, votre **alimentation**, votre **respiration**, vos justes pensées, etc. Vous la dégénerez si vous ne respectez pas cela et si vous êtes intoxiqué.
...
![Embryon humain 3 semaines](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-07/Mesoderme_10.jpeg)
...
![Développement cardiaque embryonnaire](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-08/Mesoderme_18.png)
...
![Développement veineux cardiaque](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-08/Mesoderme_36.jpeg)
...
Sur un plan fonctionnel, on ne peut pas séparer le reste de cette cavité ; elle est toujours intégrée. Le **cœlome externe**, par le mouvement de développement de l'embryon, s'intégrera en grande partie en **cœlome interne**.

Le reste partira sous forme d'exsudat à l'extérieur, repoussé par la cavité amniotique. À un certain moment de la croissance, le cœlome externe ne se développe plus.
...
![Épiblaste, streak, cœur](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-08/Mesoderme_12.png)



![Développement cellulaire cardiaque](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-08/Mesoderme_14.png)



![Tube neural précoce](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-08/Mesoderme_15.jpeg)



![Développement cardiaque embryonnaire](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-08/Mesoderme_17.png)



![Développement embryonnaire coeur](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-08/Mesoderme_138.jpeg)
...
`,
  },
  {
    ...
    duration: "11:04",
    title: "8. Le Coeur Dynamique du Mouvement Developpemental",
    shortSummary: "Analyse du développement embryonnaire du cœur, incluant le rapprochement des tubes endocardiques, le mouvement en 'looping' et les processus d'inversion. Discussion sur la dynamique cœur-foie et l'importance de l'empreinte embryonnaire en ostéopathie.",
    fullSummary: "Cette vidéo plonge au cœur de l'embryologie cardiaque, explorant les étapes fondamentales de la croissance du cœur au début du développement embryonnaire. On y aborde des concepts clés tels que le rapprochement des tubes endocardiques, le mouvement en 'looping' et les processus d'inversion qui transforment le cœur. Le formateur souligne l'importance de la compréhension de la dynamique entre le cœur et le foie, ainsi que la nécessité de suivre l'empreinte embryonnaire pour mieux accompagner les patients. En intégrant ces connaissances, les praticiens pourront affiner leur approche biodynamique, favorisant ainsi un développement harmonieux chez leurs patients.",
    transcriptMarkdown: `
...
Portons notre attention sur un orifice, l'**orifice futur du cœlome intra-embryonnaire**. Il faut l'imaginer ici. Il va, plus tard, transformer ce cœlome externe en un cœlome interne.
...
![Pliage embryonnaire latéral](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-09/Mesoderme_149.jpeg)



![Embryon avec allantoïde](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-09/Mesoderme_150.jpeg)



![Schéma explicatif](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-09/Mesoderme_09.jpeg)



![Développement du tube neural](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-09/Mesoderme_143.png)



![Plaque neurale, gouttière](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-09/Mesoderme_129.jpeg)



![Développement tube digestif embryonnaire](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-09/Mesoderme_16.jpeg)



![Circulation embryo liquide
céphalo-rachidien](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-09/Mesoderme_60.jpeg)
...
## 1. Interaction Cœur - Yeux

Premièrement, le cerveau va s'enrouler autour du cœur. Une information significative est transmise au niveau des **placodes optiques**, directement sur le cœur. On pourrait presque dire que les **yeux** vont se "déposer" sur le cœur.

## 2. Interaction Cœur - Mains

Vous verrez également une autre interaction : l'ébauche des **membres** va venir se déposer sur le cœur. Ceci informe complètement le cœur. N'oubliez pas que le cœur reçoit une information très importante sur le plan de la **crête neurale**, un plan **électromagnétique** qui nous permet de sentir le cœur à distance. Cette information va imprégner vos mains sur un plan rythmique.

## 3. Interaction Cœur - Thyroïde et Voix

Il y a une autre partie que nous ne voyons pas directement, mais dans cet enroulement, tout le **système thyroïdien** vient se déposer sur le cœur. Ceci s'accompagne à un moment donné de l'ouverture du développement vers le haut, ce qui formera le **système des cordes vocales**. On dit souvent que la **langue** est le bourgeon du cœur. Or, la langue est liée à la thyroïde et transmet des informations.

## La Connexion Cœur-Corps : Perception et Communication

Quand je touche quelqu'un, je le touche avec une information reçue de mon cœur. Je dois maintenir cette connexion. Vous verrez que cela changera grandement votre perception.

* **Le Regard :** Quand je regarde quelqu'un, je dois le regarder avec mon cœur. Les deux sont connectés. Le cœur est informé sur un plan embryonnaire, recevant une information purement électromagnétique.

* **La Parole :** Troisièmement, quand je parle, je dois parler avec mon cœur. Je reçois cette information thyroïdienne, une information électrique.

J'ai donc trois champs magnétiques d'informations. Quand nous recevons cette information, nous devons être très attentifs à :
...
Initialement, elles proviennent de la **vésicule ombilicale**, où l'on trouve les **mégaloblastes primitifs**. Cette phase dure les deux premiers mois.
...
![Circulation fœtale humaine](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-11/Mesoderme_172.png)
...
![Circulation foetale](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-11/Mesoderme_171.png)
...
![Embryon bicellulaire](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-12/Mesoderme_85.jpeg)
...
C'est le vestige sous S2, extrémité terminale de la **notochorde** et lieu de la sensation. 
...
![Croissance relative moelle épinière](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-12/Mesoderme_121.jpeg)
...
Cette intégration du cœlome, et en même temps l'intégration du cerveau, du cœur, du diaphragme, la partie postérieure du péritoine, pour revenir sur le **périnée** et redonner par cette bascule du foie toute la fermeture de ma ligne blanche, qui donnera toute l'information **urogénitale**.
...
Sur cette ligne blanche, nous pourrons rechercher des concentrations de temps cristallisées, car c'est une ligne de probabilité en rapport avec l'**érythrocyte**, la formation des globules, donc un futur, où le plan de la **copula** est aussi ton futur.
...
Il existe une **prédominance innée** chez certaines personnes, qui peuvent manifester une fonction **systolique** ou **diastolique**. Un équilibre entre ces deux fonctions est normalement requis. Le cœur répète son mouvement embryonnaire de manière assez directe.

## Mouvements du Cœur et Implications Émotionnelles

Un mouvement spécifique peut être ressenti. Par exemple, les personnes trop orientées vers un mouvement de **systole** sont souvent en recherche, mais peuvent aussi s'épuiser rapidement. À l'inverse, d'autres partent de ce point et cherchent constamment un point d'appui inférieur.

## Le Looping Ventriculaire et les Phases Cardiaques

Le cœur effectue un **looping** caractéristique, où le système **ventriculaire**, initialement supérieur, devient inférieur, avec un point d'appui crucial entre les **oreillettes** et les **ventricules**.

* **Pendant la systole :**
  * Le cœur effectue une **montée**.
  * Il réalise un mouvement de **supination**.
  * Il a tendance à se **verticaliser**.
  * Il procède à une **détorsade**.

C'est à ce moment que l'**aorte** s'ouvre pour accueillir tout le sang, provoquant une **congestion**.

* **Pendant la diastole (descente) :**
  * Tout le sang de l'aorte est éjecté dans le système.

Il est parfois facile de confondre le mouvement systolique avec le mouvement de descente. La systole est le moment de l'**éjection**. Quand le cœur redescend, il se **re-remplit**.

Lorsque le volume est éjecté, la pression dans le système de la crosse aortique augmente. Au moment de la descente, le cœur se remplit tout en éjectant l'aorte.

## Orientation du Cœur : Verticalisation vs. Horizontalisation

Avez-vous l'impression que le cœur a tendance à se **verticaliser** ou à s'**horizontaliser** ? Est-ce qu'il se verticalise et monte, ou s'il s'horizontalise et descend ?

## Points d'Appui pour l'Observation

Nous allons prendre trois points d'appui :

1. Au niveau de l'**espace aortique** (deuxième espace intercostal).
2. Au niveau de l'**espace pulmonaire**.
3. L'**éminence hypothénar** va se déposer sur la pointe du cœur.

## Les Systèmes Influents du Cœur

Le cœur réagit en fonction de deux grands systèmes qui lui sont très proches et tend à les aider au maximum :
...
Il cherche toujours à maintenir cette pression dans son environnement. Le cœur est un **régulateur de volume**. Il faut considérer le cœur comme une grosse artère se prolongeant avec l'aorte, comme un **octopus**.

## Mouvements de Supination et Pronation

Nous aurons un mouvement de **supination**, puis un mouvement de **pronation**.

## Évaluation Manuelle et Réactivité Fasciale

Nous allons observer l'environnement et comment il est agencé. Ensuite, nous placerons les mains au niveau du foie et observerons sa réaction sur un plan **fascial**.

L'aorte, si vous l'observez bien au niveau anatomique, part en fait assez en arrière, ce qui la rend difficile à visualiser. Cependant, elle partage un environnement fascial commun avec les **bronches** et l'**œsophage**, qui viennent s'insérer au niveau d'une vertèbre souvent en adaptation.

## Les Zones Rythmiques et la Relation Diaphragmatique

Il existe :

* Une zone **neurosensorielle**.
* Une zone **rythmique**.
* Une zone **métabolique**.
* Une zone **urogénitale**.

Pour un bon mouvement, le cœur doit avoir une bonne relation avec le **diaphragme**. Il existe une relation directe via la continuité fasciale de la crosse et de l'aorte. 

Rappelez-vous le passage très profond de l'aorte, où les **piliers diaphragmatiques** s'insèrent de part et d'autre. Pour travailler le cœur, il est essentiel que le diaphragme soit **ouvert** et **souple**. N'oubliez pas l'autre passage important au niveau de l'œsophage.

## Application Pratique : Suivi des Mouvements Fascials

Nous avons étudié le **fulcrum embryonnaire pré-pattern** qui se positionne au niveau de la ligne primitive, au niveau du coccyx, avec le point d'arrivée. 
...
`,
  },
  {
    ...
    duration: "03:38",
    title: "14. Le Coeur Rappel Taichi &  Pratique",
    shortSummary: "Interactions entre le cœur, le cerveau et le système circulatoire, avec un focus sur les mouvements embryonnaires et les bases théoriques. Techniques palpatoires pour évaluer le cœur, le foie et les reins, en lien avec les émotions.",
    fullSummary: "Cette vidéo enseigne comment le cœur interagit avec le cerveau et le système circulatoire à travers des mouvements embryonnaires, tout en révisant les bases théoriques du système cœur-cerveau. Vous apprendrez des techniques palpatoires spécifiques pour évaluer le cœur, le foie et les reins ainsi que leur impact émotionnel, notamment comment le rein est lié à la peur. En intégrant ces concepts avec la pulsologie, vous développerez une approche thérapeutique holistique, permettant de soutenir le corps dans son cheminement de guérison.",
    transcriptMarkdown: `
# Le Cœur : Rappel Taï-chi & Pratique

## Introduction au Système Cœur-Cerveau

Nous allons explorer le lien intrinsèque entre le **cerveau**, le **cœur** et le **système circulatoire**.

Le **système mésentérique**, en tant qu'axe de rotation du développement péritonéal, effectue un mouvement de descente. Ce mouvement du cerveau est synchronisé avec les mouvements des **reins** et du **foie**.

Nous réexaminerons la **motilité** du développement du cerveau et l'intégrerons à nos connaissances cardiaques, pour comprendre comment le cœur soutient le cerveau.

N'oubliez pas que le cœur peut être positionné dans la **vésicule vitelline** dès les premiers stades.

## Évaluation par Palpation : Repères et Observations

Pour commencer, je prends un repère précis : l'**angle de Louis**. Je sais qu'il se situe au niveau de mon **deuxième espace intercostal**.

Je place mon majeur sur l'angle de Louis, puis je dépose ma main et l'aligne avec l'axe du cœur.

### Observation Cardiaque

Face à moi, le cœur est en **pronation**, ce qui correspond à la **diastole**. Cela indique qu'il est en quête, en recherche.

Dans l'engagement de sa vie, il est un peu en renonciation, plus en retrait que dans son action.

### Évaluation Hépatique

Je place ensuite ma main au niveau hépatique, avec une pression très légère, comme si une **fourmi** y était posée que l'on ne peut pas écraser.

J'observe le foie. S'il est plutôt horizontal, cela peut signifier qu'il est légèrement **gonflé**.

Il a tendance à se diriger par ici.

### Évaluation Rénale

Maintenant, examinons les reins. Je palpe un rein et constate qu'il est également en pronation.

Cela indique qu'il est plus enclin à sa lésion, ce qui signifie que c'est le rein qui le déstabilise ici, tandis que le foie lui apporte un soutien.

Le rein est émotionnellement lié à la **peur**. Le patient cherche un point d'appui, mais son histoire est bloquée à ce niveau.

Chez ce patient, je travaillerai donc les reins pour soutenir son cœur.

## Mouvements Embryonnaires et Soutien Thérapeutique

Je vous rappelle que le **mouvement embryonnaire** des poumons est distinct.

Alors que celui du cœur est différent. Observez la différence dans ces mouvements.

![Rotation des organes](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-15/Mesoderme_77.jpeg)
...
Observez ce qu'il se passe. Sentez-vous la différence ? Le corps cherche à se réorganiser de lui-même.

Plus tard, nous explorerons la motilité du développement du foie et des reins, ainsi que leur lien avec le **système vasculaire**.

## Le Cœur et la Pulsologie

Il est essentiel de retenir que le cœur, dans sa forme, est le reflet de l'écho de sa périphérie.

C'est pourquoi la **pulsologie** est un domaine si fascinant. Elle permet de distinguer :

* Un **pouls** de type artériel pur.
* Un pouls de type veineux, accompagné de **stases**.

Pour moi, il y a des stases, probablement localisées dans la zone hépatique.
...
![Développement coeur système veineux](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-16/Mesoderme_38.jpeg)
...
*   **L'ombilical :** Disparaît en grande partie, laissant un système fibreux terminal. Un vaisseau terminal persistant peut former le **diverticule de Meckel**, une petite poche située juste avant la valve iléo-cœcale, pouvant être à l'origine de diverticulites.

## Le Système Cardinal

Le système cardinal se divise en :

![Système veineux embryonnaire](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-16/Mesoderme_39.jpeg)
...
## Les Composants du Vaisseau et les Changements de Trajectoire

Pour qu'un vaisseau existe, quatre composants sont nécessaires :

1.  La **trajectoire**.
2.  La **concentration métabolique**.
3.  La **vacuolisation**.
4.  Le **fluide interstitiel**.
...
![VCS et VCI embryonnaires](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-16/Mesoderme_41.jpeg)
...
![Développement embryonnaire cardiaque](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-16/Mesoderme_51.jpeg)
...
![Embryon 35 jours vascularisation](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-16/Mesoderme_42.jpeg)
...
![Système veineux embryonnaire](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-16/Mesoderme_43.jpeg)
...
![Système veineux profond](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-16/Mesoderme_71.jpeg)




![Développement veine cave inférieure](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-16/Mesoderme_40.jpeg)



![Développement Système Veineux](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-16/Mesoderme_45.jpeg)
...
`,
  },
  {
    ...
    shortSummary: "Analyse de la structuration du système veineux vitellin et ombilical, avec le développement du foie à partir de tissus mésodermiques et endodermiques. Examen des dynamiques veineuses et de leur rôle dans la santé métabolique.",
    fullSummary: "Cette vidéo offre une exploration approfondie du système vitellin et ombilical, en mettant l'accent sur le développement du foie à partir de tissus mésodermiques et endodermiques. Elle détaille les différentes étapes de formation du réseau vasculaire hépatique, y compris les veines vitellines et ombilicales, ainsi que leurs interactions complexes. Les concepts clés tels que la céphalisation, la cardialisation, et les deux courants du système portal hépatique sont expliqués, soulignant l'importance de ce réseau pour le drainage sanguin et la santé métabolique globale. Les impacts émotionnels liés aux organes digestifs sont également abordés, enrichissant ainsi la compréhension biodynamique du corps humain.",
    transcriptMarkdown: `
...
![Embryon système vasculaire hépatique](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-17/Mesoderme_52.jpeg)
...
![Circulation embryonnaire 28 jours](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-17/Mesoderme_53.jpeg)
...
![Circulation embryonnaire 8 semaines](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-17/Mesoderme_54.jpeg)
...
![Circulation veineuse embryonnaire](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-17/Mesoderme_58.png)
...
![Embryon, veines hépatiques](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-17/Mesoderme_59.jpeg)
...
![Système porte 12 semaines](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-17/Mesoderme_55.jpeg)
...
![Système porte hépatique](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-17/Mesoderme_61.jpeg)
...
![Circulation fœtale](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-17/Mesoderme_173.png)
...
![Veine Portale Anatomie](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-17/Mesoderme_63.jpeg)
...
![Système veineux humain](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-17/Mesoderme_37.jpeg)
...
![Système porte embryonnaire](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-17/Mesoderme_57.png)



![Système veineux définitif](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-17/Mesoderme_46.jpeg)
...
`,
  },
  {
    ...
    duration: "08:04",
    title: "17. Systeme Vasculaire Arcs Banchiaux",
    shortSummary: "Développement du système vasculaire embryonnaire, impact des arcs branchiaux sur le crâne et le tube digestif, éléments pertinents pour l'ostéopathie.",
    fullSummary: "Cette vidéo explore le développement du système circulatoire à partir des îlots vasculaires sanguins, mettant l'accent sur l'évolution du système aortique primitif et des veines cardinales. Les arcs branchiaux, qui jouent un rôle fondamental dans la structure vasculaire et squelettique, sont analysés en détail, notamment leurs dérivés et leur influence sur le crâne et le tube digestif. En plus d'explorer les relations vasculaires, la vidéo souligne l'importance de l'équilibre dans la circulation sanguine et lymphatique, offrant des perspectives pratiques pour l'ostéopathie. Les fonctions spécifiques des arcs branchiaux et leurs contributions morphologiques à des structures telles que l'artère maxillaire et le système hyoïdien sont également abordées, fournissant une compréhension approfondie nécessaire pour des manipulations thérapeutiques efficaces.",
    transcriptMarkdown: `
...
![Développement vasculaire embryonnaire](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-18/Mesoderme_23.jpeg)
...
![Circulation embryon 4 semaines](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-18/Mesoderme_24.png)
...
![Embryon 29 jours](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-18/Mesoderme_27.png)
...
![Arcs aortiques embryonnaires](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-18/Mesoderme_29.png)
...
![Système vasculaire embryonnaire](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-18/Mesoderme_30.png)
...
![Arcs aortiques embryonnaires](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-18/Mesoderme_31.png)
...
![Dérivés arcs pharyngiens](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-18/Mesoderme_34.jpeg)
...
* **Lymphe :** Elle est responsable de l'élimination, notamment l'élimination toxique, et joue un rôle dans l'immunité.
...
![Embryon 7 semaines, appareil digestif](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-18/Mesoderme_28.png)



![Système artériel embryonnaire](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-18/Mesoderme_33.jpeg)



![Vascularisation tête humaine](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-18/Mesoderme_35.png)
...
`,
  },
  {
    ...
    duration: "07:29",
    title: "18. Le Systeme Veineux Notes",
    shortSummary: "Analyse de l'influence du système veineux sur la santé globale, avec des explications sur les congestions et le drainage veineux, accompagnées de solutions thérapeutiques.",
...
![Plexus vertébraux](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-19/Mesoderme_72.jpeg)
...
![Système veineux humain](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-19/Mesoderme_68.jpeg)
...
![Veine iliaque interne](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-19/Mesoderme_69.jpeg)
...
![Vascularisation pelvienne vue postérieure](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-19/Mesoderme_70.jpeg)
...
La **citerne de Pécquet** (ou de Chyle) est un réseau très important, responsable d'une grande résorption au niveau de la fosse clavière gauche. Les **muscles psoas**, grâce au **fascia périrénal**, drainent jusqu'à 1,5 litre de lymphe par jour par leurs mouvements.
...
![Sinus veineux crâniens](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-19/Mesoderme_67.jpeg)
...
`,
  },
  {
    ...
    duration: "05:54",
    title: "19. Resume de La Structuration Vasculaire par La Cavite Amiotique",
    shortSummary: "Structuration vasculaire par la cavité amniotique et intégration avec le système vitellin, éléments cruciaux pour le développement embryonnaire. Analyse des mouvements de résorption et de l'intégration artérielle, ainsi que des dynamiques internes affectant la santé embryonnaire.",
    fullSummary: "Cette vidéo explore en profondeur la structuration vasculaire par la cavité amniotique, mettant en lumière son intégration avec le système vitellin et son rôle dans le développement embryonnaire. Les concepts clés abordés incluent le mouvement de résorption vers le centre de l'embryon, l'intégration artérielle, et l'importance de la cavité amniotique dans la redéfinition des espaces internes. Les mouvements essentiels tels que la céphalisation, l'enroulement embryonnaire, et le rapatriement des fluides sont discutés, tout en soulignant l'impact du système notochordal et du tube neural. Cette connaissance est cruciale pour les praticiens cherchant à reconnaître les dynamiques internes qui influencent la santé embryonnaire et le bien-être global.",
    transcriptMarkdown: `
...
![Système notochordal ou une vue transversale de l'intégration, correspondant au texte](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/mesoderme-intro/Mesoderme_5.jpeg)



Nous allons suivre ce mouvement pas à pas. Il est essentiel de "laisser faire" la respiration primaire.

![L'image la structure veineuse viscérale mentionnée dans le résumé, et cette phrase marque une transition vers la notion de 'mouvement'](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/mesoderme-intro/Mesoderme_6.jpeg)
...
![L'image correspond à la description de l'intégration des systèmes comme le vitellin et hépatique](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/mesoderme-intro/Mesoderme_7.jpeg)
...
![Régression de la vésicule vitelline et la formation du cordon ombilical, ce qui est logique après la mention du 'retour'](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/mesoderme-intro/Mesoderme_8.jpeg)

 La vésicule vitelline, poussée par la vitesse de croissance différentielle, sera reprise dans le schéma.

![Cordon ombilical formation](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-21/Mesoderme_66.png)
...
![Fœtus dans l'utérus](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-21/Mesoderme_165.png)
...
`,
  },
  {
    ...
    duration: "02:50",
    title: "20. Pratique de Structuration du Systeme vasculaire",
    shortSummary: "Structuration du système vasculaire, axée sur le neutre thérapeutique et la respiration primaire. Compétences pratiques pour étudiants et praticiens en ostéopathie.",
    fullSummary: "Cette vidéo vous plonge dans la pratique de structuration du système vasculaire, en mettant l'accent sur l'importance de trouver et d'émerger le neutre chez le patient. Grâce à des techniques telles que le champ micro-cristallin et l'immobilité dynamique, vous apprendrez à créer un environnement propice à la guérison en intégrant les concepts de silence dans la pièce et mobilité au niveau des piliers diaphragmatiques. La session se concentre aussi sur la cavité amniotique et l'importance de la respiration primaire comme souffle de vie, essentielle pour une approche thérapeutique holistique. Cette approche offre une opportunité d'apprendre non seulement comment intervenir, mais aussi comment laisser les processus naturels du corps s'épanouir.",
    transcriptMarkdown: `
...
Je vais vous guider à un moment donné. Nous partirons du **neutre** et laisserons petit à petit le neutre du patient se développer. Nous allons nous concentrer sur le **champ micro-cristallin**, en prenant tout l'espace.

Pour avoir une action thérapeutique la plus efficace possible, il est essentiel d'atteindre un neutre. Ensuite, il est important de faire émerger ce neutre chez le patient. C'est un processus qui doit **maturer**.

Pour cela, il faut le **meeting point**, le point de rencontre. Une fois que j'ai établi ce point de rencontre, la personne, en confiance, peut progressivement se désengager, se laisser aller et aller vers son neutre.

Petit à petit, ces deux neutres vont commencer à se mélanger. Une fois que ces deux neutres se mélangent, un espace, une **émergence** plus visible peut apparaître : ce qu'on appelle la **respiration primaire**.

La respiration primaire n'est pas uniquement présente dans le corps, elle est omniprésente, un peu comme le **souffle de vie**.

Nous allons nous concentrer sur la **cavité amniotique**, cette zone B. En même temps, nous dissocierons notre attention pour nous focaliser sur les **piliers diaphragmatiques**.

Le point le plus fixe de mon diaphragme est constitué par les piliers. Nous allons constater que, finalement, nous atteindrons un neutre. Ce sont des points d'appui énormes, presque un point silencieux.

Avec un peu de patience, nous ferons émerger le neutre de manière plus large, en utilisant également le **silence cristallin**.

Nous parlerons plutôt de l'**immobilité cristalline** de la pièce. Il existe une forme d'immobilité dans la zone C que nous devons percevoir. Nous laisserons le corps se centrer par rapport à cette zone C.

Bien que cela puisse sembler subtil, cela se fera naturellement sur un plan **fluidique**, presque électrique.

Ensuite, nous commencerons à faire confondre ce silence de la pièce, ou cette immobilité dynamique de la pièce, avec l'immobilité dynamique au niveau des piliers diaphragmatiques.

Tout en étant conscient de la cavité amniotique et de l'intégration de ma **vésicule vitelline** pour former mon système veineux, nous allons faire confondre ce silence de la pièce avec l'immobilité dynamique.
...
Vous allez prendre contact avec le patient de la manière la plus douce possible. C'est comme demander une **communication**, une **autorisation**. Le mouvement présent, c'est la santé.

## La Perception du Corps

Nous touchons comme si nous avions des **fourmis** qui pourraient partir, mais qui ne le peuvent pas, et que nous ne pouvons pas écraser. Prenez le temps, laissez maturer encore votre neutre, positionnez-vous parfaitement.

Permettez à la **respiration thoracique**, et petit à petit à la respiration primaire, de se synchroniser. Vos mains se mettent sur le **champ micro-cristallin**, c'est-à-dire que vous prenez l'entièreté de la personne, même son **aura**, sa **cavité amniotique**. Vous avez l'entièreté de la personne dans la main. La respiration bouge, le souffle de vie bouge, la respiration primaire, et la conscience de l'espace autour de vous.

Cette respiration a elle-même un point d'appui qui se trouve dans la **zone A**, dans le corps. La respiration, c'est comme une porte qui s'ouvre et une porte qui se ferme. S'il y a une porte qui s'ouvre et une porte qui se ferme, il y a comme une **charnière**, un point d'appui à cette respiration. Vous avez le silence ou l'**immobilité dynamique** dans la pièce.

Vous avez la respiration qui bouge et le souffle de vie, la respiration primaire. Petit à petit, votre neutre s'approfondit.

## Synchronisation et Immobilité

Vous vous synchronisez avec la respiration primaire, le souffle de vie, et votre respiration thoracique. Synchronisez-vous simplement.

Prenez conscience de l'**immobilité cristalline** de la pièce. Le point d'appui, le point immobile de ce pendule, représente le point d'immobilité de la respiration thoracique.

Vous restez dans l'espace, dans la présence de la conscience de l'espace. Vous avez en tête tout ce mouvement, l'immobilité qui est là, et son organisation transversale et longitudinale.

Quelque part, vous allez reconstruire cette couche. Au même moment, vous allez redonner toute la force des **fluides** vers le centre.

Vous avez la respiration, le souffle de vie, et la conscience de la pièce. L'immobilité.

## La Rencontre des Neutres

Petit à petit, avec un peu de calme, quand le neutre va s'approfondir, ces deux points de silence vont se confondre. Cela va donner une nouvelle qualité : le **silence**.

Pour cela, vous avez observé la respiration, la fin de l'expiration. Juste avant que le patient réinspire, il y a une conscience, il y a une porte. Mettez-vous dans cette qualité.

La respiration, l'immobilité cristalline de la pièce, le souffle de vie, et la rencontre, petit à petit, de ce **diaphragme**, de ces **piliers diaphragmatiques**, de ce point d'appui de la respiration, et de ce silence de la pièce, de cette immobilité de la pièce.

Petit à petit, les neutres doivent se rencontrer. Ils vont se confondre, ils vont s'unifier.

## Reconstruction et Régénération

Vous avez la **cavité amniotique** qui s'expand latéralement, comme un œuf qui vous entoure complètement et qui se reconstruit. Tout le système fluide se recentre.

- La zone A se calme.
- La zone B se reconstruit.
- La zone C se confond avec l'immobilité.

Avec l'immobilité dynamique du point d'appui de la respiration. Laissez le neutre s'approfondir.

Cette **midline**, comme une fonction, est un centre de santé. C'est une ouverture à l'espace, il n'y a pas vraiment de distance. Laissez-vous placer par elle. Ouvrez votre champ perceptuel, périphérique.

## La Fonction Thérapeutique

La rencontre des deux neutres va créer, ouvrir la **fonction thérapeutique**. Maintenant, c'est la petite marée qui est présente.

Laissez-vous repositionner par elle. Elle ne peut pas être lésée. C'est ce qui va permettre, petit à petit, la juste réorientation spatio-temporelle de la forme et de sa fonction. **Unité** avec la nature.

Elle convertit les forces thérapeutiques. Laissons encore quelques minutes ce processus se faire. Abandonnez-vous.

La cavité amniotique, la zone B, se reconstruit. Le corps trouve ses points d'appui, ses points de silence pour renaître.

Il y a une pleine force de **régénération** qui se met en place, qui s'active.

## Alignement et Conscience

Portez votre conscience jusqu'à l'**horizon**. De votre ligne médiane jusqu'à l'horizon. Du centre de votre être jusqu'à l'horizon. De l'horizon jusqu'à votre ligne médiane.

La respiration, le souffle de vie. Petit à petit, il peut y avoir un **tight** qui arrive. Laissez-vous surprendre.
...
`,
  },
  {
    ...
    duration: "11:53",
    title: "22. Le Foie Généralités",
    shortSummary: "Origine embryologique du foie, incluant tissus de l'intestin et structures mésodermiques. Description de sa fonction exocrine et endocrine, ainsi que son développement, sa croissance, son hémodynamisme et ses relations avec le diaphragme.",
    fullSummary: "Cette vidéo explore l'origine embryologique complexe du foie, constitué de tissus provenant de l'intestin supérieur, moyen et inférieur, ainsi que de structures mésodermiques essentielles. Elle détaille la dualité fonctionnelle du foie, agissant à la fois comme glande exocrine pour la sécrétion de bile et glande endocrine grâce à son composant mésodermique. On y apprend également l'importance de la croissance embryonnaire et de l'hémodynamique dans le développement de cet organe vital. De plus, la vidéo souligne l'intégrité fonctionnelle et les relations anatomiques entre le foie et le diaphragme, illustre comment des déséquilibres peuvent mener à des dysfonctionnements, tout en insistant sur le rôle du diaphragme comme 'porte de la vie' qui influence directement la santé hépatique.",
    transcriptMarkdown: `
# Le Foie : Généralités
...
![Hypertension portale](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-24/Mesoderme_65.png)
...
![Embryon humain dissection](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-24/Mesoderme_25.png)
...
Cela signifie que nous allons poser nos mains et laisser le mouvement se faire. Nous pourrons avoir un mouvement qui recherche ou un mouvement qui exprime son originalité. Nous allons donner ce point pour que le système puisse se réorganiser.
...
`,
  },
  {
    ...
    duration: "03:58",
    title: "24. Pratique Le Foie",
    shortSummary: "Techniques douces pour stimuler la régénération du foie et optimiser les approches thérapeutiques.",
    fullSummary: "Cette vidéo explore l'interaction entre le mouvement de croissance hépatique et les organes environnants, en mettant l'accent sur l'importance de la position du foie sous le diaphragme et de l'axe aortique. À travers une approche délicate, l'enseignant guide les thérapeutes sur la manière de se connecter à la dynamique embryonnaire du foie, en cultivant une écoute et un neutre respectueux, alors qu'il encourage l'utilisation de gestes légers pour favoriser sa régénération. Les concepts de conscience de l'espace et de la respiration primaire sont également abordés, soulignant l'importance de la patience dans le processus thérapeutique.",
    transcriptMarkdown: `
# Pratique du Foie : Mouvement et Approche Thérapeutique

## Le Mouvement de Croissance Hépatique et ses Relations Anatomiques

Le **foie**, par son **mouvement de croissance**, exerce une influence majeure sur l'agencement des organes voisins. Il initie une **bascule sous-diaphragmatique**.

Cette croissance impacte la mise en place **gastrique**, ainsi que celle de la **poche rétro-gastrique**. Le **duodénum** et la **rate** sont également dépendants de cette expansion considérable du foie.

D'un point de vue **facial**, l'ensemble de ce système est suspendu à l'**aorte**. C'est un axe de référence crucial, car il constitue la voie principale de la **porte trophique**, autour de laquelle le système semble pivoter.

## Accompagnement du Mouvement Développemental du Foie

Pour accompagner ce mouvement, je me positionne légèrement au-dessus du **grill costal**. Mon objectif est d'exagérer le mouvement pour le visualiser, mais il s'agit d'un mouvement **développemental pur**.

Je me place en **écoute embryonnaire**, en établissant d'abord mon **neutre**. Mes mains sont posées, englobant délicatement, sans exercer de pression excessive.

L'image à retenir est celle des **fourmis** : il ne faut ni les écraser, ni les laisser s'échapper. Dans mon esprit, je visualise l'axe vasculaire aortique.

À la fin de l'expiration, je me connecte à cette qualité spécifique du foie, qui cherche à retrouver sa source, à revenir légèrement en arrière. Je le laisse faire.

## Premier Ressenti et Point d'Appui

Mon premier ressenti est qu'il n'est pas complètement libre dans son mouvement. Il cherche à se **régénérer**.

Je place un **point d'appui** avec mon coude, sans trop de force, et je donne ce point d'appui avec ma **respiration primaire**. Je laisse le neutre s'installer et le système se manifester.

Nous allons prendre l'axe du **cœur** et de la **veine cave**. Le mouvement est un peu plus délicat, difficile à mimer.

## La Conscience de l'Espace et du Neutre Thérapeutique

La deuxième étape est la **conscience de l'espace**, l'ouverture et la perception de cet espace. Vient ensuite la notion du **neutre**, essentielle.

Lorsque ce neutre commence à maturer, petit à petit, les deux neutres se rencontrent. C'est à ce moment que le processus devient **thérapeutique**.
...
`,
  },
  {
    ...
    duration: "06:56",
    title: "25. Le Systeme Renal Cinétique Embryonnaire Globale",
    shortSummary: "Formation du système rénal à partir du mésoderme et impact des forces embryonnaires sur son développement. Analyse des principes d'embryologie biodynamique pour les thérapeutes.",
    fullSummary: "Cette vidéo explore en profondeur la cinétique embryonnaire du système rénal, en commençant par son origine mésodermique, puis en illustrant comment les forces de flexion et d'endorotation influencent le développement des reins. Les concepts clés incluent le développement crânio-caudal des différentes étapes du rein – Pronéphron, Mésonéphron et Métanéphron – et la dynamique des mouvements de compression et de rotation au sein du mésoderme. Les thérapeutes apprendront à reconnaître comment ces mécanismes embryonnaires établissent les bases des systèmes organiques, offrant ainsi une meilleure compréhension de l'anatomie et de la physiologie humaine.",
    transcriptMarkdown: `
...
![Concept de la formation du rein par compression et flexion](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/mesoderme-intro/Mesoderme_11.jpeg)



![Embryon plan tridermique](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-27/Mesoderme_127.jpeg)
...
Au début de la cinquième semaine, l'embryon s'allonge. On observe un plus grand pli au niveau du **cœlome**.
...
![Développement crânio-caudal du rein (Pronéphron, Mésonéphron, Métanéphron) qui est le sujet du paragraphe](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/mesoderme-intro/Mesoderme_12.jpeg)
...
![Anatomie embryonnaire vertébrée](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-27/Mesoderme_92.jpeg)
...
Vers le **28e jour**, ce canal forme un premier pronéphron, caractérisé par un petit **glomérule**, première image d'un rein fonctionnel. C'est le moment de la **fermeture du tube neural**, de l'intégration du **cœlome externe** en cœlome interne, et de la délimitation de l'embryon.
...
Le canal de Wolff ou ductus mésonéphrophique induit le métanéphron, qui correspond à la partie terminale de la lame intermédiaire, celle-ci étant toute la lame postérieure de l'embryon.

## Développement Postérieur et Inflément
...
![Évolution du mésonéphros](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-28/Mesoderme_81.jpeg)
...
![Coupe embryon sagittal](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-29/Mesoderme_131.jpeg)
...
![Ascension rénale embryonnaire](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-29/Mesoderme_80.jpeg)
...
![Développement éminence/canal neural](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-29/Mesoderme_119.png)
...
`,
  },
  {
    ...
    duration: "05:27",
    title: "28. Pratique Reins Vessie",
    shortSummary: "Analyse des reins et de la vessie en embryologie biodynamique, avec une attention particulière sur la respiration primaire et les mouvements subtils en thérapie.",
    fullSummary: "Cette vidéo vous propose une exploration approfondie de la pratique des reins et de la vessie à travers le prisme de l'embryologie biodynamique. Vous apprendrez l'importance du trajet embryonnaire des reins et comment la respiration primaire influence l'équilibre corporel. Des techniques pratiques incluent la manipulation du sacrum et la reconnaissance des connexions entre les reins et l'utérus, révélant des tensions et des déséquilibres potentiels. Vous serez également guidé dans des exercices de rééquilibrage entre l'ecto et l'endo, tout en prenant conscience des processus de guérison inachevés liés aux mouvements de torsion des reins. Une approche sensorielle enrichissante pour tout thérapeute en quête de techniques pour optimiser la santé de leurs patients.",
    transcriptMarkdown: `
# Embryologie Biodynamique : Pratique des Reins et de la Vessie

## Le Trajet Embryonnaire du Rein et la Respiration Primaire

Le **trajet embryonnaire** du développement des reins est crucial dans une approche transgénérationnelle. La **respiration primaire** joue un rôle essentiel, où un décalage et une compression différentielle gauche-droite se manifestent, entraînant un mouvement perceptible.

## Pratique sur le Dos : Sacrum et Rein

Dans cette pratique, nous nous concentrons sur le **sacrum** et le **coccyx**. En prenant le sacrum en main, je peux imaginer manipuler les deux reins, mais je me concentre sur un seul. Dans le mouvement de **motilité**, le rein devient un point d'appui, permettant au sacrum de s'ouvrir et de descendre.

Je ressens que le sacrum rejoint le rein, ce qui indique un potentiel déséquilibre, soit au niveau digestif, soit neuronal. Un travail au niveau du **péritoine** pourrait être nécessaire pour libérer des tensions, notamment dans le champ magnétique de l'utérus.

## La Rotation Externe des Reins

La **rotation externe** des reins est une information puissante à ressentir à distance. Les aortes participent à ce mouvement, qui se manifeste par une **dorsorotation**. Ce mouvement est plus marqué à la fin du processus, alors que les aortes ne sont pas encore pleinement développées.

## Connexion avec un Vide et l'Utérus

Je ressens une attirance vers un **vide**, une reconnaissance qui pourrait indiquer un problème générationnel. En me connectant à cette sensation, je laisse la respiration primaire agir. Cela révèle qu'il y a quelque chose d'inachevé, en lien avec l'utérus, même en son absence physique. Cette concentration d'énergie peut se manifester ailleurs, souvent dans la nuque, où les gens transfèrent leur énergie.

## Pratique de Rééquilibrage Ecto/Endo

Nous allons effectuer une pratique simple et rééquilibrante, qui agit comme une articulation entre l'**ecto** et l'**endo**. En manipulant le tissu intermédiaire, je me concentre sur le **sacrum** et la loge rénale. Je garde à l'esprit l'**unité du corps**, en me rappelant de maintenir cette globalité et l'espace environnant. J'attends que le **neutre** émerge progressivement.

## Le Processus de Guérison Inachevé

Il existe une **santé** qui s'exprime, mais le processus semble inachevé. Cela évoque une personne en chemin, avançant pas à pas, parfois avec une certaine paresse. Cette prise de conscience peut motiver le rein à continuer son processus. Un frein persiste, surtout à gauche, et je l'intègre dans la respiration primaire, me plaçant dans la position du patient.
...
![This image seems to depict the effect of adrenals pushing gonads laterally, forming the Mullerian duct, as described](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/mesoderme-intro/Mesoderme_16.jpeg)
...
La crête génitale, informée et développée, est liée au développement du foie, qui crée un nouvel espace **rétropéritonéal**. 

Ce champ d'aspiration, typique des glandes, pousse les gonades et les reins, entraînant la disparition du **mésonéphros**. 
...
![Migration gonocytaire](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-32/Mesoderme_86.jpeg)
...
![Rôle général des canaux de Wolff et de Müller, en lien avec la section qui les introduit](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/mesoderme-intro/Mesoderme_17.jpeg)
...
![Génital mâle différencié](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-32/Mesoderme_95.jpeg)
...
![Anatomie appareil génital masculin](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-32/Mesoderme_97.jpeg)
...
![Descente testiculaire, un concept clé expliqué dans ce paragraphe](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/mesoderme-intro/Mesoderme_18.jpeg)
...
![Descente testiculaire fœtale](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-32/Mesoderme_100.jpeg)
...
![Différenciation testiculaire](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-32/Mesoderme_103.jpeg)
...
![Embryon 27 jours](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-32/Mesoderme_79.jpeg)



![Migration des gonocytes](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-32/Mesoderme_84.jpeg)



![Gonade indifférenciée](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-32/Mesoderme_87.jpeg)



![Différenciation gonadique embryonnaire](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-32/Mesoderme_90.jpeg)



![Canaux de Wolff](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-32/Mesoderme_96.jpeg)



![Anatomie prostate masculine](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-32/Mesoderme_98.jpeg)



![Migration testiculaire](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-32/Mesoderme_99.jpeg)
...
`,
  },
  {
    ...
    duration: "06:15",
    title: "31. L'Appareil Génital Féminin",
    shortSummary: "Analyse du développement embryonnaire du système génital féminin, formation des organes reproducteurs et leur impact sur la fertilité, avec des implications pour l'ostéopathie et l'embryologie biodynamique.",
    fullSummary: "Dans cette vidéo, nous explorons en profondeur le développement de l'appareil génital féminin, en commençant par la formation des canaux de Wolff et de Müller, et leur impact sur la structure reproductive. L'accent est mis sur la relation uro-génitale qui diffère entre l'homme et la femme, en mettant en lumière la création de l'utérus et des trompes. Nous approfondissons également le rôle des ligaments large et ovarien, ainsi que l'importance de la santé rénale dans la régulation hormonale et la fertilité. La vidéo aborde la continuité fasciale dans le pelvis et comment des anomalies comme les fibromes peuvent influencer l'ensemble de la dynamique corporelle, fournissant des informations cruciales pour les praticiens en ostéopathie et en développement embryonnaire.",
    transcriptMarkdown: `
# L'Appareil Génital Féminin

## 1. Ductus Mésonephrotique (Canal de Wolff) et Paranéphrotique (Canal de Müller)

Le **canal de Wolff**, également appelé **ductus mésonephrotique**, est le premier canal qui apparaît chez l'embryon. 

Chez l'homme, ce canal descend et est intégré entre les testicules pour former le **canal éjaculateur**. En revanche, le canal de Müller reste comme vestige et contribue à la formation du cœur de la prostate.

Chez la femme, la situation est inversée :
* Le canal de Wolff se différencie en **organes de Gardner**, qui sont des vestiges.
* Le canal de Müller, par fusion, devient l'**utérus** et les **trompes**.

### Développement Uro-génital

La relation **uro-génitale** est fondamentale. Chez l'homme, le canal épididymaire, le canal déférent et le canal éjaculateur se forment à partir de cette relation.

Chez la femme, ce développement ne se produit pas de la même manière. Le canal de Müller se réunit vers la ligne centrale pour former l'utérus.

Les organes de Gardner représentent les vestiges du canal de Wolff chez la femme. Le canal éjaculateur est orienté vers la base, et plus on s'écarte, plus il formera l'utérus. Moins on s'écarte, plus le vestige sera le **tricule prostatique**.

## 2. Le Ligament Large et les Ligaments Ovariens

Chez l'homme et la femme, le **péritoine pariétal postérieur** se concentre pour former le **ligament large**, ainsi que les petits ligaments ovariens et les ligaments ronds.

C'est le même tissu, mais avec des concentrations différentes. Ce péritoine pariétal postérieur va former l'utérus chez la femme.

Chez l'homme, ce mouvement n'existe pas, et il ne reste qu'une concentration de péritoine.

## 3. Le Rein et la Surrénale

Le rein est situé en dessous de la **surrénale**, séparés par une capsule. Cela signifie qu'une **ptose rénale** n'entraîne pas de ptose surrénalienne.

Ils sont séparés par un fascia appelé la **capsule de Glisson**. Le rein nécessite un espace graisseux.

Chez les femmes très minces, une ptose du rein peut entraîner des irrégularités menstruelles et une fertilité réduite. **Redynamiser un rein**, c'est également redynamiser sa fertilité.

### Développement Embryonnaire du Rein

Au départ, chez un petit embryon, les reins sont énormes, tout comme le foie. Cela rappelle le développement du cerveau, qui est très développé par rapport au tronc au début.

Ces proportions évoluent au cours du développement. Le foie joue un rôle important dans le développement des surrénales.
...
![Différenciation ovarienne](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-33/Mesoderme_102.jpeg)
...
![Formation utérus embryonnaire](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-33/Mesoderme_104.jpeg)
...
La **descente testiculaire** est due à la vitesse de croissance différenciée au niveau du **gubernaculum**, qui ralentit et tire tout le système.

Cette continuité fasciale entre l'utérus et toute la partie du fascia, de la peau et du petit bassin est essentielle.

## 5. Continuité Fasciale et Influence des Structures

On observe bien l'utérus, les ligaments, les ovaires et la **cavité péritonéale**.

![Appareil reproducteur féminin](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-33/Mesoderme_107.jpeg)



En soulevant l'utérus avec des pinces, on constate que tout bouge.

![Appareil reproducteur féminin](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-33/Mesoderme_108.jpeg)

 

L'impact d'un **fibrome** ou d'un **kyste** est significatif. La continuité avec les ligaments est primordiale.

![Utérus et musculature](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-33/Mesoderme_111.jpeg)
...
![Organes génitaux féminins](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-33/Mesoderme_112.jpeg)




![Appareil génital fœtal](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-33/Mesoderme_91.png)



![Appareil génital indifférencié](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-33/Mesoderme_94.jpeg)
...
![Développement tractus urogénital femelle](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-34/Mesoderme_115.jpeg)
...
![Vaginogenèse](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-34/Mesoderme_116.jpeg)
...
![Canal utéro-vaginal](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-34/Mesoderme_105.jpeg)
...
![Anatomie utérine féminine](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-34/Mesoderme_106.jpeg)
...
La descente du sacrum est influencée par le tube neural. Un autre point d'appui crucial est la combinaison du pubis et du sacrum, formant un équilibre fascial essentiel du petit bassin chez la femme.

Cet équilibre implique une ligne de force descendante relative au sacrum, influençant diverses fonctions du corps féminin.

## Approche Thérapeutique des Déséquilibres Utérins

Des situations comme les **fausses couches** laissent une empreinte énergétique dans l'utérus. Un nettoyage énergétique de l'utérus devient alors nécessaire.

Nous pouvons aborder l'utérus avec une **force magnétique**, apprenant à ressentir le champ énergétique à distance. Le praticien perçoit une fréquence, une zone de chaleur qui se densifie, signe de l'énergie en présence.

Mon approche consiste à "scanner" et identifier les zones nécessitant un nettoyage. Il s'agit de redonner de la liberté aux tissus et aux énergies.

Une **rétroversion utérine**, par exemple, peut entraîner des phases congestives. Le travail à distance vise à rééquilibrer le système gynécologique, en lien étroit avec la **gastrine**.

L'**endométriose**, caractérisée par une prolifération de tissu remontant dans le péritoine, est souvent associée à des douleurs lombaires et sacro-iliaques.

## La Cavité Intra-péritonéale et la Dimension Transgénérationnelle

Chez la femme, il existe un lien direct entre le col de l'utérus, les trompes et la **cavité intra-péritonéale**. Cette cavité est d'une grande importance, perçue comme un "ciel" ou un espace primordial.

Chaque état du corps représente la meilleure réponse fonctionnelle possible à un instant donné. Cette réponse est influencée par notre vie, mais aussi par celle de nos ancêtres.

Une rétroversion utérine, par exemple, peut être la meilleure réponse que le corps a trouvée pour résoudre un problème **transgénérationnel** ou personnel profond.

Il est essentiel de comprendre pourquoi un schéma transgénérationnel se manifeste ainsi. La thérapie vise à décoder cette "meilleure réponse" et à offrir la libération nécessaire, si elle est demandée.

L'embryon illustre parfaitement cette notion : à chaque stade de développement, il présente la meilleure réponse physiologique possible.

## La Neurulation Secondaire et la Formation du Philum Terminal
...
![Développement cloacal embryonnaire](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-34/Mesoderme_117.png)
...
![Septation du cloaque](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-34/Mesoderme_83.jpeg)



## Développement du Périnée et Influence Hépatique

Au niveau du **périnée**, nous observons l'émergence des membres inférieurs et une traction qui s'exerce. Ce mouvement est profondément lié au système utérin.

La bascule du **foie**, en synergie avec la descente du tube neural et du sacrum, influence le mouvement de développement qui tire vers la ligne blanche, via le ligament falciforme.

Ce développement hépatique entraîne une bascule qui affecte l'ensemble de la zone utérine en développement. Il pourrait expliquer des phénomènes de migration ou de tractions différentielles liées à la position utérine.

Un ligament se développe entre le pubis et l'ombilic, encapsulant l'histoire de la descente et de la formation utérine.
...
`,
  },
  {
    ...
    duration: "03:26",
    title: "33. Synthése de L'Appareil Génital",
    shortSummary: "Synthèse du développement de l'appareil génital, incluant embryologie et différenciation des organes sexuels, avec principes du sexe gonadique et canaux embryonnaires.",
    fullSummary: "Cette vidéo propose une synthèse approfondie du développement de l'appareil génital, en mettant en lumière les analogies embryologiques et la différenciation des organes sexuels masculins et féminins. Vous apprendrez comment des structures indifférenciées se transforment, sous l'influence hormonale, pour former des organes distincts comme le pénis et le clitoris, tout en intégrant les processus de fermeture le long de la ligne médiane. Les notions de sexe gonadique, de canaux embryonnaires et d’implications somatiques des conflits psychiques sont aussi abordées, permettant une approche thérapeutique enrichissante pour les praticiens.",
    transcriptMarkdown: `
...
Initialement, les structures sont indifférenciées puis se spécialisent en **organes sexuels masculins** ou **féminins**.

- **Tubercule génital :**
  - Homme : Gland et corps du pénis
  - Femme : Gland et corps du clitoris

- **Sinus urogénital :**
  - Homme : Urètre pénien
  - Femme : Vestibule du vagin

- **Pli urétéral :**
  - Homme : Pénis et urètre pénien
  - Femme : Petites lèvres

- **Pli labioscrotal :**
  - Homme : Scrotum
  - Femme : Grandes lèvres

La fermeture progressive de ces structures le long de la ligne médiane est un processus clé. On assiste d'abord à la séparation entre le **cloaque** et le **rectum**.

La différenciation des organes génitaux externes est clairement visible :

- Le clitoris se développe en petites et grandes lèvres.
- Chez l'homme, le clitoris embryonnaire devient le gland et le pénis.
- Les petites lèvres embryonnaires se ferment pour former le scrotum.
...
## Ligne médiane et Analogies embryologiques

Une perspective postérieure de l'embryon révèle le **ligament falciforme**, le **ligament terrestre** et le **pli médian**. La ligne blanche est la continuité de ce tissu, résultant de la fermeture le long de la ligne médiane. C'est l'aboutissement de tout ce mouvement de fusion.

Il existe une analogie entre la formation des organes génitaux et celle d'autres structures médianes du corps :
...
![Vascularisation lèvre/palais fendu](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-35/Mesoderme_113.png)

 Il s'agit de la fermeture de la ligne médiane antérieure.

## Sexe Gonadique et canaux embryonnaires

Le développement des **canaux génitaux** dépend du sexe gonadique :

- **En absence de sécrétion d'androgènes (femme) :**
  - Le corps de Wolff régresse.
  - Le canal de Müller se développe pour former la trompe, l'utérus et le vagin.
  - Le sinus urogénital reste ouvert (vestibule, petites lèvres). Ces structures, issues de l'endoderme, donneront l'urètre et la partie prostatique autour.
...
![Développement organes génitaux](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-35/Mesoderme_124.jpeg)


  - Le canal de Müller régresse.

![Développement embryonnaire externe](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-35/Mesoderme_122.jpeg)
...
![Organes génitaux féminins](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-35/Mesoderme_123.jpeg)
...
![Descente organes génitaux](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-35/Mesoderme_101.jpeg)
...
![Schéma explicatif](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-35/Mesoderme_127.jpeg)




![Différenciation sexuelle humaine](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-35/Mesoderme_126.jpeg)



![Développement génital externe](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-35/Mesoderme_125.jpeg)



![Paroi abdominale antérieure](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-35/Mesoderme_109.png)
...
## Équilibrage du Bassin Féminin

### Identification de l'axe et du déséquilibre

Nous allons identifier le **tubercule du troisième adducteur**, présent des deux côtés. En me référant à ces deux tubercules, je peux déterminer l'**axe du bassin** dans l'espace. Si le bassin est déséquilibré, par exemple, si un côté est légèrement enfoncé et trop court, cela indique un déséquilibre.

### Technique de rééquilibrage biodynamique

Pour équilibrer cette structure, je me place en **biodynamique**. Je prends le bassin de la femme en le soutenant à différents points. L'objectif est de porter l'intégralité du bassin tout en ayant l'axe devant moi. Je laisse alors opérer la biodynamique. Je me rapporte à ma ligne centrale et prends un point d'appui précis.

Je travaille avec un **triangle de soutien**, mais sans exercer de pression excessive. Cette conscience du soutien permet au bassin de se repositionner par rapport au point d'appui.
...
![Croissance os coxal](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-36/Mesoderme_159.jpeg)
...
### Décongestions et circulation

Cette technique favorise les **décongestions**. Un bon recentrage du bassin permet de libérer le **système vasculaire**, facilitant ainsi l'évacuation des congestions.

### Grossesse et positionnement

Lorsqu'une femme est enceinte, il n'est pas toujours aisé de la positionner sur le dos, surtout si elle souffre de fortes douleurs lombaires. Dans ce cas, il est préférable d'éviter de la coucher pour ne pas défaire le travail effectué lors du redressement. Je privilégie de laisser l'espace et la **respiration primaire** travailler.

### Contrôle et vérification

Lors d'une grossesse, je vérifie systématiquement l'axe de naissance et la liberté des pieds. Je me place derrière si nécessaire et laisse le corps se rééquilibrer, c'est l'espace environnant qui guidera ce processus.
...
![Engagement OIGA](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-36/Mesoderme_170.png)




![Os coxal latéral](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-36/Mesoderme_160.jpeg)



![Muscles du bassin](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-36/Mesoderme_162.jpeg)
...
`,
  },
  {
    ...
    duration: "09:57",
    title: "35. Meditation 4 pratiques",
    shortSummary: "Techniques de méditation visant l'harmonisation de l'énergie personnelle et celle des patients. Étude de méthodes pour se connecter au prana et libérer les tensions en faveur du bien-être.",
    fullSummary: "Cette vidéo propose un ensemble de pratiques de méditation adaptées à l'embryologie biodynamique, avec un accent sur la respiration, l'activation de l'énergie et l'ouverture du canal central. Les participants exploreront des techniques de respiration comme le Nadi Shodhana pour équilibrer le prana, tout en apprenant à créer une connexion méditative propice à la guérison. Les concepts clés abordés incluent l'harmonie, l'écoute active des besoins du patient et l'importance d'augmenter sa propre vibration énergétique pour favoriser le bien-être. La vidéo invite les thérapeutes à dépasser la volonté d'aider, favorisant une approche non-jugement et complémentaire envers leurs patients.",
    transcriptMarkdown: `
# Méditation et Pratiques en Embryologie Biodynamique

## Préparation Posturale et Respiratoire

Pour commencer, asseyez-vous dans une position relativement droite. Prenez vos pouces et placez-les sous les aisselles. Redressez légèrement votre corps, car nous allons travailler avec le **canal central**.

Inspirez profondément par le nez, puis expirez par la bouche en libérant les notions du **"moi"**, ainsi que les **toxines mentales** et égoïstes. Faites-les sortir de vous.

Inspirez à nouveau, puis expirez l'inutile hors de vous. Inspirez une dernière fois pour acquérir une **conscience claire**.

## Respiration Nadi Shodhana (Respiration Alternée)

Placez votre doigt le plus long au niveau de **Nazion**. Bouchez la narine droite et inspirez par la narine gauche. Concentrez-vous sur l'inspiration du **prana**.

Concentrez-vous pleinement sur ce niveau du prana. Inspirez par la narine gauche, puis bouchez l'autre côté et expirez par la narine droite.

Ré-inspirez avec la narine droite. Bouchez et expirez par la narine gauche. Reprenez un cycle.

Inspirez doucement le prana, l'air, la lumière, la vibration, par la narine gauche. Expirez par la narine droite.

Ré-inspirez encore une fois par la narine droite. Expirez par la narine gauche. Effectuez une dernière fois ce cycle.

Inspirez doucement par la narine gauche, expirez par la narine droite, puis expirez par la narine gauche.

## Ouvrir le Canal Central

Inspirez, gonflez votre abdomen, puis contractez le **périnée**. Rentrez le ventre et remontez le diaphragme pour élever le bol d'air.

Rentrez le menton, fermez la glotte et amenez progressivement une sensation de pression pour ouvrir cette zone.

Inspirez, amenez le bol d'air pranaïque dans le ventre. Rentrez, faites une petite bascule du bassin. Fermez la glotte. Basculez et faites remonter le diaphragme.

Faites une petite bascule du bas de la glotte jusqu'au sommet, puis relâchez. À cet instant, ouvrez votre canal central sous forme d'un symbole.

Inspirez encore une fois. La dernière fois, inspirez. Maintenant, videz complètement l'air.

Ensuite, par le vide, faites remonter votre diaphragme, puis faites-le redescendre. Cela réchauffera un peu le corps et ouvrira les choses.

## Activation de l'Énergie

Prenez vos mains et ouvrez-les, étirez tous les **méridiens** pour bien les préparer, ainsi que votre corps. Amenez le **chi** dans les mains.

Vous vous mettez dans un état méditatif. Fermez les yeux et prenez conscience du prana. Le prana est un moyen, un véhicule.

Rappelez-vous que le prana est de l'air, de la lumière et de l'énergie sous forme de vibration. En quelque sorte, vous êtes nourri par le prana.

Si vous prenez conscience de cette qualité, vous prendrez conscience de ce que l'on appelle le **Tout**. Si vous prenez conscience de votre respiration dans cette tridimensionnalité, c'est tellement simple qu'on ne le fait pas.

## Guérison et Vibration

D'une certaine façon, la guérison de la maladie est une **prise de conscience**. À un moment donné, vous ne parlerez plus de maladie.

Si vous savez augmenter votre **vibration**, si vous savez augmenter cette fréquence, vous connaîtrez une guérison. C'est pourquoi, en tant que thérapeute, vous devez toujours augmenter votre vibration.

Augmentez-la pour devenir comme **intouchable**. Il ne faut pas percevoir ce détail spécialement, sinon on tombe dans l'**orgueil**.

Il faut tout donner, tout redonner. C'est là où l'on doit être dans le **non-vouloir**. D'une certaine façon, que l'on en ait conscience ou pas, on passe par le prana.

## L'Écoute et l'Harmonie

Soyez dans un temps de **non-jugement**. Et là, le patient vous demandera de se placer au niveau qui lui conviendra le mieux.

Cela peut être viscéral, crânien, vertébral, n'importe quoi. Vous devez être à l'écoute et suivre le mouvement présent.

D'une certaine façon, la seule chose qui existe, c'est l'**harmonie**. L'harmonie s'obtient par la complémentarité de la **dualité** dans le prolongement de l'égalité de l'autre.

Souvent, c'est un orgueil de donner une réponse avant la question. Souvent, sans s'en rendre compte, on crée des points d'appui, on crée des points d'interrogation pour le patient.

L'homme ne crée pas sa maladie, il la subit. Elle est une réponse à la question que, plus ou moins consciemment, il s'est posée. Ne respirez pas par votre volonté.

La volonté d'aider l'autre peut finalement nuire plus qu'elle n'aide. Augmentez votre vibration.

## La Puissance des Mots et des Pensées

Une façon d'augmenter sa vibration est d'essayer de prendre conscience que chaque **mot** est une vibration.

Éliminez de votre vocabulaire le plus possible les mots qui ont une **basse énergie**. Ainsi, vous allez nettoyer votre **diamant intérieur**.

C'est là où il faut devenir conscient. Chaque mot, chaque geste, chaque regard, c'est une vibration. C'est comme si la Terre en avait besoin.
...
![L'image schématique générale s'insère au début du texte, après la description initiale du mouvement d'enroulement péritonéal](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/mesoderme-intro/Mesoderme_1.png)

 

Cette dynamique entraîne une fermeture sur tout l'axe antérieur, spécifiquement la **ligne blanche antérieure**.

## Formation de l'angle de l'ouïe

Ce mouvement forme d'abord un premier niveau : l'**angle de l'ouïe**, résultant de la mise en place du **médiastin**. 

Lorsque le médiastin atteint son premier plan d'équilibre, l'angle de l'ouïe est fermé. Toucher cet angle, c'est toucher toute la zone rythmique du poumon et du cœur.

## Le développement du cadre péritonéal et l'appendice xiphoïde

Un autre niveau se développe en rapport avec la **spirale du développement** du cadre péritonéal. 

Lorsque le **cæcum** termine sa descente finale dans le bassin par rotation, il adopte une position antihoraire de 270 degrés, portée par une force développementale. L'**appendice xiphoïde** trouve alors sa position, signifiant qu'il est la résultante de la mise en place de la **cavité péritonéale**, reliant le médiastin et le péritoine.

## Le niveau diaphragmatique et la céphalisation

Un niveau important est le **niveau diaphragmatique**. 

Une force significative se développe pour la mise en place du petit bassin, entraînant la **céphalisation**. Cela conduit à la **cardialisation**, qui amène ensuite à la **diaphragmatisation**, puis à l'**hépatisation**.

## Mise en place de la paroi postérieure de la cavité péritonéale

On observe la mise en place de la **paroi postérieure** de la cavité péritonéale, incluant la **loge rénale** qui se développe de haut en bas dans un mouvement descendant. 

Tout le système rénal est concerné, ainsi que le foie, les **surrénales** et les **gonades**. 

Progressivement, la **force utérine** ou **prostatique** se manifeste, intégrant le canal de **Wolff** ou le canal de **Müller** vers la ligne médiane. 

C'est une concentration d'énergie qui descend, contribuant à l'équilibre du péritoine.

## Le processus allantoïdien et la séparation du cloaque

Le processus **allantoïdien** se met en place avec la paroi postérieure du sacrum. 

Il y a une séparation due à des **vitesses de croissance** différentielles entre la partie postérieure et la partie inférieure, la partie postérieure se développant plus rapidement. 

Cette disposition sépare le cloaque en :

* Le **système rectal** postérieur
* Le **système de la vessie**, en avant

## Intégration urogénitale et l'ombilic

Tout ce mécanisme s'intègre vers la **ligne blanche antérieure** par la bascule du foie, revenant vers l'avant. 

Dans cette ligne blanche se trouve toute l'intégration du **système urogénital**, dont l'histoire se clôt ici. 

On retrouve dans ce tissu toute la finalité, tant dans la ligne blanche qui descend que dans l'intégration globale, rejoignant finalement le niveau de l'**ombilic**. 

On part du péricule et on revient vers ce niveau.

## La Force Éthérique et la Paix Intérieure

Nous intégrons un symbole : la **force éthérique** qui doit rejoindre la **force astrale** pour trouver sa puissance au niveau du cœur. 

La première étape est de retrouver la **paix** dans notre corps. Si nous avons la paix dans le corps, nous pouvons développer correctement la **sagesse**. 

Ces deux éléments vont de pair : la sagesse et la paix se rencontrent dans le cœur, révélant le véritable sens de l'**amour**. On devient un être au service, trouvant ce que l'on appelle la **dévotion**.

## L'embryon, la force pranaïque et les techniques
...
![Tube digestif et nerveux](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-39/Mesoderme_1.png)
...
![Feuillets embryonnaires](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-39/Mesoderme_176.png)



![Développement du système nerveux](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-39/Mesoderme_139.jpeg)



![Neurocrâne et colonne vertébrale](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-39/Mesoderme_175.png)



![Développement des muscles cervicaux](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-39/Mesoderme_137.jpeg)



![Schéma corps humain](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-39/Mesoderme_178.jpeg)
...
`,
  },
  {
    ...
    duration: "09:17",
    title: "38. Pratique 2  L'Appareil Génital",
    shortSummary: "Techniques de contact et de perception en biodynamique pour l'appareil génital, visant à favoriser la réorganisation énergétique et le bien-être des patients.",
...
Je me positionne dans un état de **neutralité**, en me concentrant sur ma respiration et en accueillant le **prana**.

Je place mes mains délicatement sur le corps, en contact avec le **tubercule du troisième inducteur**. Mon approche n'est pas d'imposer, mais de me déposer.

J'identifie l'**axe de naissance** de la personne, veillant à ce qu'il soit bien centré. Mon attention se porte sur l'espace environnant, car c'est lui qui me guide.

Je perçois une légère **compression** d'un côté, sans chercher à la corriger immédiatement. Le côté opposé paraît plus détendu. Cette observation est une étape préliminaire.

## Engagement du Contact : Le Bol Pelvien

Je change de position pour un nouveau point de contact. Ma main se pose légèrement sur la **fesse**, mon éminence ténare orientée vers le **trochanter**.

Je forme un contact comme un **bol**, englobant le bassin. Mes mains sont conscientes de leur position, mais 90% de mon attention est dirigée vers l'extérieur, vers l'espace.

J'attends que le neutre de la personne s'installe progressivement. L'objectif est la rencontre de nos neutres, permettant au processus de se dérouler naturellement.

Si cette rencontre a lieu, je laisse le processus se faire. Si elle n'a pas lieu, une intervention différente pourrait être nécessaire. La vie autour est le guide le plus efficace.

## Perception du Mouvement et de l'Harmonie

Un mouvement subtil de l'espace se manifeste. Je me dirige vers ce point, où un processus commence.

J'interroge la personne sur ses sensations. Elle décrit une **onde** de droite à gauche, une vague suivie d'un rééquilibrage.

Je vérifie mes propres sensations. C'est différent, mais l'**harmonie** n'est pas encore établie. La **symétrie** n'existe ni dans le corps, ni dans la vie, mais l'harmonie est recherchée.

Je continue l'exploration, invitant la personne à changer de côté si besoin.

## Approfondissement du Contact : Support Pelvien et Point d'Appui

Je prends le **bassin** de nouveau, mais cette fois-ci plus bas, au niveau des **ischions**. La personne lève une fesse pour faciliter le placement de ma main, qui doit être plate et détendue.

Le principe est le même : elle est comme portée dans l'espace, tandis que je reste très détendu. Cela demande de la **patience**.

Je crée ensuite un **point d'appui** au sommet de la tête, formant un triangle avec mes mains. Cela permet de travailler avec l'espace autour de la ligne médiane.

Un léger mouvement, comme une **marée**, indique que le processus intrinsèque de la personne est actif.

## La Zone Utéro-Prostatique et le Péritoine

Je me positionne juste au-dessus du **pubis**, avec une main spécifique. Petit à petit, la personne se dépose.

Il est essentiel de sentir tout le **sac péritonéal**, les lignes de force, y compris le **canal de Müller** et le **canal de Wolff**, qui convergent vers la ligne médiane.

Au fur et à mesure que mes mains se posent, tout semble se rassembler et se reconcentrer au niveau prostatique ou utérin. C'est une concentration du péritoine.

Je suis consciente du **ligament terrestre**, du **ligament falciforme**, et de l'ensemble du péritoine, ainsi que du péritoine pariétal postérieur.

Ce contact est particulièrement intéressant après un **accouchement difficile** ou une **césarienne**, lorsque l'utérus n'a pas retrouvé son intégrité énergétique.

## Réorganisation Énergétique et Chaleur

Lorsque le processus s'engage, un changement **vibratoire** se perçoit, souvent accompagné d'une sensation de **chaleur**, signe de la thermodynamique du corps.

Au début, certains patients peuvent ressentir une légère douleur, nécessitant une main très détendue.

Je me concentre toujours sur le champ **micro-cristallin** et j'observe la respiration de la personne. À l'expiration, j'ajuste ma position.

Le système semble se rassembler transversalement, comme le **système azygos** ou les **veines lombaires** qui réorganisent la circulation sanguine. Un petit changement de chaleur est perceptible.

Je reste attentif à l'espace, augmentant la qualité de mon écoute et réduisant mes paroles, observant la réorganisation progressive.

## Le Neutre, la Respiration Primaire et la Potentia

La chaleur se concentre, puis se dissipe, comme si le corps allait chercher plus loin ce dont il a besoin. Nous cherchons tous deux à retrouver le **neutre**.

Pour aider, je me synchronise avec la **respiration thoracique**. Mon attention se porte sur la phase de fin d'expiration, permettant une **transmutation** ou transformation vers une nouvelle forme.

Le processus se rassemble, mais une force transversale demeure. Je continue à accompagner jusqu'au bout.

Il est important d'avoir une représentation du **cœur**, de cette rencontre vers la ligne médiane, du **looping** et de la **bascule latérale**, avec les mouvements de **supination** et de **pronation**.

## Compréhension Embryologique et Pratique

Nous avons également abordé la dynamique de développement du **foie**, de l'**estomac**, de l'arrière-cavité des **épiploons** et de l'**intestin**.

La paroi postérieure a été explorée en profondeur, avec la mise en place de la **loge rénale**, des **surrénales**, du **système gonadique**, de l'**utérus** et de la **prostate**, tous convergeant vers la ligne médiane.

L'axe de naissance et la manière de porter le bassin différemment ont été discutés, apportant une notion de **calme** et de **rééquilibrage**.

Cette notion du neutre, du **"meeting point"**, du point de rencontre de deux neutres, commence à s'installer.

Elle permet l'émergence de la **respiration primaire**, qui, progressivement, active le processus thérapeutique (la marée). Il s'agit d'être présent et d'accompagner.

Il y a en vous une **puissance**, la **"potency"**, qu'il faut permettre d'éveiller.

## Importance de la Méditation et de l'Imagination

Il est essentiel de s'entraîner à la **méditation** pour stabiliser l'esprit. Cela apporte plus de paix et est recommandé à tous, même aux plus distraits.
...
![Embryon Carnegie stade 10](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-41/Mesoderme_132.jpeg)
...
![Embryon: coupe transversale](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-41/Mesoderme_133.jpeg)



![Embryon humain, coupe transversale, stade Carnegie 12](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-41/Mesoderme_134.jpeg)



![Neurulation et somites](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-41/Mesoderme_140.jpeg)



![Somite myotome dermatome](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-41/Mesoderme_141.jpeg)



![Développement embryonnaire membre](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-41/Mesoderme_151.png)



![Origine mésenchyme squelette](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-41/Mesoderme_164.png)
...
![Sclérotome, vertèbres, nerfs](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-42/Mesoderme_142.jpeg)
...
![Circulation LCR rachidien](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-42/Mesoderme_145.png)
...
![Embryon 4e semaine](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-42/Mesoderme_120.jpeg)



![Somites et tube neural](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-42/Mesoderme_130.jpeg)



![Somites et tube neural](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-42/Mesoderme_144.png)



![Développement tube digestif](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-42/Mesoderme_154.png)
...
`,
  },
  {
    ...
    duration: "07:22",
    title: "41. Développement des Cotes",
    shortSummary: "Développement embryologique des côtes, lien entre ectoderme, mésoderme et structures thoraciques. Analyse des techniques d'optimisation de la motilité costale et leur impact sur les échanges respiratoires et l'équilibre émotionnel.",
    fullSummary: "Cette vidéo plonge dans le développement embryologique des côtes, en reliant des éléments comme l'ectoderme et le mésoderme à la formation des structures thoraciques. Elle expose les concepts de complexité et d'émergence, et montre comment ces processus peuvent influencer les conditions cliniques. En parallèle, l'importance de la motilité costale est mise en avant, offrant des techniques tant directes qu'indirectes pour travailler sur chaque côte. L'aspect émotionnel, notamment en lien avec la quatrième côte à gauche, est exploré, soulignant la corrélation entre les mouvements respiratoires et l’équilibre émotionnel.",
    transcriptMarkdown: `
...
Les côtes sont également liées à des phénomènes cliniques. Par exemple, chez les boxeurs, un coup peut entraîner une **évragie intercostale**. Si la côte n'est pas cassée, cela peut indiquer un problème sous-jacent. En parallèle, le développement de la côte est accompagné par la **plèvre pariétale** et le repli interne de la **plèvre viscérale**, formant le **fascia endothoracique**.
...
![Tensegrité](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-43/Mesoderme_21.jpeg)



![Embryon 7 semaines, vaisseaux](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-43/Mesoderme_32.png)



![Embryon système nerveux](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-43/Mesoderme_136.png)



![Développement côtes et sternum](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-43/Mesoderme_148.jpeg)
...
![Concept de champs d'aspiration et de restriction, se plaçant logiquement après l'explication de ces mécanismes dans les cellules et le tube neural](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/mesoderme-intro/Mesoderme_2.png)



![Bourgeon de membre](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-44/Mesoderme_155.png)
...
![Développement des membres](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-44/Mesoderme_156.png)
...
![Développement membre embryonnaire](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-44/Mesoderme_157.png)
...
![Rotation membre supérieur](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-44/Mesoderme_152.jpeg)
...
![Rotation membre inférieur](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-44/Mesoderme_153.jpeg)
...
![Lignes de Langer embryonnaires](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/mesoderme/meso-44/Mesoderme_146.png)
...
`,
  },
  {
    ...
    duration: "02:01",
    title: "43. Pratique Accéder à L'Os Fluide  Le Péroné",
    shortSummary: "Étude du péroné via une approche biodynamique, avec focus sur la structure, la densité osseuse et l'intégration des fluides. Exploration des concepts de neutre, maturation et embryologie de l'os.",
    fullSummary: "Dans cette session, l'accent est mis sur l'exploration du péroné à travers une approche biodynamique. Les praticiens apprendront à ressentir la densité de l'os, à observer sa structure et à développer une sensibilité au champ micro-cristallin. En adoptant une conscience cellulaire puis moléculaire, les participants sont guidés à s'aligner avec la respiration primaire, permettant aux fluides corporels de s'intégrer harmonieusement. La pratique aborde des concepts clés comme le neutre, la maturation et la nature embryonnaire de cet os membranaire. Enfin, les participants sont invités à explorer des réalités plus profondes allant du plan atomique au plan lumineux, mettant en avant l'importance de l'eau dans cette dynamique.",
    transcriptMarkdown: `
...
Commencez par vous positionner correctement. Prenez le péroné comme si vous teniez une grande plume. Observez sa position et la structure de l'os. 

Il est essentiel de se concentrer d'abord sur la **densité**. Ajustez-vous pour permettre à l'os de trouver sa position spatiale parfaite. Concentrez-vous sur le **champ micro-cristallin**. Vous remarquerez un changement de chaleur, une variation **thermodynamique**.

Ensuite, passez à une **conscience cellulaire**. Imaginez que vous tenez un paquet de cellules dans vos mains. Puis, approfondissez votre perception en adoptant une **conscience moléculaire**. Laissez-vous guider par votre respiration primaire. 

N'oubliez pas de rester dans votre **neutre** et de laisser le neutre de la personne maturer. Il est important qu'il n'y ait pas de maturation du neutre des deux côtés. Parfois, j'invite un partenaire à se positionner au niveau de la base du crâne.
...
Il ne suffit pas d'amener ces souvenirs à la conscience ; il faut les faire renaître dans le tissu. Lors de cette approche, je vais comprimer à partir des **pariétaux**. Pour un bébé, si quelque chose semble nécessaire, je vais travailler au niveau du **bassin**. L'enfant peut avoir besoin d'être comprimé ou décompressé, et c'est le ressenti du moment qui guide cette décision.

Ce processus entraîne un mouvement **spirituel** et une dynamique dans le corps. Sur le plan **osseux-membranaire**, il est également crucial de considérer la compression au niveau **vasculaire**. Imaginez une éponge que l'on comprime ; cela illustre bien ce qui se passe dans le corps. 

La **rate** joue un rôle essentiel lors de la naissance. Si nécessaire, elle va rétablir un flux, car un **rééquilibrage** est nécessaire dans tout le système vasculaire, entre le cœur, les poumons et le **cordon ombilical**. Ce passage est fondamental, car il représente un grand changement vasculaire : vous passez d'une respiration et d'une oxygénation par le cordon à une autonomie respiratoire via vos poumons.

Le premier **cri**, le premier **souffle**, est crucial. À ce moment-là, vous êtes dans un axe ombilical, et le sang entre par le **trou de Botal**. C'est un changement fluidique majeur. Pour faciliter ce changement, l'**axe hépatique** et **splénique** intervient, fournissant l'information nécessaire. Si cette transition n'est pas bien réalisée, certains enfants peuvent naître avec des caractéristiques **spléniques**, souvent mélancoliques, car ils n'ont pas effectué cette première respiration correctement.

Ce passage d'oxygène, de la compression globale et fluidique du système, ainsi que de la compression membraneuse, est essentiel. L'importance des **pariétaux** et du mouvement du corps est à souligner. 
...
`,
  },
  {
    ...
    duration: "10:31",
    title: "45. BONUS - Le Mouvement Régénérateur",
    shortSummary: "Pratique corporelle et sensorielle (création de Marc Damoiseaux) qui retrace physiquement les grandes étapes de l'incarnation de l'embryon : de l'ovule à l'enroulement tissulaire complet.",
    fullSummary: "Le Mouvement Régénérateur (créé par Marc Damoiseaux) est une puissante pratique somatique où le corps retrace physiquement sa propre genèse. En conscience, le praticien revit la polarisation originelle de l'ovule, le clivage des premiers blastomères, puis traverse la gigantesque plicature de l'embryon (vague notochordale, looping du cœur, bascule pulmonaire et rotation des fascias digestifs). Cette architecture en mouvement ramène ultimement la perception de l'Axe Central (Vertex - SSB - Cœur - Sacrum), réinitialisant l'équilibre tissulaire profond de la chaîne médiane.",
    transcriptMarkdown: `
# Le Mouvement Régénérateur 

*Créé par Marc Damoiseaux, le Mouvement Régénérateur est inspiré du mouvement développemental de l'embryon.*

Position initiale.
Pousse de la main droite dans la main gauche, pied parallèle. Largeur des épaules.
Le dos est droit et détendu. Légère flexion des genoux.
Observation des différentes lignes médianes : la ligne médiane notochordale, postérieure et antérieure. On observe bien la sphère neuro-sensorielle, rythmique, métabolique, urogénitale. Essayez de les ressentir, de vous équilibrer.
...
La première fonction de l'ovule en création est la polarisation primitive. Un axe est-ouest, et un axe nord-sud. Et avant et arrière.

Arrivée du spermatozoïde. Pénétration du spermatozoïde dans l'ovule. Et le premier clivage apparaît. Vous dessinez devant vous dans l'espace les deux premiers blastomères. Vous pouvez prendre l'ensemble, la division cellulaire. Et vous déposez cette sphère vers le bas, au niveau du ventre.

Dans un premier temps, pas de croissance, mais multiplication cellulaire.
Ensuite la 4ème phase, c'est l'éclosion. Suivi de la nidation, apparition de la cavité amniotique et du cœlome extra-embryonnaire. Croissance.

Formation du pédicule embryonnaire. Mise en place de la ligne primitive (fermez la tirette). Ensuite, grande vague notochordale.

Ensuite, vous imaginez un embryon couché devant vous, tête vers les mains. Formation de la gouttière neurale. Le tube neural se ferme.
Mise en place, petit à petit, de la motilité du cerveau en croissance. Expansion du cerveau. Flexion mésencéphalique. Suivie de la flexion cervicale et de la mise en place du pont.

Phase de télencéphalisation. Occiput et temporaux dans les mains.

Mouvement de développement du cœur. Depuis la ligne primitive, vous descendez les mains vers le coccyx. Vous joignez les mains vers l'avant au-dessus de la tête. Fusion des deux tubes. Et looping du cœur : descente de la main droite en rotation vers la gauche.
Mouvement de développement du diaphragme. Les pouces vont former les piliers diaphragmatiques.

Formation de la délimitation embryonnaire (Zone B). Toute la cavité amniotique. On part derrière le dos, c'est comme si on tendait un grand ballon de baudruche vers l'avant. La réunion de la vésicule vitelline et de la cavité amniotique avec le pédicule embryonnaire va former le cordon ombilical.

Ensuite on monte les mains au niveau de l'angle de Louis. On va faire un petit tour de main. Formation des poumons. Ouverture, inspiration.

On remonte les mains vers le haut. Formation du mouvement des reins. On descend : pronéphros, mésonéphros, métanéphros. Rapport entre les reins et la descente du sacrum.

Mouvement de développement de l'espace sous-diaphragmatique. Vous tenez un ballon du côté gauche et vous le roulez pour former l'espace hépato-gastro-pancréatico-liénal.

Ensuite, rotation de l'intestin. La main droite passe au-dessus de la main gauche, comme si on tournait dans le sens anti-horaire. L'intestin se forme avec la main droite qui forme le côlon ascendant.

Ensuite, on rapproche les mains au niveau du péritoine pariétal postérieur. On concentre, on se rapproche vers la ligne médiane. On descend vers le pubis. On remonte pour former l'utérus ou la prostate.

On remonte les mains au niveau des épaules. Mouvement développemental des membres supérieurs et inférieurs. On fait les membres supérieurs : rotation externe. Les pouces et les mains se tournent pour tenir un petit embryon. Les mains représentent ce petit embryon en formation.

On ramène les mains dans la position initiale. On prend le pouce droit avec la main gauche et on redescend au niveau de l'ombilic pour retrouver la posture initiale. On prend conscience de cette posture.
On prend conscience de retrouver son axe, la chaîne centrale. Vertex, Tente du Cervelet, Symphyse Sphéno-Basilaire, œsophage, trachée, péricarde, centre phrénique avec la faux du cerveau, la racine du mésentère, jusqu'en bas.

On est bien centré et on retrouve son équilibre, sa balance.
`
  },
  {
    id: "meso-46",
    ...
    youtubeId: "",
    duration: "143 p.",
    title: "46. Support Intégral — Recueil PDF Global (01 à 45)",
...
Être conscient de notre respiration nous permet d'unir notre **esprit et notre corps**. Dans cet état de présence, nous pouvons nous libérer des entraves du passé. Beaucoup de nos **maladies** et de nos souffrances proviennent de ce passé dont nous sommes souvent prisonniers. 

Je vous invite à être pleinement conscient ici et maintenant. En prenant conscience de votre respiration, vous augmentez votre **énergie de concentration** et commencez à ressentir votre corps. Cela implique de **relâcher** le corps, particulièrement lors de l'expiration. En stimulant le **nerf vague**, vous activez votre **système parasympathique**, favorisant ainsi la **récupération** et la **guérison**.

### Les Niveaux de Conscience

Il existe plusieurs niveaux de conscience, et nous allons en explorer quelques-uns. La **pleine conscience** peut être divisée en un objet et un sujet. Cela signifie que vous pouvez être conscient de quelque chose, que ce soit de manière objective ou subjective. 

Avec la pratique, vous développerez ce que l'on appelle la **vision profonde**. Cela vous permettra de vous libérer de vos sensations, d'observer vos émotions sans réagir immédiatement. Par exemple, lorsque vous ressentez de la colère, apprenez à observer cette sensation plutôt que de vous laisser emporter par elle.

### Pratique de la Méditation

Pour commencer, concentrez-vous sur votre **inspire** et votre **expire**. Suivez chaque mouvement de votre respiration. Cela vous aidera à vous détendre et à vous relâcher. 

Lorsque vous êtes conscient de votre respiration, vous vous offrez un **cadeau** : le moment présent. Ce moment de présence vous permet de vous libérer des pensées du passé et des préoccupations pour l'avenir. 

### L'Importance de l'Inspiration et de l'Expiration

En tant qu'ostéopathe, il est crucial de comprendre l'importance de l'inspiration et de l'expiration. Ces mouvements dans le corps sont essentiels pour maintenir une **liberté de mouvement**. Les mouvements mineurs gouvernent les mouvements majeurs, et il est important de se concentrer sur la finesse de la respiration pour atteindre ce que l'on appelle le **still point**.
...
![Développement embryonnaire précoce](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-02/Endoderme_63.jpeg)
...
![Processus notochordal](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-02/Endoderme_19.jpeg)
...
![Crâne fœtal](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-02/Endoderme_59.jpeg)



![Feuillets embryonnaires](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-02/Endoderme_3.png)



![Gastrulatoin, disque embryonnaire trilaminaire](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-02/Endoderme_21.jpeg)
...
`,
  },
  {
    ...
    shortSummary: "Exercices pratiques de méditation pour équilibrer les centres énergétiques et améliorer la conscience corporelle et le bien-être.",
    fullSummary: "Cette vidéo vous initie à la méditation en mettant l'accent sur les centres énergétiques du corps. Vous apprendrez les relations entre l'œil, l'épiphyse, et l'importance de la respiration, de l'alimentation, et du sommeil pour maintenir votre santé. À travers un exercice guidé, vous intégrerez des techniques de méditation pour vous connecter à votre corps à différents niveaux – minéral, végétal, et animal. Ce processus vous aidera à trouver des points de silence et d'équilibre tout en renforçant votre conscience corporelle, ce qui est essentiel pour apaiser un esprit agité et revitaliser votre énergie vitale.",
    transcriptMarkdown: `
...
Pour maintenir une bonne santé, il est crucial de bien **respirer**, de bien **manger**, mais surtout de bien **dormir**. Souvent, nous avons des difficultés à dormir parce que notre esprit est trop agité. 

### Exercice de Méditation

1. **Position de départ** : Mettez-vous debout, les pieds parallèles et les jambes légèrement fléchies pour ouvrir l'espace. 
2. **Alignement** : Effectuez une légère **rétroversion du bassin** pour amener le nombril et le pubis vers l'**appendice xyphoïde**. 
3. **Équilibre** : Cherchez l'équilibre entre votre **ligne blanche antérieure** et **postérieure**. Fermez les yeux et prenez contact avec le sol. 
4. **Conscience corporelle** : Ressentez la gravité et le poids de votre corps sur vos pieds. Prenez conscience de votre **système urogénital**, qui est en continuité jusqu'au niveau des pieds. 
5. **Connexion avec le monde végétal** : Ressentez votre **système digestif** et détendez-vous. Chaque niveau de votre corps a un **point de silence**. Cherchez ce silence dans vos tissus. 

Lorsque vous êtes bien ancré dans votre **règne minéral**, vous pouvez vous connecter à votre **règne végétal**, qui est lié à vos émotions. En étant détendu et immobile, respirez profondément jusqu'à vos pieds. 

6. **Règne animal** : Connectez-vous à votre **système rythmique**, en particulier à votre cœur. Recherchez le point de silence et le point d'appui, qui se situe au niveau du **mésogastre postérieur**. 
7. **Concentration** : Concentrez-vous sur le point entre vos yeux tout en restant détendu. 
...
`,
  },
  {
    ...
    shortSummary: "Analyse de l'endoderme, tissu clé du développement embryonnaire, et de son impact sur la santé hormonale et le système digestif, à travers une méthode biodynamique.",
    fullSummary: "Cette vidéo offre une exploration approfondie de l'endoderme, un tissu crucial dans le développement embryonnaire, mettant en évidence son rôle dans le système digestif et endocrinien. Vous apprendrez comment le tissu de limite et le tissu intérieur interagissent, affectant la santé globale du corps. Des concepts clés tels que le crânio-sacro-sterno-système et l'importance des glandes comme la thyroïde et les surrénales sont abordés. En combinant théorie et pratique, cette leçon vous permettra de mieux comprendre les dynamiques tissulaires et leur impact sur le corps, tout en vous offrant des outils pour travailler sur les tissus faciaux et alimentaires afin de soutenir le système endocrinien en profondeur.",
    transcriptMarkdown: `
# L'Endoderme : Introduction et Généralités
...
![Plan du corps](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-04/Endoderme_5.jpeg)
...
![Axe cerveau-intestin](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-04/Endoderme_192.jpeg)
...
![Derme et épiderme](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-04/Endoderme_201.jpeg)
...
![Systèmes corporels énumérés](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-05/Endoderme_7.png)
...
![Embryon 2 cellules](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-05/Endoderme_8.jpeg)



![Microbiote intestinal fonctions](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-05/Endoderme_190.png)



![Microbiote flore intestinale](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-05/Endoderme_191.jpeg)
...
L'énergie 1 se transforme en énergie 2, entraînant une **transformation**. Ce moment peut être chaotique, et la personne peut ressentir un **isolement**. Il est essentiel d'être présent, non seulement par des mots, mais aussi par des gestes et un regard qui doivent être **libérateurs**. L'objectif est de ramener la personne à la **confiance** en la vie, transcendant parfois même la notion de vie et de mort. 

Cette **présence** implique d'être ici et maintenant, dans l'écoute, et de revenir à un état de **liberté**. Dans cet état, il n'y a plus de freins, car on est dans le **mouvement de la vie**, qui se manifeste dans le **cadeau du présent**. Souvent, en raison d'un manque de compréhension de notre **contexte émotionnel**, nous réagissons plutôt que d'agir. Cela signifie que nous donnons à autrui le pouvoir de décider de notre existence.

La **deuxième vertèbre cervicale**, connue sous le nom d'**axis**, possède une petite dent, l'**apophyse ondotoïde**, qui est symboliquement reliée à un **fil d'argent**. Cette vertèbre est essentielle pour connecter notre intelligence égoïste à des niveaux plus élevés de conscience. Il est crucial de relier cette vertèbre à l'**épiphyse** et à l'**hypophyse**, permettant ainsi de rejoindre des aspects plus élevés de soi, tels que l'**atma**, le **manas** et le **bouddhi**. Cela signifie intégrer l'**amour**, la **sagesse** et la **volonté divine**.

Ce processus initiatique permet de se connecter à des niveaux de conscience dont nous n'avons peut-être pas conscience. Nous nous situons sur un **axe** où le développement du **processus neutro-cordal** est influencé par l'environnement. En effet, la forme est dépendante de l'extérieur, et sur le plan trophique, nous nous nourrissons de l'univers, que ce soit par la terre ou la mer.

La **symphyse phéno-basilaire** est également un reflet de l'**occlusion**. Le type d'occlusion impacte la symphyse, car le corps, au niveau des dents, est la partie la plus dense et celle qui absorbe les contraintes. Il est donc crucial de maintenir la meilleure **mobilité** possible. Les modifications, comme le changement d'un amalgame, affectent profondément la structure corporelle.

La base du crâne et le principe de la **notocorde** sont intégrés dans la **globalité posturale**. Les dents agissent comme des **capteurs de posture**, reliés à chaque organe et tissu, et toute modification peut avoir des répercussions sur l'ensemble de la posture. Une réponse importante se produit au niveau de l'**hypophyse**, en relation avec l'**hypothalamus**, qui reçoit des informations sur l'intégrité du système **acidobasique**.

Ainsi, il existe un **tonus chimique** en rapport avec l'environnement, et nous cherchons constamment à nous rééquilibrer par le mouvement. Chaque respiration modifie notre équilibre, et le système rénal joue un rôle crucial dans l'**oxydoréduction** et l'équilibre des bases.
...
Pour établir la pesanteur, il est recommandé de **respirer** dans le **hara**, en se concentrant sur la respiration abdominale. Cela peut engendrer une sensation de **chaleur** et permettre d'éprouver les niveaux de la **terre** et de l'**air**, c'est-à-dire la **lithosphère** et l'**atmosphère**. 

Concentrez-vous sur les **surrénales** et la **thyroïde**. La **gravité** exprime l'équilibre entre ces deux glandes. Elle peut stabiliser une personne dans sa fonction. Il est également important de se focaliser sur le niveau électromagnétique de l'individu, car l'**électricité** du corps est liée à la thyroïde, qui devient fonctionnelle sur le plan électrique à l'âge de **7 ans**. 

Le mot est porté, ce qui signifie que la thyroïde **électrifie** le mot. Observez ce que vous percevez. Un niveau électromagnétique élevé peut indiquer un **surplus de mentalité**, entraînant une tendance à être trop mental. 

Concentrez-vous maintenant sur le niveau **sans forme**, **A-TOMOS**. Ce niveau énergétique doit être exploré en dehors de votre volonté. Soyez simplement **confiant** et **conscient**. Portez votre attention sur la **lumière** de la personne, en observant comment le **flux cosmique** entre dans le corps et s'irradie à l'intérieur. La lumière reflète l'homme dans sa fonction. Laissez cette lumière s'ouvrir.

Ce niveau extérieur, presque **cosmique**, contient une énergie qui transforme simultanément l'énergie. On pourrait dire que cela touche à l'**âme** et à la **terre**, au sens de la matière. La lumière crée le **corps éthérique** par un rayonnement qui s'exprime dans la formation de **centres psycho-énergétiques**. La condensation éthérique donne naissance au **corps physique**, qui peut subir une transformation par le biais d'une énergie spécifique.

Deux énergies sont souvent négligées : le **son** qui vous traverse et le **silence** qui l'accompagne. Le thérapeute qui comprend ces énergies devient le miroir de l'autre. Il est crucial d'être un **miroir transparent**. On ne peut pas être le guide dans le chemin de l'autre, mais on peut l'aider dans sa formation et sa transformation par la prise de conscience de son **plan énergétique fonctionnel**. 

Cela signifie que n'importe quelle manipulation peut être une transformation énergétique pure, à condition d'agir sur le bon plan. Le thérapeute utilise son propre corps et sa conscience pour aider l'autre à trouver son chemin. 

En conclusion, la **gravité** met l'homme dans la terre, l'**électromagnétisme** le met dans son corps, le niveau **atomique** l'intègre dans son énergie, et la **lumière** le place dans sa fonction. Chaque fois qu'une personne consulte sur un plan physique, il est possible d'effectuer ce travail **aspécifique**, qui ramène au plan créatif, mais toujours en dehors de votre volonté.
...
Commencez par vous placer doucement sur l'axe, en prenant conscience de la **notochorde** et de son pouvoir trophique. Restez dans un état de **non-faire**, permettant aux énergies spécifiques de circuler : la terre, l'eau, le feu. 

À un moment donné, vous pourrez sentir un doigt qui se décolle, puis un second, laissant passer l'énergie nécessaire à la personne. Faites confiance à votre intuition pour guider ce processus. Vous remarquerez un état d'**homogénéité globale** qui se met en place.

### Lien avec la Mère

Rappelez-vous que vous êtes en contact avec le moment de l'**anidation**, ce premier moment embryonnaire crucial. Laissez-vous porter par les informations qui émergent, que ce soit un mot, un geste ou un regard. Il est essentiel de ne pas surcharger le système, mais de laisser un **courant** d'énergie circuler.

### Déviations et Reconnaissance

Un enfant qui ne parvient pas à revenir vers sa **ligne médiane** a des difficultés à vivre. Lors de son développement, il explore son environnement principalement par la bouche, recevant ainsi des informations essentielles, notamment la **flore vaginale** de sa mère.

Il est crucial de reconnaître les déviations qui peuvent survenir à la conception ou durant la grossesse. Des événements marquants, comme des décès dans la famille ou des traumatismes, peuvent influencer le développement de l'enfant. Ces schémas **transgénérationnels** doivent être pris en compte pour permettre une réintégration dans la ligne médiane originelle.

### Traumatismes de Naissance

Les traumatismes de naissance peuvent également avoir un impact significatif. Par exemple, un enfant souffrant de **régurgitations** peut avoir un sacrum comprimé en raison d'une naissance difficile. Il est essentiel de libérer cette zone pour rétablir un bon fonctionnement.

### Conception et Polarité

Lorsqu'un enfant est conçu par **fécondation in vitro (FIV)**, il est crucial de reconnaître le moment de la rencontre entre le spermatozoïde et l'ovocyte. Ce moment crée un champ d'énergie et un axe craniocodal primitif. 

Les cellules folliculaires et nourricières jouent un rôle clé dans l'organisation de ce champ électromagnétique, portant également une **information transgénérationnelle**. Ces informations peuvent se manifester dans le code génétique de l'enfant, révélant des traumatismes ancestraux.
...
Lors de la plicature, le **mésenchyme**, qui est le tissu mésenchymal sous les encéphales, devient perpendiculaire à l'axe longitudinal de l'embryon. Ce mouvement crée une belle courbure, entraînant une **compression** entre l'avant et l'arrière, ce qui contribue à la formation de la base du crâne. Ce processus dynamique génère un **champ cartilagineux** qui, au départ lâche, se densifie progressivement pour former des **cartilages primitifs** comprimés, libérant ainsi une forte énergie.
...
![Bourgeon du goût](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-09/Endoderme_17.jpeg)
...
![Schéma explicatif](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-09/Endoderme_13.jpeg)
...
![Tube digestif embryonnaire](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-09/Endoderme_33.jpeg)
...
![Cerveau embryonnaire humain](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-09/Endoderme_16.jpeg)



![Embryon humain sagittal](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-09/Endoderme_23.jpeg)



![Formation de la notochorde](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-09/Endoderme_18.jpeg)



![Embryon humain sagital](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-09/Endoderme_31.jpeg)



![Embryon vascularisé](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-09/Endoderme_29.jpeg)



![Schéma explicatif](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-09/Endoderme_22.jpeg)
...
En se concentrant sur le plan **vasculaire**, on observe que les tubes endocardiques primitifs se rapprochent simultanément de la fermeture du tube neural. Cette rencontre crée un espace dans la lumière de l'**endoderme vitellin primitif**, formant ce que l'on appelle l'**intestin pharyngien**. Ce processus se déroule sur la ligne médiane, tandis que latéralement, le **cellulose** apparaît.
...
![Coupe transversale intestin](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-10/Endoderme_150.jpeg)
...
![Oreille interne embryonnaire](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-10/Endoderme_197.jpeg)
...
La rupture de la **membrane buccopharyngienne** marque le début de la formation de la bouche, qui se développe horizontalement en raison de la compression entre le cœur et le cerveau. Cette compression intègre le tissu mésodermique, contenant l'information vasculaire. L'apparition du **nasal pit** et de la cavité orale est également liée à cette dynamique.

Le développement du cerveau est en rapport avec le processus de **téléencéphalisation**, qui implique une ascension du cerveau et une descente viscérale. La face, au départ, est un champ de compression entre le cœur et le cerveau, et par la croissance de l'embryon, elle s'ouvre.
...
![Tissu intestinal villosités](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-10/Endoderme_152.jpeg)
...
![Développement embryonnaire oiseau](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-10/Endoderme_15.jpeg)



![Embryon rat neurulation](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-10/Endoderme_27.png)



![Villification intestinale](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-10/Endoderme_151.jpeg)
...
![Autostéréogramme](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-11/Endoderme_1.jpeg)
...
`,
  },
  {
    ...
    shortSummary: "Exercice de yoga axé sur le hara, visant à améliorer la respiration et à renforcer la stabilité émotionnelle et physique, utile pour thérapeutes et étudiants en quête d'équilibre.",
    fullSummary: "Dans cette vidéo, apprenez un exercice de yoga centré sur le contrôle du hara, essentiel pour la stabilité émotionnelle et physique. En plaçant votre main droite dans votre main gauche, et en visualisant une épée à votre ventre, vous développez une conscience profonde de cette région clé. À travers des respirations profondes, des expirations lentes et des apnées prolongées, vous serez guidé pour renforcer votre maîtrise du hara. Cette méthode progressive vous aidera à augmenter à la fois le nombre de répétitions et la durée de l'apnée, vous permettant d'atteindre une pratique allant jusqu'à deux minutes sans respirer.",
    transcriptMarkdown: `
...
Commencez par **respirer** profondément dans le ventre. Inspirez par le nez, puis expirez lentement par la bouche. 
...
La croissance embryonnaire est marquée par une **croissance significative** au niveau du cerveau, tandis que le **système digestif** se développe plus tard. Cependant, il est fondamental de noter que le système digestif est précoce dans son rôle, car il dépend d'abord du **système digestif maternel**. De plus, l'apparition du **système glandulaire** précède celle du **système nerveux**, soulignant l'importance vitale des systèmes glandulaires et digestifs.

L'**axe hypothalamo-hypophysaire-thyroïdien-surrénalien** est un élément central dans la régulation hormonale, particulièrement chez les femmes, qui sont influencées par les **cycles lunaires** d'environ 28 jours. Traiter les déséquilibres hormonaux implique souvent de libérer les **phases de congestion** dans divers systèmes, tels que le système cervical, thymique ou hépatique. Comprendre le **biofeedback** des systèmes est essentiel pour appréhender ces interactions.

Le développement embryonnaire se manifeste également par des **structures anatomiques** spécifiques. Par exemple, l'**angle de l'ouïe**, formé par la rencontre du **manubrium sternum** et des barres sternales, représente une mémoire de la **flexion** embryonnaire. Cette flexion est cruciale pour l'équilibre dynamique du **médiastin**, l'espace entre les poumons.

L'**appendice syphoïde**, qui se développe plus tard, est lié à l'intégration du **sécum** dans la fosse iliaque droite, marquant la phase terminale de la formation du cadre colique. Le développement intestinal implique un **mouvement de rotation antihoraire** de 270 degrés, intégrant le sécum dans la fosse ciliaque droite.

Les **déformations sternales** peuvent indiquer des déséquilibres ou des influences génétiques, tandis que le développement intestinal est orchestré par un **axe vasculaire mésentérique**. Ce processus est également lié à la dynamique cérébrale et au développement des **membres supérieurs**.

Le mouvement de flexion et d'allongement est essentiel pour la croissance embryonnaire. La **notochorde** génère une **vague** qui crée le **tube neural**, essentiel pour le développement. Ce tube neural, à son tour, favorise l'enroulement et l'allongement de l'embryon.
...
![Développement embryonnaire précoce](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-13/Endoderme_13.jpeg)



![Embryon 14-15 jours](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-13/Endoderme_14.jpeg)



![Blastule oursin](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-13/Endoderme_10.jpeg)



![Blastocèle et cellules](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-13/Endoderme_9.jpeg)



![Implantation humaine 9 jours](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-13/Endoderme_12.jpeg)



![Coupe transversale rein](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-13/Endoderme_121.jpeg)



![Circulation embryonnaire 4 semaines](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-13/Endoderme_199.png)
...
![Tête embryonnaire vertébré](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-14/Endoderme_24.jpeg)
...
![Développement innervation céphalique](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-14/Endoderme_40.jpeg)
...
![Développement facial embryonnaire](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-14/Endoderme_45.jpeg)
...
![Développement facial précoce](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-14/Endoderme_46.jpeg)
...
![Développement palais primaire](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-14/Endoderme_50.jpeg)



![Développement facial embryonnaire](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-14/Endoderme_48.jpeg)
...
![Migration crête neurale](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-14/Endoderme_57.jpeg)



![Morphogenèse faciale développement humain](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-14/Endoderme_54.jpeg)



![Développement facial embryonnaire](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-14/Endoderme_51.jpeg)
...
![Forces piézo-électriques crâniennes](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-14/Endoderme_58.png)
...
![Développement thyroïdien embryonnaire](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-15/Endoderme_64.jpeg)
...
![Développement thyroïde et parathyroïde](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-15/Endoderme_67.jpeg)
...
![Embryon humain sagittal](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-15/Endoderme_26.jpeg)



![Développement arcs pharyngiens](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-15/Endoderme_37.jpeg)



![Musculature arcs pharyngiens](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-15/Endoderme_38.jpeg)



![Développement palais embryon](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-15/Endoderme_47.jpeg)



![Développement palais et nez](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-15/Endoderme_49.jpeg)



![Développement pharyngien](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-15/Endoderme_65.jpeg)
...
`,
  },
  {
    ...
    shortSummary: "Analyse des signes faciaux, oculaires et linguaux liés aux déséquilibres internes. Méthodes d'interprétation des apparences physiques comme indicateurs de diagnostics cliniques.",
    fullSummary: "Cette vidéo offre une approche détaillée de l'analyse faciale et des signes associés aux yeux et à la langue, permettant aux thérapeutes d'interpréter visuellement l'état de santé global de leurs patients. À travers des exemples pratiques, l'enseignement couvre les indices révélateurs tels que les rides, la couleur des yeux et la texture de la langue, reliant ces éléments à des problèmes spécifiques des organes internes comme le foie, les reins et le système digestif. Vous apprendrez comment des caractéristiques apparemment innocentes peuvent être des indicateurs de maladies sous-jacentes, enrichissant ainsi votre pratique clinique avec des outils d'évaluation non invasifs et basés sur l'observation.",
    transcriptMarkdown: `
...
La couleur du **nez** peut également fournir des indices : un nez bleuté peut être en rapport avec la **libido**. Les **cernes** sous les yeux, qu'ils soient bleutés, bruns ou gonflés, peuvent signaler une **déficience rénale** ou un problème d'élimination de l'urée. Un bleu foncé peut être le signe d'un **problème dépressif**, tandis qu'une teinte jaune peut indiquer un **problème hépatobiliaire**. Des cernes bruns ou noirs nécessitent une consultation pour vérifier l'état du **pancréas**.

Les **lignes de la patte d'oie** peuvent révéler des déséquilibres organiques plus profonds, notamment au niveau des reins, du foie ou de l'estomac. Des petites vénules éclatées peuvent indiquer un besoin d'**oxygénation** et nécessitent une évaluation du foie et de l'intestin. Un **bout de nez** rouge peut être lié à des problèmes cardiaques, tandis que des lignes marquées peuvent être associées au **pancréas**.

Chez les femmes, un menton irrégulier peut signaler des **déséquilibres hormonaux**. Les **lèvres** peuvent également fournir des informations : des lèvres pincées peuvent indiquer des problèmes gastriques, tandis qu'un épaississement peut également être un signe de troubles gastriques. Le **perlèche** peut signaler une **candidose**, et des lèvres très rouges peuvent indiquer un **épuisement en vitamine B**.

Un dessèchement de la peau autour du nez peut être un signe de **pré-cancer**. Les lèvres en elles-mêmes reflètent l'état intestinal, et des taches peuvent indiquer des problèmes intestinaux ou cardiaques. Des lèvres bleutées peuvent signaler un problème pulmonaire ou une insuffisance d'**absorption d'oxygène**.

L'**œil** est souvent considéré comme un reflet de la santé générale. La **capsule de Tenon** et la relation entre l'œil et les fascias du corps sont essentielles. Un déséquilibre oculaire peut influencer la posture. Les couleurs de l'œil, comme le jaune de la sclérotique, peuvent indiquer des problèmes hépatiques ou biliaires. Une sclérotique blanche-bleue peut signaler un problème pulmonaire, tandis qu'une couleur brune peut indiquer des problèmes d'**absorption** au niveau du foie.

La **conjonctivite** ou l'**orgelet** peuvent être liés à des infections ou à des carences minérales. Le système immunitaire joue un rôle crucial dans la santé digestive, et des problèmes au niveau des paupières peuvent indiquer des troubles rénaux.

En ce qui concerne la **langue**, une langue rose, mobile et fraîche est idéale. Une langue très rouge peut signaler des problèmes cardiaques, tandis qu'une langue blanche peut indiquer des troubles gastriques. L'enduit de la langue, qui est généralement postérieur, reflète l'état de santé gastrique, hépatique ou colique.

Des dépôts sur la langue peuvent signaler des problèmes au niveau du colon ou des poumons. Une langue très lisse ou douloureuse peut indiquer des carences en vitamines. Une langue déviée peut signaler une paralysie d'un nerf crânien.
...
Traiter la peau revient à relibérer tout le système du liquide céphalo-rachidien et à favoriser les espaces de drainage. La peau traduit également l'équilibre des tensions réciproques des membranes et du système lymphatique. Elle est l'expression basale de l'équilibre métabolique profond du système nerveux, reflétant la qualité interne du corps.
...
![Coupe embryon humaine](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-17/Endoderme_105.jpeg)
...
- **Bronzage** : Augmentation de la mélanine. Attention à l'exposition excessive.
- **Couleur brune** : Peut indiquer un déséquilibre, comme la **maladie d'Addison**.
- **Couleur jaune** : Peut signaler une lésion hépatique ou biliaire.
- **Peau noire** : Peut refléter un trouble profond au niveau du pancréas.
- **Couleur paille** : Suspicions de cancer futur.

Les hormones, notamment celles liées à la grossesse, influencent également la pigmentation de la peau. Par exemple, l'hypothyroïdisme perturbe la mélanine, tandis que les hormones hypophysaires et surrénaliennes agissent également sur celle-ci.

### Rôle de la Thyroïde et des Surrénales

La **thyroïde** fonctionne en tandem avec les **surrénales**. Elle joue un rôle crucial dans l'oxygénation du corps, tandis que les surrénales aident à détoxifier grâce au **cortisol**. La transformation de la T3 en T4, hormones thyroïdiennes essentielles, dépend de l'équilibre du cortisol. Un stress excessif augmente le cortisol, inhibant la transformation de la T3 en T4, ce qui perturbe l'oxygénation cellulaire.

Les surrénales, en plus de produire des hormones, sont également responsables de la fabrication de neurotransmetteurs. Une défaillance des surrénales peut entraîner divers problèmes de santé, notamment des rhinites, des migraines, et d'autres symptômes liés à des stases.

### Interactions entre Organes

Il existe une dynamique importante entre le cœur, le foie, la rate et l'intestin grêle. Le foie, en tant que rencontre entre différents types de tissus, est influencé par la fonction des surrénales. Un foie congestionné peut se manifester par un visage rouge, indiquant une hypertension portale ou un excès de stockage de fer.

Les couleurs de la peau peuvent également indiquer des déséquilibres :

- **Rouge** : Peut signaler une dysfonction thyroïdienne ou une hypertension portale.
- **Terne, gris, brun** : Indique des dépôts de mélanine et un déséquilibre physiologique.
- **Bleu** : Peut exprimer un déséquilibre cardiovasculaire ou une mauvaise absorption de l'oxygène.
...
![Neurulation précoce](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-17/Endoderme_22.jpeg)
...
Des **lignes horizontales** sur les ongles peuvent signaler des difficultés d'**absorption des nutriments**, tandis que des **lignes verticales** indiquent une mauvaise absorption au niveau intestinal. Des petits points sur les ongles peuvent être liés à des **déficits minéraux**, notamment en **zinc**, **fer** et **cuivre**. En cas d'infection, le corps utilise ces minéraux, qui se trouvent dans les os et les ongles, pour mobiliser les **globules blancs**.

Une fois l'infection éliminée, les minéraux sont également éliminés. Des ongles présentant une inversion peuvent signaler des **poumons** et un **cœur fragiles**. Un arrêt marqué sur les ongles peut indiquer soit un **champignon** (déficit immunitaire), soit un **problème métabolique** profond.

Des ongles en forme de **cuillère** peuvent exprimer un problème d'**absorption** ou de **stockage du fer**, souvent lié à une dégradation des globules rouges. L'absence de l'**lunule** (le petit blanc à la base de l'ongle) peut indiquer un manque de **vitalité**. En appuyant sur l'ongle, il blanchit puis reprend sa couleur, ce qui est un bon signe.

Un **ongle jaune** est le signe d'un **foie fragile**, tandis qu'un **ongle bleu** peut indiquer un problème cardiaque ou pulmonaire. Si l'**lunule** est bleuâtre, cela peut signaler un **foie perturbé**, et si elle est rouge, cela pourrait être un signe précoce de problème cardiaque, surtout si le bout de la langue est très rouge.
...
![Microvillosités apicales et mitochondries](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-18/Endoderme_145.jpeg)
...
Il est essentiel de considérer le **système nerveux** en lien avec le **système viscéral** pour établir un équilibre. Lorsqu'un bébé passe de l'ombilique à la région buccale, il doit être capable de rassembler toutes les informations au niveau de la bouche. Si un bébé ne parvient pas à se rassembler, il est crucial de l'aider à retrouver cette **harmonie** pour qu'il puisse ramener les éléments vers sa **ligne médiane**.

Un enfant, en effet, devient très **buccal**, car la bouche représente une zone de survie. Il a besoin d'un point d'appui, que ce soit en position assise ou allongée. Dans mes traitements, je commence généralement par le **bassin**, le **viscéral**, et j'évite de traiter le crâne trop tôt. Si je dois intervenir au niveau du crâne, je privilégie un point d'appui au niveau de la mâchoire, en évitant de toucher directement la tête.

Il est primordial de **détendre** le bassin, le sacrum et la zone digestive. Si nécessaire, je m'assure également de détendre le **médiastin**. Lorsque je travaille sur le crâne, je le fais de manière très légère, en prenant soin de la **gaine durale**. Plus le toucher est léger, plus il permet d'accéder à des profondeurs anatomiques.

Je laisse l'anatomie se révéler à travers mon corps, en prenant conscience des densifications qui peuvent indiquer un champ électrique plus fort. En touchant la périphérie, je peux ressentir des déviations ou des tensions, mais je reste concentré sur une approche **biodynamique**. Mon intention est de rester sur la santé, sans me laisser distraire par les lésions.

Lorsque je ressens une tension, je ne m'y engage pas directement. Je garde une vision globale et je me concentre sur le **pattern de la santé**. Je peux alors ajuster ma fréquence de contact, passant de la peau aux tissus osseux, tout en restant attentif aux sensations de la personne.

Il est important de maintenir une **immobilité** tout en étant conscient des différentes densifications. Je me concentre sur la gaine dure et son épaississement, tout en restant dans une approche globale. Je cherche à établir une connexion entre les différentes structures, notamment au niveau de la **suture coronale**.
...
La première information que je recherche pour évaluer l'**expansion** est le **tai-chi du cerveau**. Un manque d'énergie à l'arrière indique une fatigue potentielle, ce qui signifie qu'il est nécessaire de rééquilibrer un axe, notamment chez la **mésentérique**. Cela peut être bénéfique pour le plan digestif et aider à revitaliser le corps.

Je constate un manque de **force magnétique** dans le cerveau, ce qui me pousse à explorer un plan nutritif au niveau du crâne. Il est important de détendre les mains et d'adopter une approche moins précise, en prenant de la distance et en développant une vision périphérique. Laissez venir les sensations dans vos mains et ressentez l'**expansion**.

Le premier mouvement à effectuer est une **expansion**. En modifiant un axe, je vais rechercher de manière précise l'axe mésentérique, en me connectant à un reliquat embryonnaire pour aider cette force. Je dois chercher la globalité, en commençant par un niveau splénique. Je reconnecte le corps avec une **énergie vitale ancienne** que le cerveau connaît, sur un plan vasculaire qui est d'abord un **champ électrique**.

Un changement oxydatif a été effectué, modifiant la respiration et me permettant de me positionner sur un autre axe, un vestige presque **phallomésentérique**. Cela crée une sensation plus profonde dans le cerveau. Notez les changements et observez ce qui se passe lorsque cela remonte dans la profondeur du cerveau.

Les **quatre niveaux nutritifs** se composent de quatre tuyaux : la colonne vertébrale et les carotides, formant le tronc basilaire. Je vais libérer un plan, et vous pourrez observer les effets. Vous pourriez ressentir une chaleur dans la tête, ce qui est normal.

Nous travaillons ici sur un niveau subtil. En profondeur, je ressens une **libération**. Le terme "Libérianes" me vient à l'esprit, et je pense que cela vous fera du bien. 
...
`,
  },
  {
    ...
    shortSummary: "Interaction entre les amygdales pharyngiennes et le système sphéno-basilaire, mettant en avant leur rôle immunitaire. Techniques ostéopathiques pour traiter les affections ORL et attention portée au développement immunitaire des enfants.",
...
![Base crânienne vue sup](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-21/Endoderme_25.jpeg)
...
Les recherches scientifiques montrent qu'en travaillant à ce niveau, on développe des **facultés empathiques**, de **compassion** et d'**attention** plus subtiles, ce qui contribue à notre **bonheur**. Ce que j'appelle la **joie**.

Lorsque l'on apprend à rester sur sa respiration et à la suivre, on commence à reconnaître son corps, unissant ainsi le **corps et l'esprit**. Le quatrième niveau consiste à **relâcher le corps**. Une fois ces étapes franchies, on entre dans le cinquième niveau : **générer un sentiment de joie**. 

Il est dit que cet enseignement remonte à **Buddha**, qui proposait **16 façons d'engendrer la respiration**. Nous allons pratiquer un exercice centré sur l'acte **expiratoire**, connu sous le nom de **brahmarie**, ou respiration de l'abeille. Cette technique a un effet très intéressant sur le **cerveau**, apportant rapidement un **calme de l'esprit** et une **diminution du stress**.

La langue est considérée comme le **bourgeon du cœur**, et la **thyroïde** en est issue. Nous parlons avec notre cœur, mais aussi avec la **subtilité fréquentielle** de la thyroïde. À un certain niveau, ce n'est plus le mot qui compte, mais le **son** et la **fréquence** qui touchent.

Je vais vous guider à travers les cinq premières étapes, puis nous pratiquerons le **brahmarie** et observerons un moment de **silence** dans le corps. Il faudra produire un son venant de l'arrière-gorge lors de l'expiration, semblable à celui d'une abeille ou d'un bourdon. Ce son montera dans la cavité jusqu'aux **sinus**, touchant toute la zone cérébrale, y compris la caisse tympanique et les sinus frontal, sphénoïdal, maxillaire et même temporale.

Nous commencerons par adopter une **position droite**. En gardant le dos droit, l'expiration aura un effet physiologique de **relâchement** sur le **nerf vague**, favorisant le passage au **système parasympathique** de récupération. Si je me tiens mal, je réduis cet effet.

Je vais expérimenter cet état de conscience lors de l'inspiration. Au deuxième niveau, je vais porter une attention très soutenue à l'acte respiratoire, conscient du mouvement du corps. Au quatrième niveau, je me détends complètement à l'expiration, tout en restant conscient de mon inspiration.

Nous allons faire **douze respirations**. Les deux premières seront faites normalement, et pour les dix suivantes, nous boucherons légèrement les oreilles. Inspirez, puis à l'expiration, produisez un petit **bourdonnement**. Répétez cela dix fois, puis relâchez et entrez dans le silence qui s'installe. Dans ce silence, laissez émerger un sentiment de joie. Si vous ne savez pas quoi faire, un simple **sourire** peut suffire.

Inspirez à nouveau, expirez, et à la fin de l'expiration, il y a un espace où vous ne respirez pas. Déposez votre esprit dans cet espace. Même lorsque vous réinspirez, restez présent dans cet espace. En vous connectant à cette perception, vous vous rapprochez de la **respiration embryonnaire**, qui n'était pas soumise au mouvement diaphragmatique. 

Votre cœur a commencé à battre après **21 jours** de gestation. Il est donc bénéfique de prendre un moment dans ce silence, car c'est dans le silence que la réorganisation peut se produire. Cette force embryonnaire est toujours présente.
...
![Embryogénèse, fœtus, mère](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-22/Endoderme_30.jpeg)
...
![Gastruation neurulation invagination](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-23/Endoderme_56.jpeg)
...
![Circulation fœtale](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-23/Endoderme_118.jpeg)
...
![Circulation foetale](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-23/Endoderme_119.jpeg)
...
![Coupe œsophage](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-23/Endoderme_76.jpeg)
...
![Hiato esofágico](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-23/Endoderme_132.png)
...
![Diaphragme en vue antérieure](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-23/Endoderme_146.png)
...
![Arcs aortiques embryonnaires](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-23/Endoderme_39.jpeg)
...
![Aorte, arc, intercostales](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-23/Endoderme_71.png)
...
![Innervation thoracique et abdominale](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-23/Endoderme_73.png)
...
![Développement pulmonaire embryonnaire](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-24/Endoderme_78.png)
...
![Neurulation (embryologie)](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-24/Endoderme_11.jpeg)
...
![Arbre bronchique embryonnaire (6e semaine)](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-24/Endoderme_77.png)
...
![Schéma explicatif](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-24/Endoderme_14.jpeg)
...
![Coelome embryonnaire](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-24/Endoderme_111.jpeg)
...
![Diaphragme humain](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-24/Endoderme_74.jpeg)
...
![Embryon humain, organes internes](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-24/Endoderme_82.jpeg)
...
![Lobe pulmonaire, bronches](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-24/Endoderme_85.jpeg)



![Coupe frontale poumons](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-24/Endoderme_91.png)



![Anatomie Pulmonaire](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-24/Endoderme_80.png)
...
![Dôme pleural et ligaments](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-24/Endoderme_90.png)




![Embryon 6 semaines](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-24/Endoderme_81.jpeg)
...
`,
  },
  {
    ...
    shortSummary: "Analyse de l'approche biodynamique des poumons. Étude du mouvement de bascule et du fulcrum embryonnaire pour la fonction respiratoire. Impact des émotions sur la respiration et techniques pour libérer les espaces pleuraux.",
    fullSummary: "Cette vidéo se concentre sur l'approche biodynamique des poumons, en mettant l'accent sur la manière dont le mouvement de bascule des poumons et la recherche du point de fulcrum embryonnaire sont essentiels pour restaurer leur fonction primaire. Les participants apprendront à observer la dynamique entre les poumons, la plèvre et le tissu environnant, notamment comment les émotions, telles que la tristesse, peuvent s'y loger et influencer la respiration. Des techniques visant à initier un dialogue tissulaire et à libérer les espaces pleuraux bondés d'exsudats sont également abordées, en soulignant l'importance de la réorganisation structurelle et émotionnelle des poumons pour améliorer la santé respiratoire.",
    transcriptMarkdown: `
...
Durant les neuf mois de développement embryonnaire, les poumons sont préparés à ce premier mouvement. Ils fabriquent du **liquide amniotique**, une fonction cruciale car l'embryon en a besoin pour sa survie. Ce liquide est en partie issu de l'urine des reins. Plus tard, une **protéine spécifique** appelée **surfactant** sera produite, permettant l'ouverture des poumons au moment de la naissance.

Au départ, la pression exercée est douce. Il s'agit de retrouver progressivement un espace où le poumon peut s'organiser et retrouver sa liberté. Entre la **plèvre viscérale** et la **plèvre pariétale**, il existe une rencontre entre la trachée, la bronche et le tissu bronchique aérien, qui contient de l'air et un volume résiduel, ainsi qu'un espace liquidien.

Il est important de noter que ce tissu peut abriter des émotions, comme une **tristesse** intériorisée. Par exemple, un enfant qui pleure dans ses poumons ou qui souffre de bronchites peut exprimer une tristesse qu'il ne sait pas verbaliser. En travaillant doucement sur ce tissu, il est possible d'initier un dialogue et un échange **oxydatif tissulaire**.

À travers la **grande cissure postérieure**, on peut accéder à des espaces où des émotions sont cachées. Il est essentiel de laisser le corps travailler et de se concentrer sur l'axe de réorganisation. Les **récessus costopleuropulmonaires** sont des sacs d'accumulation d'exsudats, où les déchets des poumons se déposent. Ces zones, souvent moins mobiles, nécessitent d'être dynamisées et libérées.
...
![Lobe supérieur oblique](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-26/Endoderme_87.jpeg)



![Cystic lung disease](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-26/Endoderme_88.jpeg)
...
Il est important d'avoir une **bonne motivation** lorsque vous commencez à méditer. Votre esprit va vous présenter des **obstacles**. Le premier obstacle est la **paresse**. Cela peut se manifester par une **paresse active**, où vous vous engagez dans de nombreuses activités, sauf la méditation. Un autre aspect de la paresse est l'**abandon**, où vous vous dites que la méditation n'est finalement pas pour vous. L'antidote à cela est de trouver une **juste motivation**, qui doit être non seulement pour vous-même, mais aussi pour les autres.

Le deuxième obstacle que vous rencontrerez est l'**oubli** de la méthodologie de la méditation. Au début, il est facile de se perdre dans ses pensées. J'ai moi-même vécu des moments où je croyais méditer, mais je finissais par rêver. La méditation est un **entraînement de l'esprit**, une découverte de son propre fonctionnement. 

Il est normal de ne pas toujours se sentir bien en méditant. L'important est d'apprendre à reconnaître et à entraîner son esprit. L'antidote ici est l'**attention** et la **pleine conscience**. Cela vous permet de découvrir l'**énergie** de votre esprit, la **concentration**, qui vous ouvrira progressivement à une **vision profonde** des choses.
...
Le péritoine, la **rate**, et même certaines parties du **myocarde** peuvent réexprimer des situations **ontogénétiques** d'adaptation, et retrouver des fonctions. La rate est particulièrement importante dans le développement du **système circulatoire**. Lors de la mise en place de ce système, des **pressions** se créent au niveau de la rate, influençant l'ouverture ou non de certains volumes.

Pour qu'un **vaisseau** se forme, quatre composants sont nécessaires : une **trajectoire**, une **concentration métabolique**, des **vacuolisations**, et la présence de **substances intercellulaires**. Un vaisseau peut être comparé à un **arc-en-ciel** : dans un espace-temps donné, il faut la présence du soleil, de la pluie, et une inclinaison adéquate pour qu'il apparaisse. Si l'une de ces conditions disparaît, le vaisseau disparaît également.

Dans le processus **ontogénétique**, des vaisseaux apparaissent puis disparaissent, car il existe un équilibre **volémique** crucial entre le cœur, le foie, la rate et l'intestin grêle, qui agissent comme des **éponges de sang**, en collaboration avec les **poumons**. 

Au moment de la **naissance**, il y a non seulement des compressions osseuses, mais aussi des compressions volémiques. En compressant, on augmente le flux sanguin dans certaines zones, modifiant ainsi les schémas de circulation.

Certaines personnes peuvent être bloquées au niveau de la rate, ce que l'on appelle des **spléniques**. Cela peut se traduire mentalement par des tendances **mélancoliques**. Il est essentiel de relâcher ces champs de pression, car notre mentalité s'appuie sur des volumes.
...
Le péritone répond à ce développement et en est l'expression. On observe la **cavité amniotique**, la **cavité viteline**, et le **pédicule embryonnaire**, entourés par le cellulome externe. Dans la phase de développement suivante, le cellulome externe s'intègre en un cellulome interne de manière synchrone avec la mise en place du tube digestif primitif, ainsi que du péritone viscéral et pariétal. Entre ces deux péritones, un liquide provenant du cellulome externe s'intègre pour devenir le **liquide intrapéritonéal**. Il est important de noter qu'il n'existe aucun organe intrapéritonéal, seulement des organes péritonisés, à quelques exceptions près chez la femme, où une ouverture entre le péritone et le monde extérieur se produit, notamment avec les **trompes**.
...
![Coupe transversale embryon](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-29/Endoderme_100.jpeg)
...
![Développement coelome embryonnaire](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-29/Endoderme_102.jpeg)
...
![Pliage embryonnaire latéral](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-29/Endoderme_103.jpeg)
...
![Embryon, cœlome, amnios](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-29/Endoderme_101.jpeg)
...
`,
  },
  {
    ...
    shortSummary: "Analyse du péritoine comme organe dynamique, essentiel pour la mobilité des liquides, l'intégration embryologique et les échanges moléculaires. Étude des interactions péritonéales et de leurs effets sur le système immunitaire et divers symptômes.",
    fullSummary: "Dans cette vidéo, explorez le péritoine, souvent sous-estimé, en tant qu'organe actif et dynamique. L'enseignement met en avant sa fonction essentielle dans la mobilité du liquide intrapéritonéal, son rôle dans l'intégration embryologique et son implication dans les échanges moléculaires au sein de l'organisme. Les concepts de continuité cellulaire et d'homéostasie sont approfondis, illustrant comment des interactions au niveau péritonéal peuvent déclencher des réponses immunitaires à distance, telles que des réactions allergiques. Un éclairage précieux sur les liens entre le péritoine et des symptômes apparemment non liés, comme l'asthme, rend cette vidéo cruciale pour tout professionnel des thérapies somatiques.",
    transcriptMarkdown: `
...
L'intégration du **cellulome externe** en un **cellulome interne** se déroule dans une dynamique similaire à celle de l'intégration du **tube neural**. On peut comparer cela à l'intégration du **liquide amniotique** dans le tube neural et du **liquide extra-psolomique** dans le système péritonéal. Ce processus se termine autour du **28e jour**, avec un volume péritonéal qui cherche à maintenir une **constance** pour assurer un équilibre hydrostatique de type **homéostasique**, tant sur le plan cérébral que péritonéal.

Le péritoine est également impliqué dans des échanges moléculaires. Il contient des **cellules mésenchymateuses** qui, au-delà de la plaque précordale, deviennent le **péricarde** et le **septum transversum**. Ces cellules sont intégrées par le mouvement global de l'embryon, notamment lors du développement du cœur, qui interagit avec la **vésicule viteline**. Ce processus d'intégration se produit entre le **22e** et le **28e jour**.
...
`,
  },
  {
    ...
    shortSummary: "Mise en place du tractus gastro-intestinal et délimitation de l'embryon avec un examen des fondements du développement embryologique et leur pertinence en pratique médicale.",
    fullSummary: "Cette vidéo aborde en profondeur la mise en place du tractus gastro-intestinal ainsi que la délimitation de l'embryon, en se concentrant sur le développement de l'estomac, du duodénum et du côlon. Les concepts clés tels que la synchronicité du développement, la dynamique des mouvements tridimensionnels, et l'importance du diaphragme pour la délimitation sont explorés. Les relations entre les différents organes, le péritoine et les structures associées sont détaillées, incluant des éléments comme le mésogastre et les épiplombs. Ce contenu offre des bases solides pour toute pratique thérapeutique, en soulignant l'importance d'une compréhension intégrale des processus embryologiques dans l'ostéopathie.",
    transcriptMarkdown: `
...
![Feuilles embryonnaires](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-31/Endoderme_2.png)
...
![Pliage embryonnaire latéral](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-31/Endoderme_32.jpeg)
...
Ce processus s'intègre dans des mouvements de **rotation spécifiques**, organisés dans des sens horaires et anti-horaires. Sur un plan frontal, nous observons un mouvement de développement global **anti-horaire**, tandis que sur un plan transversal, le mouvement est **horaire**. La cavité péritonéale commence à s'organiser et à se délimiter, ce qui implique qu'elle va bouger. 
...
![Projection estomac antérieure](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-31/Endoderme_165.png)
...
![Anatomie abdominale supérieure](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-31/Endoderme_169.png)
...
![Embryon humain, organes](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-31/Endoderme_200.png)
...
![Pliage embryonnaire latéral/crânio-caudal](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-31/Endoderme_94.jpeg)



![Diaphragme humain](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-31/Endoderme_96.jpeg)



![Pliement embryonnaire latéral](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-31/Endoderme_104.jpeg)
...
Le **petit épiplon**, également connu sous le nom de gastrohépatique, est situé sur le feuillet gauche. Ce feuillet droit du péritoine viscéral gastrique est essentiel pour comprendre la dynamique de l'estomac.

### Développement des Organes

Le développement des organes, comme le foie, est influencé par leur apport en **nutriments** et en **informations** via le système vasculaire. Le foie agit comme un moteur, organisant les mouvements des autres organes dans la cavité hépatos-gastro-pancréatique. Ce mouvement est généralement **horaire**.

Le **tronc cœliaque** est un centre d'organisation vasculaire important. Il comprend l'artère stomachique, l'artère coronaire et l'artère splénique, qui nourrissent respectivement l'estomac et la rate. 

### Mouvements de l'Estomac

L'estomac subit un mouvement de **rotation** qui est influencé par la croissance du foie. Ce mouvement crée une **poche rétro-gastrique**, également appelée arrière-cavité des épiplons, qui est essentielle pour le bon fonctionnement de l'estomac. Cette poche permet à l'estomac de se déplacer librement, facilitant ainsi son **brassage** et sa **digestion**.

Le grand épiplon, formé par la rencontre de plusieurs feuillets, est un tissu vital qui relie l'estomac, la rate et le pancréas. Il joue un rôle dans la **libération** de l'estomac et constitue un espace d'adaptation.

### Importance du Péritoine

Le péritoine est une membrane qui contient des informations sur tous les organes, agissant comme un organe lymphoïde. En cas d'infection, il mobilise des cellules immunitaires pour nettoyer la zone affectée. 

La **poche rétro-gastrique** est un point d'appui embryonnaire crucial, reliant le péritoine gastrique antérieur et postérieur. Cette organisation est essentielle pour le bon fonctionnement des organes environnants, notamment le cœur et les poumons.

### Traitement et Libération de l'Estomac

Pour traiter l'estomac, il est crucial de lui redonner un espace de **glissement** et de libérer les tensions au niveau du diaphragme et de l'œsophage. Les tensions intragastriques, exprimées par l'**angle de His**, peuvent être travaillées pour améliorer la fonction gastrique.

Il est également important de prendre en compte l'impact des organes pelviens sur l'estomac. Les déséquilibres hormonaux au niveau du petit bassin peuvent influencer la fonction gastrique. 
...
Nous allons travailler depuis la **base du crâne** jusqu'à la **jonction œsophageo-cardiotuberositaire** de l'estomac. Il est également crucial de considérer la zone d'appui au niveau **yoïdien**, en lien avec le **fulcrum** de l'œsophage et son **fulcrum embryologique**. Ce dernier est représenté par le **hiatus de Vinso**, qui se remet en place à chaque fois. 

Il est important de rechercher les **points d'appui** pour que le système s'organise efficacement dans sa fonction. Nous avons identifié plusieurs fonctions de l'estomac : **hormonale**, **mécanique**, et **fluidique**. De plus, l'estomac est en relation avec la **parole**. Son fonctionnement débute dans la bouche, avec la langue, la salive, les dents et les déglutitions. Cela souligne l'importance de ne pas ravaler nos mots.

La **colère** peut s'exprimer, se réprimer ou nous illuminer. Si elle s'exprime, cela peut être problématique. Si elle est réprimée, c'est très mauvais. Cependant, si nous l'utilisons avec clarté, elle peut nous éclairer. Au moment où la colère monte, il y a une vision qui peut être exploitée pour revenir à la **clarté de l'esprit**. Chaque émotion a sa **sagesse** et peut être transformée en **éveil**.

Nous observons autour de l'iris un petit **anneau stomacal**. En examinant la lèvre, on peut noter une légère décoloration, ainsi qu'une langue pâle et tremblante. Pour travailler sur l'estomac, nous commencerons depuis la base du crâne, en reprenant la **gaine durale** tout en appliquant un appui doux pour rechercher les **anneaux** et permettre une **liberté**.

Nous aborderons d'abord un plan **tissulaire**, puis éventuellement un plan **cellulaire**, et si nécessaire, un plan **moléculaire**, **enzymatique** ou **énergétique**. Le travail se fait doucement par rapport à la **symphyse phénobasilaire**. Un léger gonflement dans la loge du cou peut indiquer des vieux stress liés aux **surrénales**. Nous libérons par les reins et le diaphragme, redonnant ainsi de la **souplesse** aux piliers diaphragmiques.

Nous pouvons également travailler sur l'**os hyoïde** en lien avec son **fulcrum embryonnaire**. Des tensions peuvent être ressenties au niveau de l'hypoglosse, ce qui indique des **non-dits** qui peuvent être libérés pour faciliter l'expression. En prenant en compte la jonction de l'estomac, nous pouvons également travailler sur le **sphénoïde** pour relâcher les tensions.

L'estomac, dans sa globalité, est relié à l'arrière-cavité des **épiplants**. En plaçant nos mains sur la partie postérieure de l'estomac, nous créons une surface de **glissement** pour permettre l'expression. Nous observons la respiration du patient, en nous connectant à son souffle. Le travail se fait dans le **vide**, où nous pouvons recevoir des informations du tissu.
...
![Vascularisation artérielle estomac](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-33/Endoderme_123.jpeg)



![Anastomoses porto-caves](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-33/Endoderme_131.jpeg)
...
![Duodénum et mésentère](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-35/Endoderme_186.jpeg)
...
![Fascias d'accolement duodénum](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-35/Endoderme_137.jpeg)
...
Le sphincter iliosécal se développe également, lié à la mise en place des cadres entre le mésentaire et l'angle colique droit. La position du sphincter peut influencer le système immunitaire, et une déstabilisation du cadre duodénal peut affecter la fertilité en perturbant le flux sanguin.
...
![Ampoule de Vater](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-35/Endoderme_139.jpeg)
...
![Terminaison canaux bilio-pancréatiques](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-35/Endoderme_140.jpeg)
...
![Vascularisation duodénale et pancréatique](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-35/Endoderme_143.jpeg)



![Duodénum rapports postérieurs](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-35/Endoderme_142.jpeg)
...
![Hépatogenèse embryonnaire régulée](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-37/Endoderme_147.png)
...
![Embryon et foie fœtal](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-37/Endoderme_153.jpeg)
...
![Embryon 28 jours système veineux](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-37/Endoderme_155.jpeg)
...
![Circulation embryonnaire 8 semaines](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-37/Endoderme_156.jpeg)
...
![Embryon, circulation veineuse](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-37/Endoderme_157.jpeg)
...
![Développement vasculaire embryonnaire](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-37/Endoderme_159.png)
...
![Système porte embryonnaire](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-37/Endoderme_160.png)
...
![Circulation hépatique](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-37/Endoderme_166.jpeg)
...
![Système biliaire intrahépatique](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-37/Endoderme_167.png)
...
`,
  },
  {
    ...
    shortSummary: "Développement du pancréas, avec les transitions entre le pancréas antérieur et dorsal et ses interactions avec d'autres structures embryologiques. Impact de ces relations sur la santé métabolique et l'insuline.",
    fullSummary: "Dans cette vidéo sur le développement du pancréas, vous apprendrez comment cet organe crucial se forme à partir de la phase de développement hépatique et des mouvements gastriques. À travers une approche détaillée, le contenu couvre les transitions entre le pancréas antérieur et dorsal, ainsi que les types de pancréas exocrine et endocrine. Les interactions entre le pancréas, le foie et les autres structures embryologiques comme l'estomac et le cœur sont explorées, illustrant la complexité de ces relations et leur impact sur la santé métabolique via l'insuline. Cette leçon inclut des éléments théoriques et pratiques, idéaux pour améliorer votre compréhension en ostéopathie et embryologie.",
    transcriptMarkdown: `
...
Au cours de la phase de **rotation**, le pancréas antérieur effectue un grand mouvement de trois quarts, rejoignant la partie postérieure pour former les deux types de pancréas : un **pancréas exocrine** et un **pancréas endocrine**. Le pancréas exocrine secrète des substances en rapport avec le système des **sucs gastriques** et **sucs pancréatiques**, tels que l'**amylase**, la **lipase** et la **protéase**.
...
Si vous avez compris le mouvement de développement de l'arrière-cavité des épiplons, vous commencez à saisir que tout le reste n'est qu'une dynamique de ce développement sur un plan transversal. Le pancréas joue un rôle crucial en libérant de l'**insuline**, qui ouvre les portes cellulaires, influençant ainsi l'**activité mitochondriale** et le métabolisme des sucres.

Lors de la dissection, il est important de noter qu'il est très difficile de séparer le **duodénome** du pancréas, car ils sont profondément accolés. Si l'on observe la structure par le haut, on peut voir un mouvement hépatique qui tourne l'estomac et crée l'arrière-cavité, s'orientant de manière spécifique.
...
![Irrigation estomac/pancréas/rate](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-38/Endoderme_125.png)



![Vaisseaux duodénopancréatiques](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-38/Endoderme_141.jpeg)
...
`,
  },
  {
    ...
    shortSummary: "Développement embryologique de l'anse intestinale, rotation antihoraire, rôle de l'artère mésentérique supérieure et influences des émotions sur la santé intestinale en ostéopathie.",
...
![Rotation anse intestinale](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-39/Endoderme_172.png)
...
![Troncs artériels embryonnaires](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-39/Endoderme_184.jpeg)
...
![Circulation villosités intestinales](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-39/Endoderme_122.jpeg)
...
![Pli ventral/latéral embryonnaire](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-39/Endoderme_133.jpeg)
...
![Tourbillon embryologique](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-39/Endoderme_196.jpeg)
...
![Appareil digestif embryonnaire](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-39/Endoderme_174.jpeg)



![Intestin moyen, rotation](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-39/Endoderme_175.jpeg)



![Intestin grêle vascularisé](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-39/Endoderme_176.jpeg)



![Amniocentèse, Embryon, Utérus](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-39/Endoderme_135.jpeg)



![Appendice, caecum, variations](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-39/Endoderme_187.jpeg)



![Position de l'appendice](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-39/Endoderme_188.jpeg)



![Vascularisation appendice caecum](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-39/Endoderme_189.jpeg)
...
`,
  },
  {
    ...
    shortSummary: "Techniques de palpation pour équilibrer le cadre colique, en lien avec la motilité intestinale et les aspects psychiques. Informations sur les dynamiques internes et les interrelations corps-psyché pour les thérapeutes.",
    fullSummary: "Dans cette vidéo, la pratique du cadre colique est explorée à travers des points d'appui cruciaux tels que l'artère mésentérique et l'angle collique gauche. Les intervenants mettent l'accent sur la motilité intestinale et son lien avec les plans psychique et émotionnel, démontrant comment certaines tensions peuvent refléter des déséquilibres internes comme la ptose ou des dysfonctionnements viscéraux. L'importance de la normotension abdominale est soulignée, affrontant les problématiques d'hypertension et d'hypotension. Les connexions entre le côlon transverse et les certitudes personnelles, ainsi que l'impact des excès alimentaires sur le bien-être, sont également abordées, offrant aux étudiants et thérapeutes des clés pour une approche intégrative et libératrice.",
    transcriptMarkdown: `
# Pratique 1 : Le Cadre Colique

Dans cette pratique, nous allons explorer les **points d'appui** essentiels dans le cadre colique.

Le **premier point d'appui** est l'**artère mésentérique**. Ensuite, le **deuxième point d'appui** se situe à l'**angle collique gauche**, qui est fixé. Le **troisième point d'appui** se trouve en profondeur. Enfin, le dernier point d'appui est lié à la dynamique de l'intestin, qui se déplace en sens inverse.

Le mouvement que nous observons est un mouvement de **motilité**. À partir de ce point, nous pouvons commencer à parcourir une **histoire**. Je suis immédiatement attiré vers l'**estomac**, la **rate** et l'angle collique gauche. Ce point d'appui est en train de rééquilibrer un **plan psychique** assez profond. Il est possible qu'il cherche à se rapprocher d'un **fulcrum** plus en avant pour retrouver des informations.

Ce point est en équilibre entre le **plan aortique** et le **plan splénique**. C'est un plan d'intégration, un inconscient qui désire remonter à la surface, pouvant s'exprimer sous forme de **rêve** ou de **cauchemar**. En plaçant le point d'appui sur le côté gauche, je cherche à obtenir une certaine **liberté**.

Le point final se situe ici. Normalement, la **tension épigastrique** doit être légèrement supérieure à la **tension hypogastrique**. Il s'agit toujours d'une recherche de **normotension abdominale** ou d'**hypotension abdominale**. Si, lors de ma palpation, je constate que la tension hypogastrique est supérieure à la tension épigastrique, cela indique un système de **ptose**.

Dans ce cas, je dois travailler sur un système de **rééquilibrage viscérospatial** ou fluide. En cas d'**hypertension**, il est nécessaire de relibérer les fluides. En revanche, pour l'**hypotension**, un relâchement est requis, ce qui implique de réintégrer le système viscérospatial pour redonner de la **dynamique** et augmenter la force.

Il est important de noter que des **excès alimentaires** peuvent encore être améliorés. En remontant, j'observe un angle qui se forme, et en redescendant, je me dirige vers ma **zone de joie**. Si les problèmes ne sont pas résolus, cela peut mener à la **zone de colère**.
...
![Tube digestif embryonnaire](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-40/Endoderme_173.jpeg)
...
Lors de la palpation, il est essentiel de prendre tout le ventre dans les mains, en gardant les mains bien détendues. Une respiration trop haute peut indiquer une demande de **discrétion**. La **chaleur** ressentie est un échange entre le praticien et le patient, où le tissu commence à donner des informations. Si le tissu se met en défense, la zone inférieure commence à se détendre, tandis que la partie supérieure manque encore d'homogénéité. L'objectif est de retrouver un état homogène.

Lorsque la chaleur augmente, toutes les lignes de force semblent s'orienter vers la zone utérine, comme si le tissu réintégrait son **nid**. Cela aide le patient à revenir dans sa **maison intérieure**, semblable à quelqu'un attaché à sa terre. À ce stade, le praticien peut élargir son contact à l'ensemble du corps, initiant un **processus thérapeutique**. L'intégration vers la zone utérine se renforce, et une plus grande homogénéité se crée entre les mains.
...
![Anatomie du côlon](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/endoderme/endo-41/Endoderme_183.jpeg)
...
![L'image un concept général, et ce paragraphe, traitant de la conscience de notre lien avec la Terre, préfigure l'introduction et la nécessité d'une 'nouvelle vision' qui suivra](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/oeil/oeil-1/Oeil_2.png)
...
`,
  },
  {
    ...
    shortSummary: "Analyse de l'anatomie et de la physiologie de l'œil, mettant en évidence son rôle dans la vision, l'équilibre et la perception émotionnelle. Relations entre l'œil, le cœur et autres systèmes corporels, avec une approche multidisciplinaire en thérapeutique.",
    fullSummary: "Cette vidéo offre une plongée fascinante dans l'anatomie et la physiologie de l'œil, révélant son rôle vital non seulement dans la vision, mais aussi dans l'équilibre et la perception émotionnelle. Les concepts clés incluent la relation étroite entre l'œil et le cœur, les influences des tensions oculaires sur le foie et la nécessité d'une approche multidisciplinaire qui combine embryologie, anatomie et dimensions spirituelles. En apprenant à adresser l'œil dans un contexte global, les thérapeutes pourront mieux comprendre les impacts des émotions sur la perception et, par extension, améliorer leur pratique en prenant en compte les liens entre la structure physique et les informations environnementales qui influencent notre vision.",
    transcriptMarkdown: `
...
![Concept de l'œil comme 'phare des fascias' et son influence sur le centre de gravité, tel que décrit dans le texte](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/oeil/oeil-2/Oeil_1.png)
...
L'**attention** est un outil crucial à aiguiser pour travailler la vue. Les émotions, comme la peur ou la colère, peuvent altérer notre perception de la réalité. Par exemple, la colère peut offrir une clarté temporaire, mais elle peut aussi déformer notre vision.
...
![Schéma relatif à l'origine de l'oeil à partir du diencéphale, en lien avec le troisième ventricule](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/oeil/oeil-3/Oeil_1.png)
...
![Schéma de l'apparition de la cavité amniotique, qui est mentionnée juste après cette phrase dans le résumé](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/oeil/oeil-3/Oeil_2.jpeg)
...
![Vestige de la cavité amniotique (zone B)](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/oeil/oeil-3/Oeil_5.png)
...
![Processus d'implantation : formation de la cavité](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/oeil/oeil-3/Oeil_3.jpeg)
...
![Cavité amniotique](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/oeil/oeil-3/Oeil_4.jpeg)
...
Il est crucial d'observer les yeux après un traitement. Si la position des yeux n'est pas stable, cela indique que l'équilibre n'est pas encore rétabli. La cavité amniotique, bien qu'elle ne soit plus sous forme liquide, reste présente sous d'autres états, comme vaporeux.
...
![Croissance différentielle](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/oeil/oeil-4/Oeil_2.jpeg)
...
![Liquide amniotique primitif](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/oeil/oeil-4/Oeil_5.jpeg)



![Formation de la gouttière neurale](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/oeil/oeil-4/Oeil_4.jpeg)



![Transformation de la plaque neurale en gouttière neurale](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/oeil/oeil-4/Oeil_3.jpeg)
...
![Fermeture pour former le tube neural et la formation des crêtes neurales](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/oeil/oeil-4/Oeil_6.png)
...
`,
  },
  {
    ...
    shortSummary: "Rôle de la notochorde dans le développement embryonnaire, son impact sur le tube neural et la formation des organes par des signaux électromagnétiques et des éléments nutritifs.",
...
![Tube neural et les ébauches optiques qui se forment](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/oeil/oeil-7/Oeil_2.png)
...
![Placode optique qui s'épaissit et se comporte comme un fulcrum](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/oeil/oeil-7/Oeil_5.png)
...
![Premiers stades du développement de l'œil](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/oeil/oeil-8/Oeil_1.png)
...
![Formation de la vésicule optique et différenciation de la rétine](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/oeil/oeil-8/Oeil_2.png)
...
![Développement et invagination du cristallin](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/oeil/oeil-8/Oeil_3.png)
...
![Schéma général de l'œil](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/oeil/oeil-9/Oeil_1.png)
...
![Tuniques de l'œil, processus ciliaires et rétine](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/oeil/oeil-9/Oeil_2.png)
...
![Invagination de l'ectoderme](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/oeil/oeil-14/Oeil_3.png)
...
![Mouvement de la crête neurale](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/oeil/oeil-15/Oeil_1.png)
...
Ce tissu est hautement **informé** et **informateur**. Par exemple, tout ce qui se trouve dans votre ventre est également issu de la crête neurale. Les **ganglions** et autres structures reflètent l'état interne du corps, permettant d'apprendre à **lire le visage** à travers les rides, les cernes et les couleurs.

## Migration et Développement

Le **prosencéphale** se développe en **téléencéphale** et **diélencéphale**, avec une migration significative du diélencéphale. Ce dernier, ainsi que le **diencéphale** et le **mésencéphale** antérieur, migrent vers la crête neurale. Ce processus de coulée est essentiel pour le développement.
...
![Sillon optique et vésicule](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/oeil/oeil-2/Oeil_1.jpeg)

 La flexion céphalique et cervicale entraîne une rencontre entre le cerveau et le cœur, avec l'œil se déposant sur le cœur.

![Rencontre du cerveau et du cœur](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/oeil/oeil-5/Oeil_1.jpeg)
...
![Points d'appui](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/oeil/oeil-5/Oeil_3.jpeg)
...
![Chargement électrique de l'os](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/oeil/oeil-19/Oeil_2.jpeg)



![Création de charges sur l'os](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/oeil/oeil-19/Oeil_1.jpeg)
...
![Lignes de force (poutres)](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/oeil/oeil-19/Oeil_3.png)
...
![Poutre canino-nasale frontale](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/oeil/oeil-19/Oeil_4.png)
...
![Schéma explicatif](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/oeil/oeil-20/Oeil_1.jpeg)
...
`,
  },
  {
    ...
    shortSummary: "Influence du ligament liliequist sur le drainage cérébral et l'équilibre des systèmes nerveux et hormonal. Exploration des liens avec l'embryologie biodynamique et l'ostéopathie.",
    fullSummary: "Cette vidéo explore l'anatomie et les mécanismes du ligament liliequist, une structure essentielle qui agit comme un diaphragme au niveau du troisième ventricule. On y apprend comment ce ligament interagit avec le nerf oculomoteur et le tronc basilaire, influençant ainsi le système ventriculaire et l'hypophyse. Les concepts de tensions membraneuses, d'axes de mouvement crânien et de leur impact sur les systèmes facial et hormonal sont abordés, tout en soulignant l'importance des mouvements crânio-sterno-sacrés et mandibulaires. L'analyse des tensions peut également aider à diagnostiquer des dysfonctionnements au niveau occlusal, offrant des clés thérapeutiques pour rétablir l'harmonie corporelle.",
    transcriptMarkdown: `
...
![Ligament de Liliequist](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/oeil/oeil-21/Oeil_1.png)
...
![Système ventriculaire](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/oeil/oeil-21/Oeil_2.png)
...
![Mouvements crâniens](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/oeil/oeil-21/Oeil_3.png)
...
![Mouvements coordonnés du crâne, sternum et sacrum](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/oeil/oeil-21/Oeil_4.png)
...
En palpant la **suture coronale**, il est possible de ressentir des variations de chaleur et de vibration, ce qui indique un bon équilibre. En travaillant sur la **bosse frontale** et la ligne **zygomatico-bosse frontale**, on peut identifier des zones de déséquilibre.
...
![Fente sphénoïdale](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/oeil/oeil-23/Oeil_29.png)
...
![Neurocrâne et viscérocrâne, notamment l'importance du palatin et du zygoma mentionnés](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/oeil/oeil-23/Oeil_1.png)
...
![Vue d'ensemble des tuniques de l'œil](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/oeil/oeil-23/Oeil_2.png)
...
![Coupe de l'œil](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/oeil/oeil-23/Oeil_3.png)
...
![Pupille et sa fonction de régulation de la lumière](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/oeil/oeil-23/Oeil_9.png)
...
![Jonction de la conjonctive](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/oeil/oeil-23/Oeil_22.png)



![Glande lacrymale et son système de drainage](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/oeil/oeil-23/Oeil_21.png)



![Glandes de sécrétions et la continuité du tarsus avec le muscle de Muller](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/oeil/oeil/oeil-23/Oeil_20.png)



![Face muqueuse de la paupière (conjonctive)](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/oeil/oeil-23/Oeil_19.png)



![Anatomie de la paupière](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/oeil/oeil-23/Oeil_18.png)



Le **tendon de Zinn** est le point d'attache des muscles oculomoteurs, qui sont en relation avec les muscles de la nuque.

![Relation de la capsule de Tenon avec les fascias du corps](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/oeil/oeil-23/Oeil_30.png)



![Muscles oculomoteurs](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/oeil/oeil-23/Oeil_28.png)



![Muscles oculomoteurs](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/oeil/oeil-23/Oeil_27.png)



![Muscles oculomoteurs](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/oeil/oeil-23/Oeil_26.png)



![Muscles oculomoteurs](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/oeil/oeil-23/Oeil_25.png)



![Muscles oculomoteurs](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/oeil/oeil-23/Oeil_24.png)



![Musculature oculaire et le point d'attache du tendon de Zinn](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/oeil/oeil-23/Oeil_23.png)

 Les nerfs optiques et les artères ophtalmiques jouent un rôle crucial dans la vascularisation et l'innervation de l'œil.

![Relation entre carotide et nerf optique](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/oeil/oeil-23/Oeil_34.png)
...
![Vascularisation de l'œil, commençant par la carotide](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/oeil/oeil-23/Oeil_31.png)

 Les **péricytes** ou cellules de Rouget modulent l'information au niveau des capillaires, en particulier dans la rétine.

![Péricytes et leur rôle dans la modulation de l'information](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/oeil/oeil-23/Oeil_32.png)
...
![L'innervation et la réunion des informations dans le canal optique](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/oeil/oeil-23/Oeil_35.png)
...
Les sensations peuvent être agréables ou désagréables. Parfois, une sensation agréable peut devenir désagréable avec le temps, et vice versa. Le Bouddha illustre cela avec l'image des **bulles de savon** : elles apparaissent, puis disparaissent. Nous avons tendance à nous attacher à ces sensations, créant ainsi un **attachement** à ce qui n'existe plus. 
...
C'est au niveau de la rétine que se produit le **décollement**, un phénomène important à connaître. À ce stade, la **cupule optique primitive** se forme et établit une connexion **juxtacrine** avec l'**épiblase** de surface. Cette interaction entraîne un épaississement de l'épiblase, créant ainsi la **placode optique extérieure**, qui est maintenue en place pendant que la structure environnante se développe.
...
![Couches de l'œil](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/oeil/oeil-26/Oeil_2.png)

 Ensuite, la lumière passe par la **pupille**.

La chambre antérieure, qui contient de l'**humeur aqueuse**, est suivie par la chambre postérieure, qui contient également ce liquide. Les **corsilières** à l'avant fabriquent du liquide, tandis que le **canal de Schlemm** à l'arrière réabsorbe ce liquide. Ce processus permet une circulation continue de liquide qui nourrit l'œil.
...
![Parcours de la lumière jusqu'au nerf optique](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/oeil/oeil-27/Oeil_1.png)
...
![Rôle des cellules horizontales et amacrines](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/oeil/oeil-27/Oeil_2.png)
...
![Corps Genouillé Latéral (CGL)](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/oeil/oeil-28/Oeil_2.png)
...
![Cellules parvocellulaires et magnocellulaires](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/oeil/oeil-28/Oeil_3.png)
...
![Distribution de l'information du CGL au pulvinar](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/oeil/oeil-28/Oeil_5.png)
...
![Connexions du pulvinar](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/oeil/oeil-28/Oeil_4.png)



![Parcours de l'information visuelle vers le CGL](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/oeil/oeil-28/Oeil_1.png)
...
![Intégration multisensorielle (auditive et vestibulaire)](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/oeil/oeil-28/Oeil_6.png)
...
![Rôle dans les saccades et l'orientation de la tête](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/oeil/oeil-28/Oeil_7.png)
...
![Circuit de Papez et mémoire](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/oeil/oeil-28/Oeil_8.png)
...
![Circuit de Papez : consolidation de la mémoire](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/oeil/oeil-28/Oeil_9.png)
...
![Réinterprétation de l'information perçue](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/oeil/oeil-28/Oeil_11.png)

 Ce processus d'interprétation est influencé par les connexions entre les aires visuelles et le corps genouillé latéral.

![Interprétation de la réalité](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/oeil/oeil-28/Oeil_10.png)
...
![Importance du CGL dans la perception](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/oeil/oeil-28/Oeil_12.png)
...
![Formation de la base du crâne](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/oeil/oeil-31/Oeil_1.png)
...
![Développement de l'hypophyse](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/oeil/oeil-31/Oeil_3.png)
...
![Développement de l'infundibulum](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/oeil/oeil-31/Oeil_4.png)
...
L'œil, en tant que source d'information, joue un rôle essentiel dans l'intégration de ces messages. Il contribue à un résultat postural spécifique, représentant la meilleure adaptation possible à un moment donné. Il n'existe pas de mauvaise position, seulement la réponse fonctionnelle la plus adéquate. Il est crucial de faire confiance à ce que l'on voit, tout en étant conscient que le programme peut parfois tourner en boucle. Cela nécessite un regard, un geste libérateur, réalisé au bon moment et dans le bon espace.
...
![Yeux en spirale](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/oeil/oeil-32/Oeil_1.png)
...
![Croisement sur la ligne](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/oeil/oeil-32/Oeil_2.png)

 Chaque œil a un rôle postural et un œil dominant, qui ne sont pas toujours les mêmes.

![Axes et angles d'intégration visuelle](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/oeil/oeil-32/Oeil_3.png)



Les mouvements oculaires sont essentiels pour le rééquilibrage.

![Mouvements oculaires](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/oeil/oeil-32/Oeil_7.png)
...
![23 degrés de liberté visuelle](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/oeil/oeil-32/Oeil_4.png)
...
![Axes orbitaires et pyramidaux](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/oeil/oeil-32/Oeil_5.png)
...
![Mémoires dans l'os](https://eqcjgucfpmhvxkckokwb.supabase.co/storage/v1/object/public/schemas/images/schemas/oeil/oeil-32/Oeil_6.png)
