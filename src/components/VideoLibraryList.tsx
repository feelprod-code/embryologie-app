...
export const VideoLibraryList: React.FC<VideoLibraryListProps> = ({ onSelectVideo }) => {
    ...
    return (
        <div className="w-full flex-1 flex flex-col pt-0 pb-16">
            ...
            <div className="sticky top-[0px] md:top-[50px] lg:top-[50px] z-20 w-[100vw] md:w-full bg-[#FAF9F6] -mx-2 sm:-mx-6 lg:mx-0 pt-[env(safe-area-inset-top,4px)] md:pt-[26px] lg:pt-[26px] flex flex-col items-center pb-[24px] md:pb-[16px] px-2 border-b border-transparent md:border-slate-100 shadow-sm md:shadow-none">
