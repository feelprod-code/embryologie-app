...
export const VideoLibraryList: React.FC<VideoLibraryListProps> = ({ onSelectVideo }) => {
    ...
    return (
        <div className="w-full flex-1 flex flex-col pt-0 pb-16">
            ...
            <div className="sticky top-[0px] md:top-[60px] z-50 w-[100vw] md:w-full bg-[#FAF9F6] -mx-2 sm:-mx-6 lg:mx-0 pt-[env(safe-area-inset-top,4px)] md:pt-4 lg:pt-4 flex flex-col items-center shadow-sm md:shadow-none pb-2 md:pb-2 mb-4 md:mb-2 px-2 border-b border-transparent md:border-slate-100/50">
