...
export const VideoLibraryList: React.FC<VideoLibraryListProps> = ({ onSelectVideo }) => {
    ...
    return (
        <div className="w-full flex-1 flex flex-col pt-0 pb-16">
            ...
            <div className="sticky top-[0px] md:top-[59px] lg:top-[59px] z-20 w-[100vw] md:w-full bg-background/100 -mx-2 sm:-mx-6 lg:mx-0 pt-[env(safe-area-inset-top,4px)] md:pt-[1px] lg:pt-[1px] flex flex-col items-center shadow-sm md:shadow-none pb-6 md:pb-4 px-2 border-b border-transparent md:border-solid md:border-slate-200">
