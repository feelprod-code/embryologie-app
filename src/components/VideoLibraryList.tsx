                                ...
                                >
                                    ...
                                    >
                                        ...
                                        <div className="flex-1 min-w-0 pr-4">
                                            <h3 className={cn(
                                                "text-sm sm:text-base md:text-[13px] lg:text-[13px] font-sans font-medium tracking-wide truncate transition-transform duration-300 uppercase sm:group-hover:translate-x-1",
