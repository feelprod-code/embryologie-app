...
export const VideoLibraryList: React.FC<VideoLibraryListProps> = ({ onSelectVideo }) => {
    ...
    return (
        <div className="w-full flex-1 flex flex-col pt-0 pb-16">
            ...
            <div className="sticky top-0 md:top-[60px] z-50 w-[100vw] md:w-full bg-[#FAF9F6] -mx-2 sm:-mx-6 lg:mx-0 pt-[env(safe-area-inset-top,4px)] md:pt-1 lg:pt-1 flex flex-col items-center shadow-sm md:shadow-none pb-2 md:pb-0 mb-4 md:mb-0 px-2 border-b border-transparent md:border-slate-100/50">
