...
export const VideoLibraryList: React.FC<VideoLibraryListProps> = ({ onSelectVideo }) => {
    ...
    return (
        <div className="w-full flex-1 flex flex-col pt-0 pb-16">
            ...
            <div className="sticky top-[50px] md:top-[83px] lg:top-[83px] z-40 w-[100vw] md:w-full bg-[#FAF9F6] -mx-2 sm:-mx-6 lg:mx-0 pt-2 md:pt-4 flex flex-col items-center pb-4 md:pb-4 px-2 border-b border-transparent md:border-slate-100 shadow-sm md:shadow-none">
