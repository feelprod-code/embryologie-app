            ...
            >
                ...
                {activeSubtitle && subtitlesEnabled && (
                    <div
                        ...
                        style={{ zIndex: 20, paddingBottom: showControls ? 'env(safe-area-inset-bottom)' : '0px' }}
                    >
                        <span
                            className="text-slate-700 bg-white/95 px-3 py-1.5 rounded-xl mx-4 max-w-[95%] sm:max-w-[85%] md:max-w-3xl text-center whitespace-pre-wrap break-words font-sans shadow-md mb-0"
                            style={{
