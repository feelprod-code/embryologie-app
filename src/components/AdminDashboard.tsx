...
export function AdminDashboard() {
    ...
    return (
        <div className="w-full max-w-6xl mx-auto p-4 md:p-8 animate-fade-in mt-[60px] md:mt-0">
            <div className="mb-8 flex flex-col md:flex-row md:items-center justify-between gap-4 pt-10">
                <div>
                                        ...
                                        <td className="px-6 py-4 whitespace-nowrap">
                                            {profile.device_id ? (
                                                <div className="flex items-center text-sm text-slate-600 font-medium">
                                                    ...
                                                    <span className="truncate w-24" title={profile.device_id}>{profile.device_id.split('-')[0]}...</span>
                                                </div>
                                            ) : (
