                ...
                <div className="flex-1 w-full bg-transparent rounded-t-3xl shadow-[0_-15px_40px_rgba(0,0,0,0.06)] border-t border-slate-200 overflow-hidden flex flex-col relative z-30">
                    ...
                    <div className="flex-1 overflow-y-auto no-scrollbar relative">
                        <div className="p-6 md:p-10 lg:p-14 pb-32 md:pb-48 lg:pb-[200px]">
                            ...
                            {/* Credits FeelProd */}
                            <div className="flex flex-col items-center mt-16 pb-4 mb-20 lg:mb-4">
                                <span className="text-[10px] sm:text-sm lg:text-base text-slate-400 font-light uppercase tracking-[0.3em] text-center mb-1">
