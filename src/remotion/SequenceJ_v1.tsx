        ...
        <AbsoluteFill className="bg-[#FAF6ED] flex items-center justify-center font-sans overflow-hidden" style={{ perspective: '1500px' }}>
            ...
            >
                ...
                {frame >= 25 && (() => {
                    ...
                    const fadeOut = interpolate(frame, [105, 115], [1, 0], { extrapolateRight: 'clamp' });
            ...
            {/* --- SOUND EFFECTS --- */}
            <Sequence name="Bruitage - click.wav" from={240} durationInFrames={30}>
                <Audio src={staticFile('click.wav')} volume={0.8} />
            </Sequence>
            <Sequence name="Bruitage - click.wav" from={350} durationInFrames={30}>
                <Audio src={staticFile('click.wav')} volume={0.8} />
            </Sequence>
            <Sequence name="Bruitage - click.wav" from={470} durationInFrames={30}>
                <Audio src={staticFile('click.wav')} volume={0.8} />
            </Sequence>
