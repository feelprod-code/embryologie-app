...
export const SequenceK: React.FC = () => {
    ...
    // 4. Sortie de l'iPhone et Entrée du Document PDF (frame 380, juste après le clic 275 et le chargement)
    // Au clic, on switche IMMÉDIATEMENT (stiffness élevé, sans rebond) !
    const switchAnim = spring({ frame: Math.max(0, frame - 380), fps, config: { damping: 20, stiffness: 220 } });
    ...
    // Démarrage frame 400, fin frame 600
    const pdfScroll = interpolate(frame, [400, 600], [0, -3400], { 
