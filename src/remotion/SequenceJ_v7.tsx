...
export const SequenceJ_v7: React.FC = () => {
    ...
    const baseScale = 1.0;
    const phoneW = 400 * baseScale; // 400
    const phoneH = 850 * baseScale; // 850
    ...
    return (
        <AbsoluteFill className="bg-[#FAF6ED] flex items-center justify-center font-sans overflow-hidden" style={{ perspective: '1500px' }}>
            ...
            {/* TEXTES MARKETING - CENTRÉ TOP */}
            <div className="absolute left-[5%] top-[10%] flex flex-col items-center justify-center text-center z-10 w-[90%]">
                <div 
                    style={{
                        opacity: text1Fly,
                    ...
                    className="mb-8"
                >
                    <div className="bg-[#1c2e4a] text-white font-anton text-[75px] tracking-wide uppercase px-10 py-6 rounded-3xl shadow-lg border-4 border-white inline-block">
                        RÉVISION<br/>CHRONOLOGIQUE
                    </div>
                </div>
                ...
                <div 
                    style={{
                        opacity: text2Fly,
                        transform: `translateY(${interpolate(text2Fly, [0, 1], [30, 0])}px) scale(${interpolate(text2Fly, [0, 1], [0.8, 1])})`
                    }}
                >
                    <h2 className="font-bebas text-[#4171B5] text-[150px] leading-[0.85] tracking-wider drop-shadow-sm uppercase">
                        DE J1 À J28
                    </h2>
                </div>
                ...
                <div 
                    style={{
                        opacity: text3Fly,
                        transform: `translateX(${interpolate(text3Fly, [0, 1], [-30, 0])}px)`
                    }}
                    className="mt-8"
                >
                    <div className="font-handwriting text-[#F27D33] text-[100px] font-bold drop-shadow-sm leading-none rotate-[-4deg]">
                ...
                <div 
                    ...
                    className="mt-8 border-slate-300"
                >
                    <p className="font-sans text-[45px] text-slate-500 font-medium leading-snug break-words">
                    ...
                    return (
                        <>
                            ...
                            <div 
                                ...
                                style={{ 
                                    left: phoneW - 80, // Ajusté pour le vertical et rester plus centré !
                                    top: targetYBottom - 160, // Monté plus haut pour éviter la main/curseur
                                    opacity: fadeOut,
                                    transform: `translate(-50%, -50%) translateY(${floatY}px) scale(${magScale})`,
                            ...
                            >
                                <div className="relative w-[180px] h-[180px] flex items-center justify-center">
                                    ...
                                    {/* The Bubble Tail (Curved comic stem pointing DOWN to the clock icon) */}
                                    <div className="absolute top-[85%] left-1/2 w-[50px] h-[45px] pointer-events-none -translate-x-1/2">
                                        <svg viewBox="0 0 50 45" fill="rgba(255, 255, 255, 0.95)" className="w-full h-full drop-shadow-[-4px_2px_8px_rgba(0,0,0,0.06)]">
                                            <path d="M 25 45 Q 25 15 0 22 Q 25 30 50 22 Z" />
                                        </svg>
                                    </div>
                                    
                                    {/* The Bubble Body (Squircle) */}
                                    <div className="absolute inset-0 rounded-[35px] bg-white/95 backdrop-blur-xl border border-slate-100" />
                                    
                                    {/* Soft Inner Shadow for depth */}
                                    <div className="absolute inset-0 rounded-[35px] shadow-[inset_0_4px_15px_rgba(255,255,255,1)] pointer-events-none" />

                                    {/* Content Inside */}
                                    <div className="relative z-10 flex flex-col items-center justify-center">
                                        <Clock size={70} className="text-slate-400 drop-shadow-sm" strokeWidth={1.5} />
                                        <span className="font-sans font-extrabold text-[#111827] text-[15px] tracking-widest uppercase mt-4">Chronologie</span>
                                    </div>
                                </div>
                            </div>
                        </>
