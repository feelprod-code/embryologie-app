...
export const MainTrailer_Carre: React.FC = () => {
    const { fps } = useVideoConfig();

    return (
        <AbsoluteFill className="bg-[#FAF6ED]">
            {/* Version 1:1 Carré : Pilotée par le log de montage timelineConfig.ts */}
            <Series>
                {/* 0 - Intro */}
