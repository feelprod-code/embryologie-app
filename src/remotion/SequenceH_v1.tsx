...
export const SequenceH: React.FC = () => {
    ...
    if (frame < 60) {
        ...
        cursorX = interpolate(fly1, [0, 1], [340, 30]); 
        cursorY = interpolate(fly1, [0, 1], [270, 175]);
    ...
    return (
        <AbsoluteFill className="bg-[#FAF6ED] flex items-center justify-center overflow-hidden">
            ...
            {/* SOUND DESIGN: CLICS */}
            {[625, 670, 715, 805, 970].map((clickFrame) => (
                <Sequence name="Bruitage - click.wav" key={clickFrame} from={clickFrame} durationInFrames={15}>
