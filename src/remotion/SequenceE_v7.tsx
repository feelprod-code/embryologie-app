...
export const SequenceE_v7: React.FC = () => {
    ...
    return (
        <AbsoluteFill className="bg-[#FAF6ED] flex items-center justify-center overflow-hidden" style={{ perspective: '1200px' }}>
            ...
            {/* TEXTE EXPLICATIF DE LA PHASE (CENTRE HAUT POUR LE VERTICAL) */}
            <div 
                className="absolute flex flex-col items-center justify-center transition-all duration-300 ease-in-out w-[90%] text-center"
                style={{
                    left: '5%',   
                    top: '15%',   
            ...
            >
                <div className="mb-6 text-[60px] font-bebas tracking-widest text-[#555] opacity-80 uppercase">
                    PHASE {uiActivePhase + 1}
                </div>
                
                {/* FUN COLORED PILL FOR THE TITLE - Anton, tilted, no border */}
                <h1 
                    className={`font-anton text-white text-[160px] tracking-wide uppercase px-12 py-6 rounded-[4rem] shadow-xl mb-12 ${categoryColors[uiActivePhase]}`}
                ...
                <div className="flex gap-8 mb-10 justify-center">
                    <div className="bg-slate-700 text-white px-10 py-5 rounded-[2rem] flex items-center gap-4 shadow-xl">
                        ...
                        <span className="text-[50px] font-sans font-bold tracking-wide">{currentStats.hours}H {currentStats.minutes.toString().padStart(2, '0')}</span>
                    </div>
                    <div className="bg-white text-slate-700 px-10 py-5 rounded-[2rem] flex items-center gap-4 shadow-xl border border-gray-200">
                        <svg width="48" height="48" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M14.5 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7.5L14.5 2z"></path><polyline points="14 2 14 8 20 8"></polyline><line x1="16" y1="13" x2="8" y2="13"></line><line x1="16" y1="17" x2="8" y2="17"></line><line x1="10" y1="9" x2="8" y2="9"></line></svg>
                        <span className="text-[50px] font-sans font-bold tracking-wide">{currentStats.count} VIDÉOS</span>
                    </div>
                </div>
                
                <p className="text-[#555] text-[40px] max-w-[90%] mx-auto mt-4 leading-relaxed font-sans" style={{ wordWrap: 'break-word' }}>
            ...
            <div 
                ...
                style={{ 
                    left: '50%', 
                    top: '65%', // Décale le téléphone vers le bas pour l'écran vertical
                    transform: `translate(calc(-50% + ${phoneTranslateX}px), calc(-50% + ${currentYTranslate}px)) scale(${uiScale * 0.85})`, // Scale réduit pour tout faire rentrer
                }}
            >
                {/* 3D Rotating Wrapper */}
                <div 
            ...
            <div 
                className="absolute flex flex-col items-center justify-center z-[50] text-center w-[95%]"
                style={{
                    left: '2.5%', 
                    top: '25%', // Replace earlier text placement
            ...
            >
                ...
                <h1 
                    className="text-[140px] font-anton uppercase tracking-wider text-white px-12 py-6 rounded-[4rem] transform -rotate-2 bg-[#F2B729]"
                    style={{ textShadow: "0px 4px 15px rgba(0,0,0,0.3)" }}
                >
                    CHAPITRAGE & RÉSUMÉS
                </h1>

                <p className="mt-12 text-[45px] font-sans text-slate-700 max-w-[90%] leading-relaxed" style={{ wordWrap: 'break-word', textAlign: 'center' }}>
