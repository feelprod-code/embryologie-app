        ...
        <div className={cn(
          ...
          {currentView === 'timeline' && (
            <div className="w-full max-w-5xl flex flex-col animate-fade-in relative z-10 mx-auto">
              ...
              <div className="sticky top-[0px] md:top-[60px] lg:top-[60px] z-50 w-[100vw] lg:w-full bg-[#FAF9F6] -mx-2 sm:-mx-6 lg:mx-0 pt-[env(safe-area-inset-top,4px)] md:pt-4 lg:pt-4 flex flex-col items-center shadow-sm lg:shadow-none pb-2 md:pb-2 mb-2 md:mb-2 px-2 transition-all">
                {/* TIMELINE BADGE */}
