        ...
        <div className={cn(
          ...
          {currentView === 'timeline' && (
            <div className="w-full max-w-5xl flex flex-col animate-fade-in relative z-10 mx-auto">
              ...
              <div className="sticky top-[0px] md:top-[60px] lg:top-[60px] z-20 w-[100vw] lg:w-full bg-[#FAF9F6] -mx-2 sm:-mx-6 lg:mx-0 pt-[env(safe-area-inset-top,4px)] md:pt-0 lg:pt-0 flex flex-col items-center shadow-sm lg:shadow-none pb-4 md:pb-4 px-2 transition-all border-b border-transparent md:border-solid md:border-slate-200">
                {/* TIMELINE BADGE */}
