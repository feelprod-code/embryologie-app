  ...
  return (
    <div className="flex flex-col items-center h-[100dvh] w-full max-w-full relative bg-[#FAF9F6] text-slate-800 overflow-hidden">
      ...
      <div className="flex-1 w-full h-full flex flex-col items-center overflow-y-auto overflow-x-hidden relative z-10 overscroll-y-none no-scrollbar" id="main-scroll-canvas" style={{ WebkitOverflowScrolling: 'touch' }}>
        ...
        <nav className={cn(
          "sticky top-0 z-50 w-full h-[84px] bg-[#FAF9F6] border-b border-slate-200 hidden md:flex items-center justify-center gap-2 px-6 pt-3 pb-1 shadow-[0_2px_10px_-3px_rgba(0,0,0,0.05)]",
        ...
        <div className={cn(
          ...
          {currentView === 'timeline' && (
            <div className="w-full max-w-5xl flex flex-col animate-fade-in relative z-10 mx-auto">
              ...
              <div className="sticky top-[50px] md:top-[83px] lg:top-[83px] z-40 w-[100vw] lg:w-full bg-[#FAF9F6] -mx-2 sm:-mx-6 lg:mx-0 pt-2 md:pt-4 flex flex-col items-center pb-4 md:pb-4 px-2 border-b border-transparent md:border-slate-100 shadow-sm md:shadow-none">
                {/* TIMELINE BADGE */}
