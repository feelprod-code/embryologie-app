        ...
        <div className={cn(
          ...
          {currentView === 'timeline' && (
            <div className="w-full max-w-5xl flex flex-col animate-fade-in relative z-10 mx-auto">
              ...
              <div className="sticky top-[50px] md:top-[59px] lg:top-[59px] z-40 w-[100vw] lg:w-full bg-[#FAF9F6] -mx-2 sm:-mx-6 lg:mx-0 pt-2 md:pt-4 flex flex-col items-center pb-4 md:pb-4 px-2 border-b border-transparent md:border-slate-100 shadow-sm md:shadow-none">
                {/* TIMELINE BADGE */}
